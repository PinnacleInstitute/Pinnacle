...
Public Const cErrSignInFailed As Long = vbObjectError + cErrSystem + 11
Public Const cErrConfirmFailed As Long = vbObjectError + cErrSystem + 12
Public Const cErrUserInActive As Long = vbObjectError + cErrSystem + 13
