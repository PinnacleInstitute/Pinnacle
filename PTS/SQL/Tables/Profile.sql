EXEC [dbo].pts_CheckTable 'Profile'
 GO
...
CREATE TABLE [dbo].[Profile] (
   ...
   [Status] int NOT NULL ,
   [VQResponse] nvarchar (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL ,
   [SQResponse] nvarchar (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL ,
   [VQDiff] int NOT NULL ,
   [VQDimPerc] int NOT NULL ,
   [VQDimPos_I] int NOT NULL ,
   [VQDimPos_E] int NOT NULL ,
   [VQDimPos_S] int NOT NULL ,
   [VQDimNeg_I] int NOT NULL ,
   [VQDimNeg_E] int NOT NULL ,
   [VQDimNeg_S] int NOT NULL ,
   [VQIntCate_I] int NOT NULL ,
   [VQIntCate_E] int NOT NULL ,
   [VQIntCate_S] int NOT NULL ,
   [VQInt] int NOT NULL ,
   [VQIntPerc] int NOT NULL ,
   [VQDI] int NOT NULL ,
   [VQDIS] int NOT NULL ,
   [VQLeft] int NOT NULL ,
   [VQRight] int NOT NULL ,
   [VQAI] int NOT NULL ,
   [SQDiff] int NOT NULL ,
   [SQDimPerc] int NOT NULL ,
   [SQDimPos_I] int NOT NULL ,
   [SQDimPos_E] int NOT NULL ,
   [SQDimPos_S] int NOT NULL ,
   [SQDimNeg_I] int NOT NULL ,
   [SQDimNeg_E] int NOT NULL ,
   [SQDimNeg_S] int NOT NULL ,
   [SQIntCate_I] int NOT NULL ,
   [SQIntCate_E] int NOT NULL ,
   [SQIntCate_S] int NOT NULL ,
   [SQInt] int NOT NULL ,
   [SQIntPerc] int NOT NULL ,
   [SQDI] int NOT NULL ,
   [SQDIS] int NOT NULL ,
   [SQLeft] int NOT NULL ,
   [SQRight] int NOT NULL ,
   [SQAI] int NOT NULL ,
   [BQrLeft] money NOT NULL ,
   [BQrRight] money NOT NULL ,
   [BQaLeft] int NOT NULL ,
   [BQaRight] int NOT NULL ,
   [CQLeft] int NOT NULL ,
   [CQRight] int NOT NULL ,
   [RQLeft] money NOT NULL ,
   [RQRight] money NOT NULL ,
   [VQClarity_I] int NOT NULL ,
   [VQClarity_E] int NOT NULL ,
   [VQClarity_S] int NOT NULL ,
   [VQBias_I] int NOT NULL ,
   [VQBias_E] int NOT NULL ,
   [VQBias_S] int NOT NULL ,
   [SQClarity_I] int NOT NULL ,
   [SQClarity_E] int NOT NULL ,
   [SQClarity_S] int NOT NULL ,
   [SQBias_I] int NOT NULL ,
   [SQBias_E] int NOT NULL ,
   [SQBias_S] int NOT NULL ,
   [xVQClarity_I] int NOT NULL ,
   [xVQClarity_E] int NOT NULL ,
   [xVQClarity_S] int NOT NULL ,
   [xVQBias_I] money NOT NULL ,
   [xVQBias_E] money NOT NULL ,
   [xVQBias_S] money NOT NULL ,
   [xSQClarity_I] int NOT NULL ,
   [xSQClarity_E] int NOT NULL ,
   [xSQClarity_S] int NOT NULL ,
   [xSQBias_I] money NOT NULL ,
   [xSQBias_E] money NOT NULL ,
   [xSQBias_S] money NOT NULL 
   ) ON [PRIMARY]
GO
