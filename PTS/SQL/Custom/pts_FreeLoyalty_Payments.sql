EXEC [dbo].pts_CheckProc 'pts_FreeLoyalty_Payments'
GO

--DECLARE @Count varchar(1000) EXEC pts_FreeLoyalty_Payments 0, @Count OUTPUT print @Count

CREATE PROCEDURE [dbo].pts_FreeLoyalty_Payments
   @BillDate datetime,
...
--	Only process Autoships
	EXEC pts_FreeLoyalty_ValidAutoShip @Options2, @tmpPurpose OUTPUT
...
--		Do Payment post processing
		EXEC pts_FreeLoyalty_PaymentPost @PaymentID, @tmpCount OUTPUT
