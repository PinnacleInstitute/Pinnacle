EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_16'
GO
--User Activity Project Notes 
--List all project notes that are not reminders that belong to the specified user. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_16
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
...
DECLARE @AuthUserID int, @CompanyID int, @MemberID int, @Secure int, @pos int
SET @AuthUserID = 0
SET @CompanyID = 0
SET @MemberID = 0
SET @Secure = -1
