EXEC [dbo].pts_CheckProc 'pts_ZaZZed_PaymentsBinary'
GO

--DECLARE @Count varchar(1000) EXEC pts_ZaZZed_PaymentsBinary @Count OUTPUT print @Count

CREATE PROCEDURE [dbo].pts_ZaZZed_PaymentsBinary
...
BEGIN
	EXEC pts_ZaZZed_PaymentBinary @MemberID, @SalesOrderID
	EXEC pts_Commission_Company_9b @MemberID, @PaymentID, '', @cnt OUTPUT 
	SET @Count = @Count + 1
