EXEC [dbo].pts_CheckProc 'pts_TellAll_Payments'
GO

--DECLARE @Count varchar(1000) EXEC pts_TellAll_Payments 0, @Count OUTPUT print @Count

CREATE PROCEDURE [dbo].pts_TellAll_Payments
   @BillDate datetime,
...
--	Only process Autoships
	EXEC pts_TellAll_ValidAutoShip @Options2, @tmpPurpose OUTPUT
...
--		Do Payment post processing
		EXEC pts_TellAll_PaymentPost @PaymentID, @tmpCount OUTPUT
