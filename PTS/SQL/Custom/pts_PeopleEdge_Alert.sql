EXEC [dbo].pts_CheckProc 'pts_PeopleEdge_Alert'
GO

--declare @Result varchar(1000) EXEC pts_PeopleEdge_Alert 521, @Result output print @Result

CREATE PROCEDURE [dbo].pts_PeopleEdge_Alert
   @MemberID int ,
