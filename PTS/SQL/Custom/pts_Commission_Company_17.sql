EXEC [dbo].pts_CheckProc 'pts_Commission_Company_17'
GO

--DECLARE @Count int EXEC pts_Commission_Company_17 1, '3/1/14', '4/30/14', @Count OUTPUT PRINT @Count

CREATE PROCEDURE [dbo].pts_Commission_Company_17
   @CommType int ,
   @FromDate datetime ,
   @ToDate datetime ,
   @Count int OUTPUT
...
--	AND me.MemberID = 11109
	...
	BEGIN
		SET @tmpCount = 0
		EXEC pts_Commission_Company_17a @PaymentID, @tmpCount OUTPUT
