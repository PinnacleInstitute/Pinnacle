EXEC [dbo].pts_CheckProc 'pts_ZaZZed_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_ZaZZed_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_ZaZZed_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_ZaZZed_Alert @MemberID, @Result output
END
