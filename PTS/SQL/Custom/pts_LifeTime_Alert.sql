EXEC [dbo].pts_CheckProc 'pts_LifeTime_Alert'
GO

--declare @Result varchar(1000) EXEC pts_LifeTime_Alert 521, @Result output print @Result

CREATE PROCEDURE [dbo].pts_LifeTime_Alert
   @MemberID int ,
