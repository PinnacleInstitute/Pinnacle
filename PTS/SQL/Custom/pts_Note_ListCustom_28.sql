EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_28'
GO
--Project User Containing Keyword Project Notes 
--List all project notes that belong to the specified project user and contains the specified keyword. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_28
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
