EXEC [dbo].pts_CheckProc 'pts_CloudZow_Clean'
GO

--declare @Result varchar(1000) EXEC pts_CloudZow_Clean @Result output print @Result

CREATE PROCEDURE [dbo].pts_CloudZow_Clean
