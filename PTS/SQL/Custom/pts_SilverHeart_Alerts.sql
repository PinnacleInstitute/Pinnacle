EXEC [dbo].pts_CheckProc 'pts_SilverHeart_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_SilverHeart_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_SilverHeart_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_SilverHeart_Alert @MemberID, @Result output
END
