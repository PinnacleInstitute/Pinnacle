EXEC [dbo].pts_CheckProc 'pts_Lifetime_Payments'
GO

--DECLARE @Count varchar(1000) EXEC pts_Lifetime_Payments 0, @Count OUTPUT print @Count

CREATE PROCEDURE [dbo].pts_Lifetime_Payments
   @BillDate datetime,
