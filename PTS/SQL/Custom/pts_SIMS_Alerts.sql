EXEC [dbo].pts_CheckProc 'pts_SIMS_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_SIMS_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_SIMS_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_SIMS_Alert @MemberID, @Result output
END
