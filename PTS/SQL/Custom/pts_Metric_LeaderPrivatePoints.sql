EXEC [dbo].pts_CheckProc 'pts_Metric_LeaderPrivatePoints'
 GO

--DECLARE @MaxRows int EXEC pts_Metric_LeaderPrivatePoints '', '', @MaxRows, 16, '9/1/13', '9/30/14', 3, 1
--DECLARE @MaxRows int EXEC pts_Metric_LeaderPrivatePoints '', '00000001610000006870', @MaxRows, 7, '1/1/13', '1/31/13', 3, 1

CREATE PROCEDURE [dbo].pts_Metric_LeaderPrivatePoints ( 
