EXEC [dbo].pts_CheckProc 'pts_Commission_Company_14'
GO

--DECLARE @Count int EXEC pts_Commission_Company_14 1, '3/1/14', '4/30/14', @Count OUTPUT PRINT @Count

CREATE PROCEDURE [dbo].pts_Commission_Company_14
   @CommType int ,
   @FromDate datetime ,
   @ToDate datetime ,
   @Count int OUTPUT
...
--	AND me.MemberID = 11109
	...
	BEGIN
		SET @tmpCount = 0
		EXEC pts_Commission_Company_14a @PaymentID, @tmpCount OUTPUT
