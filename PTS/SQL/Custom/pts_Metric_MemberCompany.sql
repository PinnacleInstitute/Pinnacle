EXEC [dbo].pts_CheckProc 'pts_Metric_MemberCompany'
 GO
--DECLARE @MaxRows int EXEC pts_Metric_MemberCompany 7, 'sandy', '1/1/13', '12/20/13', 3

CREATE PROCEDURE [dbo].pts_Metric_MemberCompany ( 
   @CompanyID int,
