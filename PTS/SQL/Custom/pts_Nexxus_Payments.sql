EXEC [dbo].pts_CheckProc 'pts_Nexxus_Payments'
GO

--DECLARE @Count varchar(1000) EXEC pts_Nexxus_Payments 0, @Count OUTPUT print @Count

CREATE PROCEDURE [dbo].pts_Nexxus_Payments
   @BillDate datetime,
...
BEGIN
	EXEC pts_Nexxus_PaymentMember @MemberID, @Price, @InitPrice, @EnrollDate, @BillingID, @PaidDate, @Options2, @Cnt OUTPUT
