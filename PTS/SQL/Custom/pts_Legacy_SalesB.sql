EXEC [dbo].pts_CheckProc 'pts_Legacy_SalesB'
GO

--declare @Result varchar(1000) EXEC pts_Legacy_SalesB @Result output print @Result
...
-- *******************************************************************
CREATE PROCEDURE [dbo].pts_Legacy_SalesB
...
BEGIN
	EXEC pts_Legacy_SetTotalsB @MemberID, 0, @Result output
	FETCH NEXT FROM Member_cursor INTO @MemberID
END
CLOSE Member_cursor
