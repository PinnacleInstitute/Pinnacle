EXEC [dbo].pts_CheckProc 'pts_FreeLoyalty_Alert'
GO

--declare @Result varchar(1000) EXEC pts_FreeLoyalty_Alert 521, @Result output print @Result

CREATE PROCEDURE [dbo].pts_FreeLoyalty_Alert
   @MemberID int ,
