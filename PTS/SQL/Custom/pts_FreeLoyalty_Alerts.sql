EXEC [dbo].pts_CheckProc 'pts_FreeLoyalty_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_FreeLoyalty_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_FreeLoyalty_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_FreeLoyalty_Alert @MemberID, @Result output
END
