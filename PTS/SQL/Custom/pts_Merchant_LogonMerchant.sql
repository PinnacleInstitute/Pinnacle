EXEC [dbo].pts_CheckProc 'pts_Merchant_LogonMerchant'
GO

--DECLARE @Result int EXEC pts_Merchant_LogonMerchant 'bob@pinnaclep.com', @Result OUTPUT PRINT @Result

CREATE PROCEDURE [dbo].pts_Merchant_LogonMerchant
   @Email nvarchar (80) ,
   @Result int OUTPUT
AS
-- RETURN VALUES
