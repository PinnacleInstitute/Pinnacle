EXEC [dbo].pts_CheckProc 'pts_GFTG_Qualified'
GO

--declare @Result varchar(1000) EXEC pts_GFTG_Qualified 2, '6/3/12', @Result output print @Result

CREATE PROCEDURE [dbo].pts_GFTG_Qualified
   @Status int ,
   @czDate datetime ,
...
--	--------------------------------------------------------------------------------------------------------
	...
	AND ( Title = 0 OR (Title > 0 AND Price > 0) ) 
