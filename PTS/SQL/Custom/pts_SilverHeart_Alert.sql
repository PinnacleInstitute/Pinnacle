EXEC [dbo].pts_CheckProc 'pts_SilverHeart_Alert'
GO

--declare @Result varchar(1000) EXEC pts_SilverHeart_Alert 521, @Result output print @Result

CREATE PROCEDURE [dbo].pts_SilverHeart_Alert
   @MemberID int ,
