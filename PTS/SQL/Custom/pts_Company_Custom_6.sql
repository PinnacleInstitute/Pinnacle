EXEC [dbo].pts_CheckProc 'pts_Company_Custom_6'
GO

--declare @Result int
--EXEC pts_Company_Custom_6 5, 0, 86912, 0, @Result output
--print @Result

CREATE PROCEDURE [dbo].pts_Company_Custom_6
   @Status int ,
   @EnrollDate datetime ,
   @Quantity int ,
   @Amount int ,
...
-- *******************************************************************
-- Status 6 ... Mark Values Card Mailings "In Process"
-- *******************************************************************
IF @Status = 6
BEGIN
...
-- *******************************************************************
-- Status 7 ... Mark Values Card Mailings "Mailing Complete"
-- *******************************************************************
IF @Status = 7
BEGIN
