EXEC [dbo].pts_CheckProc 'pts_SalesOrder_CustomList_13'
GO

--EXEC pts_SalesOrder_CustomList_13 101, 0, 1, 0

CREATE PROCEDURE [dbo].pts_SalesOrder_CustomList_13
   @Status int ,
   @EnrollDate datetime ,
   @Quantity int ,
   @Amount int
...
BEGIN
	...
	IF @Quantity = 2 SET @Data = 'Polydot'
