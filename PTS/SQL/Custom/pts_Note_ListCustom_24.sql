EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_24'
GO
--Project Containing Keyword Project Notes 
--List all project notes that belong to the specified project and contains the specified keyword. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_24
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
