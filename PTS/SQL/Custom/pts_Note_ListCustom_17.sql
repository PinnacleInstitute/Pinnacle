EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_17'
GO
--User Starting Keyword Project Notes 
--List all project notes that belong to the specified user and start with the specified keyword. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_17
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
