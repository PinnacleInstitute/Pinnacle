EXEC [dbo].pts_CheckProc 'pts_Emailee_ListCustom_79'
GO

--EXEC pts_Emailee_ListCustom_79 9, '7967', '', '', '', ''
...
-- Data4 = To Date (Today)
-- ******************************
CREATE PROCEDURE [dbo].pts_Emailee_ListCustom_79
   @CompanyID int ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
   @Data3 nvarchar (80) ,
...
AND dl.ParentID = @MemberID
AND (0 = @Team OR dl.Line = @Team)
