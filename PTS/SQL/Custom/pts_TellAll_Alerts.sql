EXEC [dbo].pts_CheckProc 'pts_TellAll_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_TellAll_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_TellAll_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_TellAll_Alert @MemberID, @Result output
END
