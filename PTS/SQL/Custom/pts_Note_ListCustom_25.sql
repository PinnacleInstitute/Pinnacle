EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_25'
GO
--Project User Reminder Project Notes 
--List all project notes that are reminders that belong to the specified project user. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_25
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
