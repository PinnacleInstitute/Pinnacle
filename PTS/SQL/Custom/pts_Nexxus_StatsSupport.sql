EXEC [dbo].pts_CheckProc 'pts_Nexxus_StatsSupport'
GO

--DECLARE @Result varchar(1000) EXEC pts_Nexxus_StatsSupport 0, 129, @Result OUTPUT print @Result

CREATE PROCEDURE [dbo].pts_Nexxus_StatsSupport
   @Days int ,
   @OrgID int ,
