EXEC [dbo].pts_CheckProc 'pts_PB_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_PB_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_PB_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_PB_Alert @MemberID, @Result output
END
