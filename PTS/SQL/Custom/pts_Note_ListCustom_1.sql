EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_1'
GO
--Company Reminder Prospect Notes 
--List all prospect notes that are reminders that belong to the specified company. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_1
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
