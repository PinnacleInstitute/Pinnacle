EXEC [dbo].pts_CheckProc 'pts_Metric_MemberMentor'
 GO
--DECLARE @MaxRows int EXEC pts_Metric_MemberMentor 7, 'sandy', '1/1/13', '12/20/13', 3

CREATE PROCEDURE [dbo].pts_Metric_MemberMentor ( 
   @MemberID int,
