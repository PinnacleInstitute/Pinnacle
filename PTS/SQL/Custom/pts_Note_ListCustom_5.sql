EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_5'
GO
--User Reminder Prospect Notes 
--List all prospect notes that are reminders that belong to the specified user. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_5
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
