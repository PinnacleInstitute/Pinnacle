EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_7'
GO
--User Starting Keyword Prospect Notes 
--List all prospect notes that belong to the specified user and start with the specified keyword. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_7
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
