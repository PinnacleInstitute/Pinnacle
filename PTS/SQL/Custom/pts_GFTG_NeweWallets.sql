EXEC [dbo].pts_CheckProc 'pts_GFTG_NeweWallets'
GO

--DECLARE @Result varchar(1000) EXEC pts_GFTG_NeweWallets @Result OUTPUT PRINT @Result

CREATE PROCEDURE [dbo].pts_GFTG_NeweWallets
