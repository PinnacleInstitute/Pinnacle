EXEC [dbo].pts_CheckProc 'pts_LifeTime_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_LifeTime_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_LifeTime_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_LifeTime_Alert @MemberID, @Result output
END
