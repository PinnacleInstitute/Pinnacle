EXEC [dbo].pts_CheckProc 'pts_PeopleEdge_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_PeopleEdge_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_PeopleEdge_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_PeopleEdge_Alert @MemberID, @Result output
END
