EXEC [dbo].pts_CheckProc 'pts_SIMS_StatsGroup'
GO

--DECLARE @Result varchar(1000) EXEC pts_SIMS_StatsGroup 0, 6528, @Result OUTPUT print @Result

CREATE PROCEDURE [dbo].pts_SIMS_StatsGroup
   @Days int ,
   @GroupID int ,
