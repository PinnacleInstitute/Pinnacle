EXEC [dbo].pts_CheckProc 'pts_Legacy_NeweWallets'
GO

--DECLARE @Result varchar(1000) EXEC pts_Legacy_NeweWallets @Result OUTPUT PRINT @Result

CREATE PROCEDURE [dbo].pts_Legacy_NeweWallets
