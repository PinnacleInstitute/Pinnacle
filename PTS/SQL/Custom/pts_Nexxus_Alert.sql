EXEC [dbo].pts_CheckProc 'pts_Nexxus_Alert'
GO

--declare @Result varchar(1000) EXEC pts_Nexxus_Alert 521, @Result output print @Result

CREATE PROCEDURE [dbo].pts_Nexxus_Alert
   @MemberID int ,
