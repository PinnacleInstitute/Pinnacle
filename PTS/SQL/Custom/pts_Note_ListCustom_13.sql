EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_13'
GO
--Company Starting Keyword Project Notes 
--List all project notes that belong to the specified company and start with the specified keyword. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_13
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
