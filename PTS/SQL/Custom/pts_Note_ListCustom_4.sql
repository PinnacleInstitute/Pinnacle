EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_4'
GO
--Company Containing Keyword Prospect Notes 
--List all prospect notes that belong to the specified company and contains the specified keyword. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_4
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
