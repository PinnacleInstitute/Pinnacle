EXEC [dbo].pts_CheckProc 'pts_SalesOrder_CustomList_20'
GO

--EXEC pts_SalesOrder_CustomList_20 101, 0, 1, 0

CREATE PROCEDURE [dbo].pts_SalesOrder_CustomList_20
   @Status int ,
   @EnrollDate datetime ,
   @Quantity int ,
   @Amount int
...
BEGIN
	...
	IF @Quantity = 1 SET @Data = 'SSD'
	IF @Quantity = 2 SET @Data = 'SSP'
