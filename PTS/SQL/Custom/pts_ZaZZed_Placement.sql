EXEC [dbo].pts_CheckProc 'pts_ZaZZed_Placement'
GO

--declare @Result varchar(1000) EXEC pts_ZaZZed_Placement 7219, @Result output print @Result
--declare @Result varchar(1000) EXEC pts_ZaZZed_Placement 7222, @Result output print @Result

CREATE PROCEDURE [dbo].pts_ZaZZed_Placement
   @MemberID int ,
