EXEC [dbo].pts_CheckProc 'pts_GCR_MemberPayment'
GO

--declare @Result varchar(1000) EXEC pts_GCR_MemberPayment 12046, @Result output print @Result
--select * from Member where CompanyID = 17 order by MemberID desc

CREATE PROCEDURE [dbo].pts_GCR_MemberPayment
   @MemberID int ,
