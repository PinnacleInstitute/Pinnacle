EXEC [dbo].pts_CheckProc 'pts_CIS_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_CIS_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_CIS_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_CIS_Alert @MemberID, @Result output
END
