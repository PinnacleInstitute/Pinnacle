EXEC [dbo].pts_CheckProc 'pts_ZaZZed_Qualified'
GO

--declare @Result varchar(1000) EXEC pts_ZaZZed_Qualified 2, '6/3/12', @Result output print @Result

CREATE PROCEDURE [dbo].pts_ZaZZed_Qualified
   @Status int ,
   @czDate datetime ,
