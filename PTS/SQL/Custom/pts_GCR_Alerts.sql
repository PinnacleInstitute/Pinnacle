EXEC [dbo].pts_CheckProc 'pts_GCR_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_GCR_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_GCR_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_GCR_Alert @MemberID, @Result output
END
