EXEC [dbo].pts_CheckProc 'pts_GFTG_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_GFTG_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_GFTG_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_GFTG_Alert @MemberID, @Result output
END
