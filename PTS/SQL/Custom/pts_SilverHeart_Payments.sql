EXEC [dbo].pts_CheckProc 'pts_SilverHeart_Payments'
GO

--DECLARE @Count varchar(1000) EXEC pts_SilverHeart_Payments 0, @Count OUTPUT print @Count

CREATE PROCEDURE [dbo].pts_SilverHeart_Payments
   @BillDate datetime,
...
--	Only process Autoships
	EXEC pts_SilverHeart_ValidAutoShip @Options2, @tmpPurpose OUTPUT
...
--		Do Payment post processing
		EXEC pts_SilverHeart_PaymentPost @PaymentID, @tmpCount OUTPUT
