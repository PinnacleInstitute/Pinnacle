EXEC [dbo].pts_CheckProc 'pts_Emailee_ListCustom_201'
GO

--TEST
--EXEC pts_Emailee_ListCustom_201 5, '1', '', '', '', ''

-- CloudZow New Resellers
CREATE PROCEDURE [dbo].pts_Emailee_ListCustom_201
   @CompanyID int ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
   @Data3 nvarchar (80) ,
