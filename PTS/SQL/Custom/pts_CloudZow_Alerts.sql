EXEC [dbo].pts_CheckProc 'pts_CloudZow_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_CloudZow_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_CloudZow_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_CloudZow_Alert @MemberID, @Result output
END
