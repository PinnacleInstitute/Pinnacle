EXEC [dbo].pts_CheckProc 'pts_Metric_ExpLeaderCompanyCustom'
 GO

--EXEC pts_Metric_ExpLeaderCompanyCustom 7, '1/1/13', '1/1/14', 1, 2, 4, 5, 6 

CREATE PROCEDURE [dbo].pts_Metric_ExpLeaderCompanyCustom ( 
   @CompanyID int,
   @FromDate datetime,
   @ToDate datetime,
   @Custom1 int,
