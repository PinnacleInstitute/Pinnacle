EXEC [dbo].pts_CheckProc 'pts_GFTG_Alert'
GO

--declare @Result varchar(1000) EXEC pts_GFTG_Alert 521, @Result output print @Result

CREATE PROCEDURE [dbo].pts_GFTG_Alert
   @MemberID int ,
