EXEC [dbo].pts_CheckProc 'pts_Emailee_ListCustom_2_MembersLastVisit'
GO

CREATE PROCEDURE [dbo].pts_Emailee_ListCustom_2_MembersLastVisit
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
   @Data3 nvarchar (80) ,
   @Data4 nvarchar (80) ,
...
SELECT me.MemberID AS 'EmaileeID', 
       ...
       CAST(me.VisitDate AS nvarchar(80)) AS 'Data3', 
