EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_11'
GO
--Company Reminder Prospect Notes 
--List all project notes that are reminders that belong to the specified company. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_11
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
