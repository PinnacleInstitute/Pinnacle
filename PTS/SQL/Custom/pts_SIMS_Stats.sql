EXEC [dbo].pts_CheckProc 'pts_SIMS_Stats'
GO

--DECLARE @Result varchar(1000) EXEC pts_SIMS_Stats 0, @Result OUTPUT print @Result

CREATE PROCEDURE [dbo].pts_SIMS_Stats
   @Days int ,
...
WHERE  CompanyID = @CompanyID AND [Level] = 2 AND Billing <= 1 AND Status >= 1 AND Status <= 3 AND EnrollDate >= @StartDate AND EnrollDate < @EndDate
...
WHERE  CompanyID = @CompanyID AND [Level] = 2 AND Billing = 3 AND Status >= 1 AND Status <= 3 AND EnrollDate >= @StartDate AND EnrollDate < @EndDate

SELECT @M3_1 = ISNULL(COUNT(MemberID),0) FROM Member
WHERE  CompanyID = @CompanyID AND [Level] = 3 AND Billing = 3 AND Status >= 1 AND Status <= 3 AND EnrollDate >= @StartDate AND EnrollDate < @EndDate
...
WHERE  CompanyID = @CompanyID AND [Level] = 2 AND Billing <= 1 AND Status >= 1 AND Status <= 3 AND EnrollDate < @EndDate
...
WHERE  CompanyID = @CompanyID AND [Level] = 2 AND Billing = 3 AND Status >= 1 AND Status <= 3 AND EnrollDate < @EndDate

SELECT @M3_99 = ISNULL(COUNT(MemberID),0) FROM Member
WHERE  CompanyID = @CompanyID AND [Level] = 3 AND Billing = 3 AND Status >= 1 AND Status <= 3 AND EnrollDate < @EndDate

SET @M4_99 = @M2_99 + @M3_99  

-- ****** MEMBERSHIP STATUS ******
SELECT @T1 = ISNULL(COUNT(MemberID),0) FROM Member WHERE CompanyID = @CompanyID AND Billing = 3 AND ([Level] = 2 OR [Level] = 3) AND Status >= 1 AND Status <= 3 AND EnrollDate < @EndDate
SELECT @T4 = ISNULL(COUNT(MemberID),0) FROM Member WHERE CompanyID = @CompanyID AND Billing = 3 AND ([Level] = 2 OR [Level] = 3) AND Status = 4 AND EnrollDate < @EndDate
SELECT @T5 = ISNULL(COUNT(MemberID),0) FROM Member WHERE CompanyID = @CompanyID AND Billing = 3 AND ([Level] = 2 OR [Level] = 3) AND Status = 5 AND EnrollDate < @EndDate
SELECT @T6 = ISNULL(COUNT(MemberID),0) FROM Member WHERE CompanyID = @CompanyID AND Billing = 3 AND ([Level] = 2 OR [Level] = 3) AND Status = 6 AND EnrollDate < @EndDate
SELECT @T7 = ISNULL(COUNT(MemberID),0) FROM Member WHERE CompanyID = @CompanyID AND Billing = 3 AND ([Level] = 2 OR [Level] = 3) AND Status = 7 AND EnrollDate < @EndDate
...
SELECT @F2 = COUNT(me.MemberID) FROM Member AS me WHERE me.CompanyID = 7 AND me.Billing = 3 AND me.level = 2 AND me.Status >= 1 AND me.Status <= 4
...
SELECT @F3 = COUNT(me.MemberID) FROM Member AS me WHERE me.CompanyID = 7 AND me.Billing = 3 AND me.level = 3 AND me.Status >= 1 AND me.Status <= 4
