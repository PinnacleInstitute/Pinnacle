EXEC [dbo].pts_CheckProc 'pts_Note_ListCustom_21'
GO
--Project Reminder Project Notes 
--List all project notes that are reminders that belong to the specified project. 
CREATE PROCEDURE [dbo].pts_Note_ListCustom_21
   @FromDate datetime ,
   @ToDate datetime ,
   @Data1 nvarchar (80) ,
   @Data2 nvarchar (80) ,
