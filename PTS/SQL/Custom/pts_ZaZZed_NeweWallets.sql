EXEC [dbo].pts_CheckProc 'pts_ZaZZed_NeweWallets'
GO

--DECLARE @Result varchar(1000) EXEC pts_ZaZZed_NeweWallets @Result OUTPUT PRINT @Result

CREATE PROCEDURE [dbo].pts_ZaZZed_NeweWallets
