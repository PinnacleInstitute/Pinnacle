EXEC [dbo].pts_CheckProc 'pts_Metric_ExpLeaderGroupCustom'
 GO
--EXEC pts_Metric_ExpLeaderGroupCustom 6528, '1/1/13', '1/1/14', 2

CREATE PROCEDURE [dbo].pts_Metric_ExpLeaderGroupCustom ( 
   @GroupID int,
   @FromDate datetime,
   @ToDate datetime,
   @Custom1 int,
