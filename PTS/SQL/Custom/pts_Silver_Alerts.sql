EXEC [dbo].pts_CheckProc 'pts_Silver_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_Silver_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_Silver_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_Silver_Alert @MemberID, @Result output
END
