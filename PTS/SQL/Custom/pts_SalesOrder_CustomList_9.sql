EXEC [dbo].pts_CheckProc 'pts_SalesOrder_CustomList_9'
GO

--EXEC pts_SalesOrder_CustomList_9 101, 0, 1, 0

CREATE PROCEDURE [dbo].pts_SalesOrder_CustomList_9
   @Status int ,
   @EnrollDate datetime ,
   @Quantity int ,
   @Amount int
