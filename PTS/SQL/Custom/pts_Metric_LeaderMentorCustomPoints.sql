EXEC [dbo].pts_CheckProc 'pts_Metric_LeaderMentorCustomPoints'
 GO

--DECLARE @MaxRows int EXEC pts_Metric_LeaderMentorCustomPoints '', '00000000610000006607', @MaxRows, 7, '1/1/13', '1/31/13', 2, 1

CREATE PROCEDURE [dbo].pts_Metric_LeaderMentorCustomPoints ( 
