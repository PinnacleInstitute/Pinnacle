EXEC [dbo].pts_CheckProc 'pts_LifeTime_PaymentCredit'
GO

--declare @Result varchar(1000) EXEC pts_LifeTime_PaymentCredit @Result output print @Result

CREATE PROCEDURE [dbo].pts_LifeTime_PaymentCredit
