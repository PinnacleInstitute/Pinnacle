EXEC [dbo].pts_CheckProc 'pts_Legacy_Alerts'
GO

--declare @Result varchar(1000) EXEC pts_Legacy_Alerts 0, @Result output print @Result

CREATE PROCEDURE [dbo].pts_Legacy_Alerts
   @MemberID int ,
...
IF @MemberID > 0
BEGIN
	EXEC pts_Legacy_Alert @MemberID, @Result output
END
