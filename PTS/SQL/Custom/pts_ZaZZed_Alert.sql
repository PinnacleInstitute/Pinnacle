EXEC [dbo].pts_CheckProc 'pts_ZaZZed_Alert'
GO

--declare @Result varchar(1000) EXEC pts_ZaZZed_Alert 521, @Result output print @Result

CREATE PROCEDURE [dbo].pts_ZaZZed_Alert
   @MemberID int ,
