EXEC [dbo].pts_CheckProc 'pts_TellAll_Alert'
GO

--declare @Result varchar(1000) EXEC pts_TellAll_Alert 521, @Result output print @Result

CREATE PROCEDURE [dbo].pts_TellAll_Alert
   @MemberID int ,
