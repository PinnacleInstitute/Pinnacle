EXEC [dbo].pts_CheckProc 'pts_Silver_Alert'
GO

--declare @Result varchar(1000) EXEC pts_Silver_Alert 521, @Result output print @Result

CREATE PROCEDURE [dbo].pts_Silver_Alert
   @MemberID int ,
