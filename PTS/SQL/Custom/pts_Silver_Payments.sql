EXEC [dbo].pts_CheckProc 'pts_Silver_Payments'
GO

--DECLARE @Count varchar(1000) EXEC pts_Silver_Payments 0, @Count OUTPUT print @Count

CREATE PROCEDURE [dbo].pts_Silver_Payments
   @BillDate datetime,
...
--	Do Payment post processing
	EXEC pts_Silver_PaymentPost @PaymentID, @tmpCount OUTPUT
