EXEC [dbo].pts_CheckProc 'pts_TellAll_Sales2'
GO

--declare @Result varchar(1000) EXEC pts_TellAll_Sales2 @Result output print @Result
-- *******************************************************************
-- Recalculate all group sales volumes for matrix
-- *******************************************************************
CREATE PROCEDURE [dbo].pts_TellAll_Sales2
...
BEGIN
	EXEC pts_TellAll_SetTotals2 @MemberID, 1, 1, @Result output
	FETCH NEXT FROM Member_cursor INTO @MemberID
END
CLOSE Member_cursor
