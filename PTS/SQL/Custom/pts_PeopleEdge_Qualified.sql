EXEC [dbo].pts_CheckProc 'pts_PeopleEdge_Qualified'
GO

--declare @Result varchar(1000) EXEC pts_PeopleEdge_Qualified 2, '6/3/12', @Result output print @Result

CREATE PROCEDURE [dbo].pts_PeopleEdge_Qualified
   @Status int ,
   @czDate datetime ,
...
--	-- ***** Check for a verified Payout ACH *****
