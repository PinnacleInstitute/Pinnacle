EXEC [dbo].pts_CheckProc 'pts_Lead_FindStatusPhone1'
 GO

CREATE PROCEDURE [dbo].pts_Lead_FindStatusPhone1 ( 
...
SELECT TOP 21
            ISNULL(ld.Phone1, '') + dbo.wtfn_FormatNumber(ld.LeadID, 10) 'BookMark' ,
            ld.LeadID 'LeadID' ,
...
AND ISNULL(ld.Phone1, '') + dbo.wtfn_FormatNumber(ld.LeadID, 10) >= @BookMark
