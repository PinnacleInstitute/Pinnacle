EXEC [dbo].pts_CheckProc 'pts_Lead_FindStatusSalesCampaignName'
 GO

CREATE PROCEDURE [dbo].pts_Lead_FindStatusSalesCampaignName ( 
...
SELECT TOP 21
            ISNULL(sc.SalesCampaignName, '') + dbo.wtfn_FormatNumber(ld.LeadID, 10) 'BookMark' ,
            ld.LeadID 'LeadID' ,
...
AND ISNULL(sc.SalesCampaignName, '') + dbo.wtfn_FormatNumber(ld.LeadID, 10) >= @BookMark
