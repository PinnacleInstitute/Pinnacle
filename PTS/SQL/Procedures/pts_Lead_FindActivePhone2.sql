EXEC [dbo].pts_CheckProc 'pts_Lead_FindActivePhone2'
 GO

CREATE PROCEDURE [dbo].pts_Lead_FindActivePhone2 ( 
...
SELECT TOP 21
            ISNULL(ld.Phone2, '') + dbo.wtfn_FormatNumber(ld.LeadID, 10) 'BookMark' ,
            ld.LeadID 'LeadID' ,
...
AND ISNULL(ld.Phone2, '') + dbo.wtfn_FormatNumber(ld.LeadID, 10) >= @BookMark
