EXEC [dbo].pts_CheckProc 'pts_Payment2_FindStatusTypePayDate'
 GO

CREATE PROCEDURE [dbo].pts_Payment2_FindStatusTypePayDate ( 
...
SELECT TOP 21
            ISNULL(CONVERT(nvarchar(10), pa2.PayDate, 112), '') + dbo.wtfn_FormatNumber(pa2.Payment2ID, 10) 'BookMark' ,
...
WHERE ISNULL(CONVERT(nvarchar(10), pa2.PayDate, 112), '') LIKE @SearchText + '%'
AND ISNULL(CONVERT(nvarchar(10), pa2.PayDate, 112), '') + dbo.wtfn_FormatNumber(pa2.Payment2ID, 10) <= @BookMark
