EXEC [dbo].pts_CheckProc 'pts_Ad_FindMemberMemberName'
 GO

CREATE PROCEDURE [dbo].pts_Ad_FindMemberMemberName ( 
...
SELECT TOP 21
            ISNULL(me.CompanyName, '') + dbo.wtfn_FormatNumber(adv.AdID, 10) 'BookMark' ,
            adv.AdID 'AdID' ,
...
AND ISNULL(me.CompanyName, '') + dbo.wtfn_FormatNumber(adv.AdID, 10) >= @BookMark
