EXEC [dbo].pts_CheckProc 'pts_Payment2_FindStatusTypeTotal'
 GO

CREATE PROCEDURE [dbo].pts_Payment2_FindStatusTypeTotal ( 
...
SELECT TOP 21
            ISNULL(CONVERT(nvarchar(15), pa2.Total), '') + dbo.wtfn_FormatNumber(pa2.Payment2ID, 10) 'BookMark' ,
...
WHERE ISNULL(CONVERT(nvarchar(15), pa2.Total), '') LIKE @SearchText + '%'
AND ISNULL(CONVERT(nvarchar(15), pa2.Total), '') + dbo.wtfn_FormatNumber(pa2.Payment2ID, 10) >= @BookMark
