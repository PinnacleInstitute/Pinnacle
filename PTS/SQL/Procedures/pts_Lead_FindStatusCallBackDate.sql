EXEC [dbo].pts_CheckProc 'pts_Lead_FindStatusCallBackDate'
 GO

CREATE PROCEDURE [dbo].pts_Lead_FindStatusCallBackDate ( 
...
SELECT TOP 21
            ISNULL(CONVERT(nvarchar(10), ld.CallBackDate, 112), '') + dbo.wtfn_FormatNumber(ld.LeadID, 10) 'BookMark' ,
            ld.LeadID 'LeadID' ,
...
AND ISNULL(CONVERT(nvarchar(10), ld.CallBackDate, 112), '') + dbo.wtfn_FormatNumber(ld.LeadID, 10) <= @BookMark
