EXEC [dbo].pts_CheckProc 'pts_Prospect_ExpMemberServiceContactName'
 GO

CREATE PROCEDURE [dbo].pts_Prospect_ExpMemberServiceContactName ( 
...
ORDER BY LTRIM(RTRIM(pr.NameLast)) +  ', '  + LTRIM(RTRIM(pr.NameFirst))
