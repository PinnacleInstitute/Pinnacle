EXEC [dbo].pts_CheckProc 'pts_Payment2_FindStatusTypePayType'
 GO

CREATE PROCEDURE [dbo].pts_Payment2_FindStatusTypePayType ( 
...
SELECT TOP 21
            ISNULL(CONVERT(nvarchar(10), pa2.PayType), '') + dbo.wtfn_FormatNumber(pa2.Payment2ID, 10) 'BookMark' ,
...
WHERE ISNULL(CONVERT(nvarchar(10), pa2.PayType), '') LIKE @SearchText + '%'
AND ISNULL(CONVERT(nvarchar(10), pa2.PayType), '') + dbo.wtfn_FormatNumber(pa2.Payment2ID, 10) >= @BookMark
