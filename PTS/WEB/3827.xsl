                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@mode = 11)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ValuesCardMailingList']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@mode = 12)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ValuesCardInProcess']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@mode = 13)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ValuesCardMailed']"/>
                                 </xsl:if>
                           ...
                           <xsl:if test="(/DATA/PARAM/@mode = 11)">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:element name="b">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MailingListText']"/>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
