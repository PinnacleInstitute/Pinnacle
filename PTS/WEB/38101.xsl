                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@mode = 21)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewConsultantMailingList']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@mode = 22)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewConsultantInProcess']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@mode = 23)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewConsultantMailed']"/>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:element name="INPUT">
                                       ...
                                       <xsl:attribute name="value">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ViewNewMembers']"/>
                                       </xsl:attribute>
                                       <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[var URL = document.getElementById('URL').value; window.open(URL);]]></xsl:text></xsl:attribute>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
