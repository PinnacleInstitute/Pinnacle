...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1404URL", reqReturnURL
   SetCache "1404DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1404")
   ...
   Case CLng(cActionUpdate):
      ...
      Else
         With oLeadCampaign
            ...
            .Keywords = Request.Form.Item("Keywords")
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("1404URL")
         reqReturnData = GetCache("1404DATA")
         SetCache "1404URL", ""
         SetCache "1404DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "1404 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1404 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1404 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1404 Load file (oData) failed with error code " + CStr(oData.parseError)
