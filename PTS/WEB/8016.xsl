                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="A">
                                 <xsl:attribute name="href">8002.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;ParentID=<xsl:value-of select="/DATA/PARAM/@parentid"/>&amp;ParentType=<xsl:value-of select="/DATA/PARAM/@parenttype"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
