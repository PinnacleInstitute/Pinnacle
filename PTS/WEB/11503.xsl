      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               <xsl:attribute name="name">DripPage</xsl:attribute>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='DripPage']"/>
                              <xsl:text>:</xsl:text>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:value-of select="/DATA/TXN/PTSDRIPPAGE/@subject"/>
                           </xsl:element>
                        </xsl:element>
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSDRIPPAGE/@subject"/></xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="id">Days</xsl:attribute>
                              <xsl:attribute name="size">2</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSDRIPPAGE/@days"/></xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSDRIPPAGE/PTSSTATUSS/ENUM">
                              ...
                              <xsl:attribute name="name">IsCC</xsl:attribute>
                              <xsl:attribute name="id">IsCC</xsl:attribute>
                              <xsl:attribute name="value">1</xsl:attribute>
                              <xsl:if test="(/DATA/TXN/PTSDRIPPAGE/@iscc = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IsCC']"/>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">prompt</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='DripEditText1']"/>
                                 <xsl:element name="BR"/>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='DripEditText2']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
