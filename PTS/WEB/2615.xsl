            ...
            <xsl:element name="TR">
               <xsl:element name="TD">
                  ...
                  <xsl:element name="A">
                     ...
                     <xsl:attribute name="href"><xsl:value-of select="concat('http://', /DATA/SYSTEM/@servername, /DATA/SYSTEM/@serverpath)"/>2506.asp?G={id}</xsl:attribute>
                  <xsl:element name="b">
                  <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ViewInvitation']"/>
                  </xsl:element>
                  </xsl:element>
               </xsl:element>
            </xsl:element>
