                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ContactNew']"/>
                              <xsl:if test="(/DATA/PARAM/@maxcontacts &gt; 0) and (/DATA/PARAM/@totalcontacts &lt;= /DATA/PARAM/@maxcontacts)">
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    (<xsl:value-of select="concat(/DATA/PARAM/@totalcontacts,' of ',/DATA/PARAM/@maxcontacts)"/>)
                              </xsl:if>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/PARAM/@maxcontacts = 0) or (/DATA/PARAM/@totalcontacts &lt;= /DATA/PARAM/@maxcontacts)">
                                 <xsl:element name="INPUT">
                        ...
                        <xsl:if test="(/DATA/PARAM/@maxcontacts &gt; 0) and (/DATA/PARAM/@totalcontacts &gt; /DATA/PARAM/@maxcontacts)">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MaxContacts']"/>
                                 <xsl:text>:</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 <xsl:value-of select="/DATA/PARAM/@maxcontacts" disable-output-escaping="yes"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
