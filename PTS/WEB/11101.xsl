               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:element name="OPTION">
                                    ...
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Debit']"/>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="INPUT">
                        ...
                        <xsl:if test="(count(/DATA/TXN/PTSPREPAIDS/PTSPREPAID &gt; 0)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="width">750</xsl:attribute>
                                 <xsl:attribute name="align">left</xsl:attribute>
                                 ...
                                 <xsl:element name="TABLE">
                                    ...
                                    <xsl:for-each select="/DATA/TXN/PTSPREPAIDS/PTSPREPAID">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 21)">
                                                   <xsl:element name="A">
                                                      <xsl:attribute name="href">11103.asp?PrepaidID=<xsl:value-of select="@prepaidid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(@paytype = 1)">
                                                   <xsl:variable name="tmp1"><xsl:value-of select="../PTSBONUSS/ENUM[@id=current()/@bonus]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp1]"/>
                                                </xsl:if>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                          </xsl:element>
                                    ...
                                    <xsl:choose>
                                       <xsl:when test="(count(/DATA/TXN/PTSPREPAIDS/PTSPREPAID) = 0)">
                                          <xsl:element name="TR">
                                             <xsl:element name="TD">
                                                <xsl:attribute name="colspan">7</xsl:attribute>
                                                <xsl:attribute name="align">left</xsl:attribute>
