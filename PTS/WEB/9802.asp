...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "9802URL", reqReturnURL
   SetCache "9802DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "9802")
   ...
   Case CLng(cActionAdd):
      ...
      Else
         With oNews
            ...
            tmpDate = CDATE(MONTH(.ActiveDate)&"/"&DAY(.ActiveDate)&"/"&YEAR(.ActiveDate))
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("9802URL")
         reqReturnData = GetCache("9802DATA")
         SetCache "9802URL", ""
         SetCache "9802DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "9802 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "9802 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "9802 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "9802 Load file (oData) failed with error code " + CStr(oData.parseError)
