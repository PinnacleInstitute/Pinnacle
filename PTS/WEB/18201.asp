...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "18201URL", reqReturnURL
   SetCache "18201DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "18201")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      Set oMarkets = server.CreateObject("ptsMarketUser.CMarkets")
      If oMarkets Is Nothing Then
         DoError Err.Number, Err.Source, "Unable to Create Object - ptsMarketUser.CMarkets"
      Else
         With oMarkets
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("18201URL")
      reqReturnData = GetCache("18201DATA")
      SetCache "18201URL", ""
      SetCache "18201DATA", ""
...
xmlTransaction = "<TXN>"
xmlTransaction = xmlTransaction +  xmlMarkets
...
If oLanguage.parseError <> 0 Then
   Response.Write "18201 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "18201 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "18201 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "18201 Load file (oData) failed with error code " + CStr(oData.parseError)
