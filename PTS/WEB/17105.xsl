<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'BarterCategory'"/>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="INPUT">
                              ...
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@display"/></xsl:attribute>
                           </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TestOptions']"/>
                                 <xsl:if test="(/DATA/PARAM/@test != 0)">
                                    <xsl:element name="font">
                                       <xsl:attribute name="color">red</xsl:attribute>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    <xsl:if test="(/DATA/PARAM/@test = 1)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TestSuccess']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@test = 2)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TestFail']"/>
                                    </xsl:if>
                                    </xsl:element>
                                 </xsl:if>
                           </xsl:element>
                        ...
                        <xsl:if test="(/DATA/PARAM/@display = 0)">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/PARAM/@display = 0)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Display']"/>
                                    </xsl:attribute>
                              ...
                              <xsl:if test="(/DATA/PARAM/@display != 0)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Input']"/>
                                    </xsl:attribute>
