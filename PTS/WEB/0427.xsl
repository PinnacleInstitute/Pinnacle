<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="/DATA/LANGUAGE/LABEL[@name='Identification']"/>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="INPUT">
                              ...
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@answer"/></xsl:attribute>
                           </xsl:element>
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">Try</xsl:attribute>
                              <xsl:attribute name="id">Try</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@try"/></xsl:attribute>
                           </xsl:element>
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="class">prompt</xsl:attribute>
                                    ...
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoAnswers']"/>
                                    </xsl:element>
                                    </xsl:element>
                              </xsl:element>
                           </xsl:element>
                        ...
                        <xsl:if test="(/DATA/PARAM/@try != -1)">
                           <xsl:if test="(/DATA/PARAM/@try &gt;= 1) and (/DATA/PARAM/@try &lt;= 3)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="width">400</xsl:attribute>
                                    <xsl:attribute name="align">center</xsl:attribute>
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:attribute name="class">prompt</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AnswerText']"/>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="align">center</xsl:attribute>
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:value-of select="/DATA/PARAM/@question" disable-output-escaping="yes"/>
                           ...
                           <xsl:if test="(/DATA/PARAM/@try != 1)">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:attribute name="class">prompt</xsl:attribute>
                                       <xsl:if test="(/DATA/PARAM/@try = 0)">
                                          <xsl:element name="font">
                                             <xsl:attribute name="color">red</xsl:attribute>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IdentifySuccess']"/>
                                          </xsl:element>
                                       </xsl:if>
                                       <xsl:if test="(/DATA/PARAM/@try = 2)">
                                          <xsl:element name="font">
                                             <xsl:attribute name="color">red</xsl:attribute>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Try2']"/>
                                          </xsl:element>
                                       </xsl:if>
                                       <xsl:if test="(/DATA/PARAM/@try = 3)">
                                          <xsl:element name="font">
                                             <xsl:attribute name="color">red</xsl:attribute>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Try3']"/>
                                          </xsl:element>
                                       </xsl:if>
                                       <xsl:if test="(/DATA/PARAM/@try = 4)">
                                          <xsl:element name="font">
                                             <xsl:attribute name="color">red</xsl:attribute>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Try4']"/>
                                          </xsl:element>
                                       </xsl:if>
                                 </xsl:element>
                              </xsl:element>
