<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Folder Report'"/>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FolderReport']"/>
                              <xsl:text>:</xsl:text>
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(@coursename != '')">
                                                   <xsl:element name="A">
                                                      <xsl:attribute name="onclick">w=window.open(this.href,"FolderCourse","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                      <xsl:attribute name="href">1362.asp?OrgID=<xsl:value-of select="/DATA/PARAM/@orgid"/>&amp;CourseID=<xsl:value-of select="@courseid"/>&amp;FromDate=<xsl:value-of select="/DATA/PARAM/@fromdate"/>&amp;ToDate=<xsl:value-of select="/DATA/PARAM/@todate"/></xsl:attribute>
