...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "2803aURL", reqReturnURL
   SetCache "2803aDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "2803a")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("2803aURL")
         reqReturnData = GetCache("2803aDATA")
         SetCache "2803aURL", ""
         SetCache "2803aDATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "2803a Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "2803a Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "2803a Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "2803a Load file (oData) failed with error code " + CStr(oData.parseError)
