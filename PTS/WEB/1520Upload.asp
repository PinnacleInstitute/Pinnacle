...
'	.MaxFileBytes = 50 * 1024
	...
	.UpLoadPath = Request.ServerVariables("APPL_PHYSICAL_PATH") & "Sections\Company\" & CompanyID & "\Lead\"
...
If Err.number <> 0 Then
	Response.Redirect "1520.asp?CompanyID=" & CompanyID & "&FileName=" + FileName + "&UploadError=" & Err.Number & "&UploadErrorDesc=" & Err.Description
Else
	Response.Redirect "1520.asp?CompanyID=" + CSTR(CompanyID) + "&FileName=" + FileName + "&Status=1"
End If
