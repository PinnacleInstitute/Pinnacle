...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "17011URL", reqReturnURL
   SetCache "17011DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "17011")
...
Sub LoadBarterAreas()
   ...
   Else
      With oBarterAreas
         .SysCurrentLanguage = reqSysLanguage
         .List CLng(reqParentID), CLng(reqCountryID)
         If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
...
If oLanguage.parseError <> 0 Then
   Response.Write "17011 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "17011 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "17011 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "17011 Load file (oData) failed with error code " + CStr(oData.parseError)
