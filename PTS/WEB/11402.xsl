      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               document.getElementById('CopyDripCampaignID').value = obj.options[idx].value;
             }]]></xsl:text>
               </xsl:element>
               ...
               var id = document.getElementById('CopyDripCampaignID').value;
               if( id != 0 )
               {
               var url, win;
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:if test="(/DATA/PARAM/@groupid != 0)">
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">CopyDripCampaignID</xsl:attribute>
                              <xsl:attribute name="id">CopyDripCampaignID</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@copydripcampaignid"/></xsl:attribute>
                           </xsl:element>
                        </xsl:if>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CopyDripCampaign']"/>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/PARAM/@groupid = 0)">
                              <xsl:element name="INPUT">
                                 <xsl:attribute name="type">text</xsl:attribute>
