...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8162URL", reqReturnURL
   SetCache "8162DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8162")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      If (xmlError = "") Then
         Response.Redirect "8161.asp" & "?MemberID=" & reqMemberID
      End If
...
If oLanguage.parseError <> 0 Then
   Response.Write "8162 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8162 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8162 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8162 Load file (oData) failed with error code " + CStr(oData.parseError)
