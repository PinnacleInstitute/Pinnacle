...
'	.MaxFileBytes = 50 * 1024
	...
	.UpLoadPath = Request.ServerVariables("APPL_PHYSICAL_PATH") & "Drip\"
...
If Err.number <> 0 Then
	Response.Redirect "11520.asp?FileName=" + FileName + "&UploadError=" & Err.Number & "&UploadErrorDesc=" & Err.Description
Else
	Response.Redirect "11520.asp?FileName=" + FileName + "&Status=1"
End If
