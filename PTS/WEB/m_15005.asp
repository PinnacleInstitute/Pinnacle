...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_15005URL", reqReturnURL
   SetCache "m_15005DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_15005")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionLogon):
      ...
      Response.Redirect "m_0101.asp" & "?Lgn=" & reqLogon & "&Pwd=" & reqPassword & "&Page=" & "m_MemberHome.asp" & "&ReturnURL=" & reqPageURL & "&ReturnData=" & reqPageData
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_15005 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_15005 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_15005 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_15005 Load file (oData) failed with error code " + CStr(oData.parseError)
