                     ...
                     <xsl:element name="TABLE">
                                 ...
                                 <xsl:attribute name="width">800</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MarketingWebsites']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">500</xsl:attribute>
                                          <xsl:attribute name="align">right</xsl:attribute>
                                          ...
                                          <xsl:element name="b">
                                             ...
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">1402.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewLeadCampaign']"/>
                                             </xsl:element>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="IMG">
                                             ...
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="href">FormBuilder.asp?MemberID=<xsl:value-of select="/DATA/SYSTEM/@memberid"/></xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='LeadCampaignsText']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSLEADCAMPAIGNS/PTSFINDTYPEIDS/ENUM">
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">1403.asp?LeadCampaignID=<xsl:value-of select="@leadcampaignid"/>&amp;CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                <xsl:element name="IMG">
                                       ...
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">left</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:variable name="tmp4"><xsl:value-of select="../PTSPAGETYPES/ENUM[@id=current()/@pagetype]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp4]"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">left</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:choose>
                                             <xsl:when test="(@ismember='0')">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IsMemberFalse']"/>
                                             </xsl:when>
                                             <xsl:otherwise>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IsMemberTrue']"/>
                                             </xsl:otherwise>
                                          </xsl:choose>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:choose>
                                             <xsl:when test="(@isaffiliate='0')">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IsAffiliateFalse']"/>
                                             </xsl:when>
                                             <xsl:otherwise>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IsAffiliateTrue']"/>
                                             </xsl:otherwise>
                                          </xsl:choose>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(@pagetype = 2)">
                                                <xsl:element name="A">
                                                   <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                                   <xsl:attribute name="onclick">w=window.open(this.href,"preview","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                   <xsl:attribute name="href">pp.asp?p=<xsl:value-of select="@leadcampaignid"/></xsl:attribute>
                                                   <xsl:element name="IMG">
                                                      <xsl:attribute name="src">Images/preview.gif</xsl:attribute>
                                                      <xsl:attribute name="border">0</xsl:attribute>
                                                      <xsl:attribute name="alt"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Preview']"/></xsl:attribute>
