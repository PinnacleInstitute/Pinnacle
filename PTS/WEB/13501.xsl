               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:if test="(/DATA/PARAM/@result = 0)">
                           <xsl:if test="(/DATA/TXN/PTSMEMBER/@level = 3) or (/DATA/TXN/PTSMEMBER/@level = 2)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 2) or (/DATA/TXN/PTSMEMBER/@title = 3) or (/DATA/TXN/PTSMEMBER/@title = 4)">
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:if test="/DATA/PARAM/@membership=12">
                                                      <xsl:attribute name="CHECKED"/>
                                                   </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_12']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_12i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:if test="/DATA/PARAM/@membership=13">
                                                      <xsl:attribute name="CHECKED"/>
                                                   </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_13']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_13i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:if test="/DATA/PARAM/@membership=14">
                                                      <xsl:attribute name="CHECKED"/>
                                                   </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_14']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_14i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
