...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0113URL", reqReturnURL
   SetCache "0113DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0113")
   ...
   Case CLng(cActionUpdate):
      ...
      Else
         With oAuthUser
            ...
            End If
            If (xmlError = "") Then
               .UpdateLogonPassword CLng(reqSysUserID)
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            End If
            If (xmlError = "") Then
               .UpdateUserType CLng(reqSysUserID)
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            End If
            If (xmlError <> "") Then
               xmlAuthUser = .XML()
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("0113URL")
         reqReturnData = GetCache("0113DATA")
         SetCache "0113URL", ""
         SetCache "0113DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "0113 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0113 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0113 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0113 Load file (oData) failed with error code " + CStr(oData.parseError)
