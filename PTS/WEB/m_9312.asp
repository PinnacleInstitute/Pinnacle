...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_9312URL", reqReturnURL
   SetCache "m_9312DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_9312")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oPages
            .SysCurrentLanguage = reqSysLanguage
            .ListPage CLng(reqCompanyID), tmpGroupID, tmpGroupID1, tmpGroupID2, tmpGroupID3, CLng(reqPageType)
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
   ...
   Case CLng(cActionReturn):
      ...
      reqReturnURL = GetCache("m_9312URL")
      reqReturnData = GetCache("m_9312DATA")
      SetCache "m_9312URL", ""
      SetCache "m_9312DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_9312 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_9312 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_9312 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_9312 Load file (oData) failed with error code " + CStr(oData.parseError)
