...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "5020URL", reqReturnURL
   SetCache "5020DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "5020")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      SetCache "PRODUCTID", reqProductID
End Select
...
If oLanguage.parseError <> 0 Then
   Response.Write "5020 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "5020 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "5020 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "5020 Load file (oData) failed with error code " + CStr(oData.parseError)
