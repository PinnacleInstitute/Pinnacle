                     ...
                     <xsl:element name="TABLE">
                                 ...
                                 <xsl:attribute name="width">600</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Employees']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">500</xsl:attribute>
                                          <xsl:attribute name="align">right</xsl:attribute>
                                          ...
                                          <xsl:element name="A">
                                             ...
                                             <xsl:attribute name="href">9021.asp?UserType=2&amp;Reminder=0</xsl:attribute>
                                          ...
                                          <xsl:element name="A">
                                             <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                             <xsl:attribute name="onclick">w=window.open(this.href,"Summary","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                             <xsl:attribute name="href">9021.asp?UserType=2&amp;Reminder=1</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ReminderSummary']"/>
                                          </xsl:element>
                                          <xsl:text disable-output-escaping="yes">&amp;#160;|&amp;#160;</xsl:text>
                                          <xsl:element name="A">
                                             <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                             <xsl:attribute name="href">0202.asp?ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewEmployee']"/>
                                          </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='EmployeeFindText']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSEMPLOYEES/PTSFINDTYPEIDS/ENUM">
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:element name="TR">
                                    ...
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:attribute name="class">ColumnTitle</xsl:attribute>
                                       <xsl:attribute name="valign">Bottom</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='UserGroup']"/>
                                    </xsl:element>
                                    <xsl:element name="TD">
                                       <xsl:attribute name="align">left</xsl:attribute>
                                       <xsl:attribute name="width">10%</xsl:attribute>
                                       <xsl:attribute name="class">ColumnTitle</xsl:attribute>
                                       <xsl:attribute name="valign">Bottom</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='UserStatus']"/>
                                    </xsl:element>
                                 </xsl:element>
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSEMPLOYEES/PTSEMPLOYEE">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:element name="A">
                                             <xsl:attribute name="href">0203.asp?EmployeeID=<xsl:value-of select="@employeeid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">left</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:variable name="tmp4"><xsl:value-of select="../PTSUSERGROUPS/ENUM[@id=current()/@usergroup]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp4]"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">left</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:variable name="tmp5"><xsl:value-of select="../PTSUSERSTATUSS/ENUM[@id=current()/@userstatus]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp5]"/>
                                       </xsl:element>
                                    </xsl:element>
                                 </xsl:for-each>
                                 <xsl:choose>
                                    <xsl:when test="(count(/DATA/TXN/PTSEMPLOYEES/PTSEMPLOYEE) = 0)">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             <xsl:attribute name="colspan">5</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
