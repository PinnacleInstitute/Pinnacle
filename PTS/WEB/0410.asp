...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0410URL", reqReturnURL
   SetCache "0410DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0410")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("0410URL")
      reqReturnData = GetCache("0410DATA")
      SetCache "0410URL", ""
      SetCache "0410DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "0410 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0410 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0410 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0410 Load file (oData) failed with error code " + CStr(oData.parseError)
