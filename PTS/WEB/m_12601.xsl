                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">m_12603.asp?ContestID=<xsl:value-of select="@contestid"/>&amp;Private=<xsl:value-of select="/DATA/PARAM/@private"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                <xsl:element name="IMG">
                                             ...
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="href">m_11710.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;OwnerContestID=<xsl:value-of select="@contestid"/></xsl:attribute>
                                                <xsl:element name="IMG">
