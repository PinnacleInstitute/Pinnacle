<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Survey Questions'"/>
               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:if test="(/DATA/PARAM/@mode = 99)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">2</xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@mode = 1)">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Congrats']"/>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                        ...
                        <xsl:if test="(/DATA/PARAM/@mode = 0)">
                           ...
                           <xsl:if test="(count(/DATA/TXN/PTSSURVEYQUESTIONS/PTSSURVEYQUESTION) &gt; 0)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:attribute name="class">Prompt</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SurveyHelp']"/>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                           ...
                           <xsl:element name="TR">
                              <xsl:for-each select="/DATA/TXN/PTSSURVEYQUESTIONS/PTSSURVEYQUESTION[position()]">
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          <xsl:attribute name="colspan">2</xsl:attribute>
                                          <xsl:attribute name="width">600</xsl:attribute>
                                       ...
                                       <xsl:for-each select="/DATA/TXN/PTSSURVEYCHOICES/PTSSURVEYCHOICE[(@surveyquestionid = current()/@surveyquestionid)]">
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="name"><xsl:value-of select="@surveyquestionid"/></xsl:attribute>
                                                   <xsl:attribute name="id"><xsl:value-of select="@surveyquestionid"/></xsl:attribute>
                                                   <xsl:attribute name="value"><xsl:value-of select="@surveychoiceid"/></xsl:attribute>
                                                   <xsl:if test="/DATA/TXN/PTSSURVEYANSWERS/PTSSURVEYANSWER[@surveychoiceid=current()/@surveychoiceid]">
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:element name="TEXTAREA">
                                                <xsl:attribute name="name">T<xsl:value-of select="@surveyquestionid"/></xsl:attribute>
                                                <xsl:attribute name="id">T<xsl:value-of select="@surveyquestionid"/></xsl:attribute>
                                                <xsl:attribute name="rows">4</xsl:attribute>
                                                <xsl:attribute name="cols">68</xsl:attribute>
                                                <xsl:value-of select="/DATA/TXN/PTSSURVEYANSWERS/PTSSURVEYANSWER[@surveyquestionid=current()/@surveyquestionid]/@answer"/>
                                             </xsl:element>
                                          </xsl:element>
                                       </xsl:element>
                                    </xsl:if>
