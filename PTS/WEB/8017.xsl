<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Mini Documents'"/>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(contains(/DATA/SYSTEM/@useroptions, 'U'))">
                                                ...
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">Tutorial.asp?Lesson=36&amp;contentpage=3&amp;popup=1</xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@attachmentcount &gt; 0)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MyAttachText']"/>
                              </xsl:element>
                           </xsl:element>
                        </xsl:if>
                        ...
                        <xsl:if test="(/DATA/PARAM/@attachmentcount = 0)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:attribute name="class">prompt</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoAttach']"/>
                              </xsl:element>
                           </xsl:element>
                        </xsl:if>
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                ...
                                                <xsl:value-of select="@attachname"/>
                                                   <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                   <xsl:element name="A">
                                                      <xsl:attribute name="href">8003.asp?AttachmentID=<xsl:value-of select="@attachmentid"/>&amp;ContentPage=3&amp;Mini=1&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                      <xsl:element name="IMG">
