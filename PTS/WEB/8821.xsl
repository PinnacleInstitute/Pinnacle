                     ...
                     <xsl:element name="TABLE">
                                 ...
                                 <xsl:attribute name="width">600</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TeamEmailManager']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">400</xsl:attribute>
                                          <xsl:attribute name="align">right</xsl:attribute>
                                          ...
                                          <xsl:element name="b">
                                             ...
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">8822.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewTeamEmail']"/>
                                             </xsl:element>
                                          </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TeamEmailManagerText']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:if test="(@issalesstep != 0)">
                                                <xsl:element name="IMG">
                                                   <xsl:attribute name="src">Images/SmartPhone.gif</xsl:attribute>
                                                   <xsl:attribute name="align">absmiddle</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                </xsl:element>
                                             </xsl:if>
                                             ...
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">8823.asp?EmailID=<xsl:value-of select="@emailid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                <xsl:element name="IMG">
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="font">
                                             ...
                                             <xsl:text>:</xsl:text>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                             <xsl:if test="(not(@testdata1))">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AllStatus']"/>
                                             </xsl:if>
                                             <xsl:if test="(@testdata1)">
                                                <xsl:value-of select="@testdata1"/>
                                             </xsl:if>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;&amp;#160;</xsl:text>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Level']"/>
                                             <xsl:text>:</xsl:text>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                             <xsl:if test="(not(@testdata2))">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AllLevel']"/>
                                             </xsl:if>
                                             <xsl:if test="(@testdata2)">
                                                <xsl:value-of select="@testdata2"/>
                                             </xsl:if>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;&amp;#160;</xsl:text>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title']"/>
                                             <xsl:text>:</xsl:text>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                             <xsl:if test="(not(@testdata3))">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AllTitle']"/>
                                             </xsl:if>
                                             <xsl:if test="(@testdata3)">
                                                <xsl:value-of select="@testdata3"/>
                                             </xsl:if>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;&amp;#160;</xsl:text>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='EnrolledFrom']"/>
                                             <xsl:text>:</xsl:text>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                             <xsl:if test="(not(@testdata4))">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Forever']"/>
                                             </xsl:if>
                                             <xsl:if test="(@testdata4)">
                                                <xsl:value-of select="@testdata4"/>
                                             </xsl:if>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='EnrolledTo']"/>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:if test="(not(@testdata5))">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Forever']"/>
                                             </xsl:if>
                                             <xsl:if test="(@testdata5)">
                                                <xsl:value-of select="@testdata5"/>
                                             </xsl:if>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;&amp;#160;</xsl:text>
                                             <xsl:element name="A">
                                                <xsl:attribute name="onclick">w=window.open(this.href,"EmailList","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                <xsl:attribute name="href">8824.asp?EmailID=<xsl:value-of select="@emailid"/></xsl:attribute>
                                                <xsl:element name="IMG">
