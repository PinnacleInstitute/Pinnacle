...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "13803URL", reqReturnURL
   SetCache "13803DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "13803")
...
reqProduct =  GetInput("Product", reqPageData)
...
xmlParam = xmlParam + " product=" + Chr(34) + CleanXML(reqProduct) + Chr(34)
...
fileLanguage = "Language" + "\13803[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\13803[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "13803 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "13803 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "13803 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "13803 Load file (oData) failed with error code " + CStr(oData.parseError)
