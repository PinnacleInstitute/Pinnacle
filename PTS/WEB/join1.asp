...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "join1URL", reqReturnURL
   SetCache "join1DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "join1")
      ...
      Else
         With oMachine
            ...
            If Result <> "OK" Then 
               ...
               SendEmail "support@CloudZow.com", "support@CloudZow.com", "support@CloudZow.com", "ENROLL COMPUTER ERROR: " + .Email, .NameFirst + " " + .NameLast + " - " + .LiveDriveID + " - " + Result
            Else
               'Email Support for new computer limits
               SendEmail "support@CloudZow.com", "support@CloudZow.com", "limit@CloudZow.com", "NEW COMPUTER: " + .Email, .NameFirst + " " + .NameLast + " - " + .LiveDriveID
            End If   
...
fileLanguage = "Language\join1[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\join1[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "join1 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "join1 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "join1 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "join1 Load file (oData) failed with error code " + CStr(oData.parseError)
