      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               <xsl:attribute name="name">Zazzed</xsl:attribute>
               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                           ...
                           <xsl:if test="(/DATA/PARAM/@result = 2)">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:attribute name="class">PageHeading</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='WBNotice']"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:if>
                        ...
                        <xsl:if test="(/DATA/PARAM/@result = 0)">
                           <xsl:if test="(/DATA/PARAM/@binary = 2)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">2</xsl:attribute>
                                    <xsl:attribute name="height">24</xsl:attribute>
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                   <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_6']"/>
                                                   </xsl:if>
                                                   <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_6i']"/>
                                                   </xsl:if>
                                                   <xsl:element name="BR"/>
                                                   <xsl:if test="(/DATA/PARAM/@binary = 0)">
                                                      <xsl:element name="font">
                                                         <xsl:attribute name="color">blue</xsl:attribute>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_Binary']"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                             </xsl:element>
                                          </xsl:element>

                                          <xsl:if test="(/DATA/PARAM/@binary = 0) or (/DATA/PARAM/@binary = 3)">
                                             <xsl:element name="TR">
                                                <xsl:element name="TD">
                                                   <xsl:attribute name="colspan">3</xsl:attribute>
                                                   <xsl:attribute name="height">12</xsl:attribute>
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_7']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_7i']"/>
                                                      </xsl:if>
                                                      <xsl:element name="BR"/>
                                                      <xsl:if test="(/DATA/PARAM/@binary = 0)">
                                                         <xsl:element name="font">
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@binary = 0)">
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_3']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_3i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@binary = 0)">
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_4']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_4i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@binary = 0)">
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_1']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_1i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@binary = 0)">
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_2']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_2i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@binary = 0)">
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="align">left</xsl:attribute>
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership9_0']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>
