...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "2305URL", reqReturnURL
   SetCache "2305DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "2305")
...
If oLanguage.parseError <> 0 Then
   Response.Write "2305 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "2305 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "2305 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "2305 Load file (oData) failed with error code " + CStr(oData.parseError)
