...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "14800URL", reqReturnURL
   SetCache "14800DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "14800")
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         ...
         If (reqProcess = 30) Then
            ...
            Set oFreeLoyaltys = server.CreateObject("ptsFreeLoyaltyUser.CFreeLoyaltys")
            If oFreeLoyaltys Is Nothing Then
               DoError Err.Number, Err.Source, "Unable to Create Object - ptsFreeLoyaltyUser.CFreeLoyaltys"
            Else
               With oFreeLoyaltys
                  .SysCurrentLanguage = reqSysLanguage
                  .CustomList 3, 0, 0, 0
...
xmlTransaction = xmlTransaction +  xmlFreeLoyaltys
...
fileLanguage = "Language" + "\14800[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\14800[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "14800 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "14800 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "14800 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "14800 Load file (oData) failed with error code " + CStr(oData.parseError)
