...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8020URL", reqReturnURL
   SetCache "8020DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8020")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      SetCache "ATTACHMENTID", reqAttachmentID
      SetCache "CONTENTPAGE", reqContentPage
      SetCache "MINI", reqMini
End Select
...
If oLanguage.parseError <> 0 Then
   Response.Write "8020 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8020 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8020 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8020 Load file (oData) failed with error code " + CStr(oData.parseError)
