<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Monthly Payment Schedule'"/>
            ...
            <xsl:element name="FORM">
               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:attribute name="width">1050</xsl:attribute>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:for-each select="/DATA/TXN/PTSYEARS/PTSYEAR">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="width">1050</xsl:attribute>
                                    <xsl:attribute name="align">left</xsl:attribute>
                                       ...
                                       <xsl:attribute name="style">border: 1px #5084A2 solid</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Jan']"/>
                                                </xsl:element>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Feb']"/>
                                                </xsl:element>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Mar']"/>
                                                </xsl:element>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Apr']"/>
                                                </xsl:element>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:element name="TD">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Jun']"/>
                                                </xsl:element>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Jul']"/>
                                                </xsl:element>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Aug']"/>
                                                </xsl:element>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Sep']"/>
                                                </xsl:element>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Oct']"/>
                                                </xsl:element>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Nov']"/>
                                                </xsl:element>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Dec']"/>
                                                </xsl:element>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:for-each select="/DATA/TXN/PTSDAS/PTSDA[(@year = current()/@year)]">
                                                <xsl:element name="TR">
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         ...
                                                         <xsl:value-of select="@jan1"/>
                                                         </xsl:element>
                                                         <xsl:element name="BR"/>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@jan2"/>
                                                         </xsl:element>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">75</xsl:attribute>
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@feb1"/>
                                                         </xsl:element>
                                                         <xsl:element name="BR"/>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@feb2"/>
                                                         </xsl:element>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">75</xsl:attribute>
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@mar1"/>
                                                         </xsl:element>
                                                         <xsl:element name="BR"/>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@mar2"/>
                                                         </xsl:element>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">75</xsl:attribute>
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@apr1"/>
                                                         </xsl:element>
                                                         <xsl:element name="BR"/>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@apr2"/>
                                                         </xsl:element>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">75</xsl:attribute>
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@may1"/>
                                                         </xsl:element>
                                                         <xsl:element name="BR"/>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@may2"/>
                                                         </xsl:element>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">75</xsl:attribute>
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@jun1"/>
                                                         </xsl:element>
                                                         <xsl:element name="BR"/>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@jun2"/>
                                                         </xsl:element>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">75</xsl:attribute>
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@jul1"/>
                                                         </xsl:element>
                                                         <xsl:element name="BR"/>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@jul2"/>
                                                         </xsl:element>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">75</xsl:attribute>
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@aug1"/>
                                                         </xsl:element>
                                                         <xsl:element name="BR"/>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@aug2"/>
                                                         </xsl:element>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">75</xsl:attribute>
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@oct1"/>
                                                         </xsl:element>
                                                         <xsl:element name="BR"/>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@oct2"/>
                                                         </xsl:element>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">75</xsl:attribute>
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@nov1"/>
                                                         </xsl:element>
                                                         <xsl:element name="BR"/>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@nov2"/>
                                                         </xsl:element>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">75</xsl:attribute>
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@dec1"/>
                                                         </xsl:element>
                                                         <xsl:element name="BR"/>
                                                         <xsl:element name="font">
                                                            <xsl:attribute name="size">1</xsl:attribute>
                                                         <xsl:value-of select="@dec2"/>
                                                         </xsl:element>
                                                   </xsl:element>
                                                </xsl:element>
