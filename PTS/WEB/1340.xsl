			             ...
			             <xsl:element name="TR">
			               <xsl:element name="TD">
			                  ...
			                  <xsl:attribute name="height">15%</xsl:attribute>
							   <xsl:element name="IMG">
								   <xsl:attribute name="src"><xsl:value-of select="/DATA/PARAM/@header"/></xsl:attribute>
								   <xsl:attribute name="height">100%</xsl:attribute>
							   </xsl:element>
				            </xsl:element>
			            </xsl:element>
			             ...
			             <xsl:element name="TR">
			               <xsl:element name="TD">
			                  ...
			                  <xsl:attribute name="height">11%</xsl:attribute>
									<xsl:choose>
										<xsl:when test="/DATA/PARAM/@status&gt;=7"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Certification']"/></xsl:when>
										<xsl:otherwise><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Completion']"/></xsl:otherwise>
									</xsl:choose>
			               </xsl:element>
			            </xsl:element>
