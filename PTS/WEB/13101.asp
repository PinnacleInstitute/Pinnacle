...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "13101URL", reqReturnURL
   SetCache "13101DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "13101")
...
Select Case CLng(reqActionCode)
            ...
            Else
               With oMember
                  ...
                  tmpTo = .Email
                     ...
                     tmpSender = "support@pb.com"
                     tmpFrom = "support@pb.com"
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("13101URL")
      reqReturnData = GetCache("13101DATA")
      SetCache "13101URL", ""
      SetCache "13101DATA", ""
...
fileLanguage = "Language" + "\13101[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\13101[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "13101 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "13101 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "13101 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "13101 Load file (oData) failed with error code " + CStr(oData.parseError)
