<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Nexxus Dashboard'"/>
                     ...
                     <xsl:element name="TABLE">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:element name="IMG">
                                    <xsl:attribute name="src">Images/Dashboard48c.png</xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/TXN/PTSDASH/@f != 0)">
                                    <xsl:element name="IMG">
                                       <xsl:attribute name="src">Images/IsLocked.gif</xsl:attribute>
                                       <xsl:attribute name="align">absmiddle</xsl:attribute>
                                       <xsl:attribute name="border">0</xsl:attribute>
                                    </xsl:element>
                              </xsl:if>
                                             ...
                                             <xsl:attribute name="style">border: 1px #5084A2 solid</xsl:attribute>
                                                ...
                                                <xsl:element name="TR">
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         ...
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 11)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title11']"/>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TR">
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="align">right</xsl:attribute>
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='PayTitle']"/>
                                                      <xsl:text>:</xsl:text>
                                                      <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:element name="IMG">
                                                            <xsl:attribute name="src">Images/Company/<xsl:value-of select="/DATA/TXN/PTSMEMBER/@companyid"/>/Title<xsl:value-of select="/DATA/TXN/PTSMEMBER/@title2"/>.gif</xsl:attribute>
                                                            <xsl:attribute name="align">absmiddle</xsl:attribute>
                                                            <xsl:attribute name="border">0</xsl:attribute>
                                                         </xsl:element>
                                                         <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 1)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title1']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 2)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title2']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 3)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title3']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 4)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title4']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 5)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title5']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 6)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title6']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 7)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title7']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 8)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title8']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 9)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title9']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 10)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title10']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 11)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title11']"/>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                ...
                                                <xsl:element name="TR">
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         ...
                                                         <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title &gt;= 5) and (/DATA/TXN/PTSMEMBER/@title &lt;= 7)">
                                                         ...
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 10)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Need11']"/>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                <xsl:element name="TR">
                                             ...
                                             <xsl:attribute name="style">border: 1px #5084A2 solid</xsl:attribute>
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         ...
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q1 = 1)">
                                                            ...
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NotActive']"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q1 = 2)">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoPayment']"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q1 = 3)">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoReferrals']"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         ...
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q2 = 2)">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoPayoutMethod']"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q2 = 3)">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoTaxID']"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                ...
                                                <xsl:element name="TR">
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="align">right</xsl:attribute>
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TeamQualified']"/>
                                                      <xsl:text>:</xsl:text>
                                                      <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="align">center</xsl:attribute>
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q1 != 0) or (/DATA/TXN/PTSMEMBER/@title2 &lt; 3)">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='None']"/>
                                                            </xsl:element>
                                                         ...
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q1 = 0)">
                                                            ...
                                                            <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 5)">
                                                               <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Level6']"/>
                                                            </xsl:if>
                                                            <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 6)">
                                                               <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Level8']"/>
                                                            </xsl:if>
                                                            <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 7)">
                                                               <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Level10']"/>
                                                            </xsl:if>
                                                            <xsl:if test="(/DATA/TXN/PTSMEMBER/@title2 = 8)">
                                                               <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Level12']"/>
                                                            </xsl:if>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                             ...
                                             <xsl:attribute name="style">border: 1px #5084A2 solid</xsl:attribute>
                                                ...
                                                <xsl:element name="TR">
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="align">right</xsl:attribute>
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FirstOrder']"/>
                                                      <xsl:text>:</xsl:text>
                                                      <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="align">center</xsl:attribute>
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@b3 = '')">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='None']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@b3 != '')">
                                                            <xsl:value-of select="/DATA/TXN/PTSDASH/@b3"/>
                                                         </xsl:if>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">100</xsl:attribute>
                                                      <xsl:attribute name="align">center</xsl:attribute>
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@b4 != '')">
                                                            <xsl:value-of select="/DATA/TXN/PTSDASH/@b4"/>
                                                         </xsl:if>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">100</xsl:attribute>
                                                ...
                                                <xsl:if test="(/DATA/TXN/PTSDASH/@l31 != '')">
                                                   <xsl:element name="TR">
                                                      <xsl:element name="TD">
                                                         ...
                                                         <xsl:attribute name="valign">center</xsl:attribute>
                                                            <xsl:element name="b">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='D1Leader']"/>
                                                            <xsl:text>:</xsl:text>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                            </xsl:element>
                                                ...
                                                <xsl:if test="(/DATA/TXN/PTSDASH/@l41 != '')">
                                                   <xsl:element name="TR">
                                                      <xsl:element name="TD">
                                                         ...
                                                         <xsl:attribute name="valign">center</xsl:attribute>
                                                            <xsl:element name="b">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='D2Leader']"/>
                                                            <xsl:text>:</xsl:text>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                            </xsl:element>
                                                ...
                                                <xsl:if test="(/DATA/TXN/PTSDASH/@l51 != '')">
                                                   <xsl:element name="TR">
                                                      <xsl:element name="TD">
                                                         ...
                                                         <xsl:attribute name="valign">center</xsl:attribute>
                                                            <xsl:element name="b">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='D3Leader']"/>
                                                            <xsl:text>:</xsl:text>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                            </xsl:element>
