...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1405URL", reqReturnURL
   SetCache "1405DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1405")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("1405URL")
         reqReturnData = GetCache("1405DATA")
         SetCache "1405URL", ""
         SetCache "1405DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "1405 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1405 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1405 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1405 Load file (oData) failed with error code " + CStr(oData.parseError)
