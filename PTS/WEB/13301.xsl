<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Change Membership'"/>
      ...
      <xsl:element name="BODY">
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:attribute name="onload">document.getElementById('IsAgree2').focus()</xsl:attribute>
            </xsl:otherwise>
         </xsl:choose>
      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               <xsl:attribute name="name">GFTG</xsl:attribute>
                                    ...
                                    <xsl:attribute name="width">750</xsl:attribute>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="align">left</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_0']"/>
                                          </xsl:element>
                                       </xsl:element>
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                   <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_0_1']"/>
                                                   </xsl:if>
                                                   <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_0_1i']"/>
                                                   </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                       </xsl:if>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 0)">
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_0_2']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_0_2i']"/>
                                                      </xsl:if>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 1)">
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_1_2']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_1_2i']"/>
                                                      </xsl:if>
                                                </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                       ...
                                       <xsl:if test="(/DATA/TXN/PTSMEMBER/@title &lt; 3)">
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 0)">
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_0_3']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_0_3i']"/>
                                                      </xsl:if>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 1)">
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_1_3']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_1_3i']"/>
                                                      </xsl:if>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 2)">
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_2_3']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_2_3i']"/>
                                                      </xsl:if>
                                                </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                       ...
                                       <xsl:if test="(/DATA/TXN/PTSMEMBER/@title &lt; 4)">
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 0)">
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_0_4']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_0_4i']"/>
                                                      </xsl:if>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 1)">
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_1_4']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_1_4i']"/>
                                                      </xsl:if>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 2)">
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_2_4']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_2_4i']"/>
                                                      </xsl:if>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 3)">
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_3_4']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_3_4i']"/>
                                                      </xsl:if>
                                                </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:element name="font">
                                                <xsl:attribute name="color">blue</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_Text1']"/>
                                             </xsl:element>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_1']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_1i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_2']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_2i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="id">OrderOption</xsl:attribute>
                                             <xsl:attribute name="value">3</xsl:attribute>
                                             <xsl:if test="/DATA/PARAM/@orderoption=3">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_3']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_3i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="id">OrderOption</xsl:attribute>
                                             <xsl:attribute name="value">4</xsl:attribute>
                                             <xsl:if test="/DATA/PARAM/@orderoption=4">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_4']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_4i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=5">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_5']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_5i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=6">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_6']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_6i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=7">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_7']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption_7i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:element name="font">
                                                <xsl:attribute name="color">blue</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_Text2']"/>
                                             </xsl:element>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=21">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_21']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_21i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=22">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_22']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_22i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=23">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_23']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_23i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=24">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_24']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_24i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=25">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_25']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_25i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=26">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_26']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_26i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=27">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_27']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_27i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:element name="font">
                                                <xsl:attribute name="color">blue</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_Text3']"/>
                                             </xsl:element>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=31">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_31']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_31i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=32">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_32']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_32i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=33">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_33']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_33i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=34">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_34']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_34i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:if test="/DATA/PARAM/@orderoption=35">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_35']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_35i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="name">OrderOption</xsl:attribute>
                                             <xsl:attribute name="id">OrderOption</xsl:attribute>
                                             <xsl:attribute name="value">36</xsl:attribute>
                                             <xsl:if test="/DATA/PARAM/@orderoption=36">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_36']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_36i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="name">OrderOption</xsl:attribute>
                                             <xsl:attribute name="id">OrderOption</xsl:attribute>
                                             <xsl:attribute name="value">37</xsl:attribute>
                                             <xsl:if test="/DATA/PARAM/@orderoption=37">
                                                <xsl:attribute name="CHECKED"/>
                                             </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_37']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption13_37i']"/>
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                       </xsl:element>
