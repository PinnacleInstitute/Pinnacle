<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Friend'"/>
      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               <xsl:attribute name="name">Friend</xsl:attribute>
               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Friend']"/>
                                 <xsl:text>:</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 <xsl:if test="(/DATA/TXN/PTSFRIEND/@status = 1)">
                                    <xsl:element name="font">
                                       <xsl:attribute name="color">orange</xsl:attribute>
                                    <xsl:value-of select="/DATA/TXN/PTSFRIEND/@friendname"/>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    -
                                    <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                    <xsl:variable name="tmp3"><xsl:value-of select="/DATA/TXN/PTSFRIEND/PTSSTATUSS/ENUM[@id=/DATA/TXN/PTSFRIEND/@status]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp3]"/>
                                    </xsl:element>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/TXN/PTSFRIEND/@status = 2)">
                                    <xsl:value-of select="/DATA/TXN/PTSFRIEND/@friendname"/>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    -
                                    <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@emailfriend != 0)">
                                    <xsl:element name="font">
                                       <xsl:attribute name="color">blue</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='EmailedFriend']"/>
                                    </xsl:element>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">prompt</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FriendEditHelp']"/>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                 <xsl:if test="(/DATA/TXN/PTSFRIEND/@status = 1)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FriendEditHelpa']"/>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:attribute name="valign">center</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FriendName']"/>
                                       <xsl:text>:</xsl:text>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    </xsl:element>
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSFRIEND/@namefirst"/></xsl:attribute>
                                       </xsl:element>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                    ...
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:attribute name="size">25</xsl:attribute>
                                       <xsl:attribute name="maxlength">30</xsl:attribute>
                                       <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSFRIEND/@namelast"/></xsl:attribute>
                                       </xsl:element>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                       <xsl:element name="IMG">
                                          <xsl:attribute name="src">Images/Required.gif</xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/SYSTEM/@usergroup &gt; 23) and (/DATA/SYSTEM/@usergroup != 51) and (/DATA/SYSTEM/@usergroup != 52) and (/DATA/TXN/PTSFRIEND/@status = 2)">
                              <xsl:element name="INPUT">
                                 <xsl:attribute name="type">hidden</xsl:attribute>
                                 <xsl:attribute name="name">Email</xsl:attribute>
                                 <xsl:attribute name="id">Email</xsl:attribute>
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSFRIEND/@email"/></xsl:attribute>
                              </xsl:element>
                           ...
                           <xsl:element name="TR">
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:element name="b">
                                 <xsl:value-of select="/DATA/TXN/PTSFRIEND/@email"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>

                        </xsl:if>
                        <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51) or (/DATA/SYSTEM/@usergroup = 52) or (/DATA/TXN/PTSFRIEND/@status != 2)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">2</xsl:attribute>
                                 <xsl:attribute name="height">6</xsl:attribute>
                        ...
                        <xsl:if test="(count(/DATA/TXN/PTSFRIENDGROUPS/ENUM) &gt; 1)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">2</xsl:attribute>
                                 <xsl:attribute name="height">6</xsl:attribute>
                           ...
                           <xsl:element name="TR">
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="SELECT">
                                    ...
                                    <xsl:variable name="tmp"><xsl:value-of select="/DATA/TXN/PTSFRIEND/@friendgroupid"/></xsl:variable>
                        ...
                        <xsl:if test="(/DATA/PARAM/@editstatus = 0)">
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">Status</xsl:attribute>
                              <xsl:attribute name="id">Status</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSFRIEND/@status"/></xsl:attribute>
                           </xsl:element>
                        </xsl:if>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="align">right</xsl:attribute>
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FriendDate']"/>
                              <xsl:text>:</xsl:text>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                           </xsl:element>
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="INPUT">
                              <xsl:attribute name="type">text</xsl:attribute>
                              <xsl:attribute name="name">FriendDate</xsl:attribute>
                              <xsl:attribute name="id">FriendDate</xsl:attribute>
                              <xsl:attribute name="size">10</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSFRIEND/@frienddate"/></xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="IMG">
                                 ...
                                 <xsl:attribute name="border">0</xsl:attribute>
                                 <xsl:attribute name="onclick">CalendarPopup(document.forms[0], document.getElementById('FriendDate'))</xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/PARAM/@editstatus != 0)">
                              ...
                              <xsl:if test="(/DATA/PARAM/@editstatus != 0)">
                                 <xsl:element name="SELECT">
                                    <xsl:attribute name="name">Status</xsl:attribute>
                                    <xsl:attribute name="id">Status</xsl:attribute>
                                    <xsl:for-each select="/DATA/TXN/PTSFRIEND/PTSSTATUSS/ENUM">
                                       <xsl:element name="OPTION">
                                          <xsl:attribute name="value"><xsl:value-of select="@id"/></xsl:attribute>
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:element name="TR">
                                    ...
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSFRIEND/@zip"/></xsl:attribute>
                                       </xsl:element>
                                    </xsl:element>
                                    <xsl:element name="TD">
                                       <xsl:attribute name="width">400</xsl:attribute>
                                       ...
                                       <xsl:element name="SELECT">
                                          ...
                                          <xsl:variable name="tmp"><xsl:value-of select="/DATA/TXN/PTSFRIEND/@countryid"/></xsl:variable>
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="INPUT">
                              <xsl:attribute name="type">text</xsl:attribute>
                              <xsl:attribute name="name">DOB</xsl:attribute>
                              <xsl:attribute name="id">DOB</xsl:attribute>
                              <xsl:attribute name="size">10</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSFRIEND/@dob"/></xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="IMG">
                                 <xsl:attribute name="name">Calendar</xsl:attribute>
                                 ...
                                 <xsl:attribute name="height">16</xsl:attribute>
                                 <xsl:attribute name="border">0</xsl:attribute>
                                 <xsl:attribute name="onclick">CalendarPopup(document.forms[0], document.getElementById('DOB'))</xsl:attribute>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/TXN/PTSFRIEND/@status = 1)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='EmailFriend']"/>
                                    </xsl:attribute>
