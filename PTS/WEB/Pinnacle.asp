...
pos = InStr(LCASE(reqSysServerPath), "pinnacle")
...
If oLanguage.parseError <> 0 Then
   Response.Write "Pinnacle Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
xslPage = "Pinnacle.xsl"
Set oStyle = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oStyle.load server.MapPath(xslPage)
If oStyle.parseError <> 0 Then
   Response.Write "Pinnacle Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "Pinnacle Load file (oData) failed with error code " + CStr(oData.parseError)
