<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Success Track'"/>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GoalTemplate']"/>
                              <xsl:if test="(contains(/DATA/SYSTEM/@useroptions, 'U'))">
                                 <xsl:if test="(/DATA/TXN/PTSGOAL/@template = 0) or (/DATA/TXN/PTSGOAL/@template = 3)">
                                       ...
                                       <xsl:element name="A">
                                          ...
                                          <xsl:attribute name="href">Tutorial.asp?Lesson=10&amp;contentpage=3&amp;popup=1</xsl:attribute>
                                          <xsl:element name="IMG">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CopyGoalTemplate']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:element name="b">
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SelectTemplates']"/>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="name">TList</xsl:attribute>
                              <xsl:attribute name="id">TList</xsl:attribute>
                              <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[doSubmit(0,"")]]></xsl:text></xsl:attribute>
                              <xsl:attribute name="value">0</xsl:attribute>
                              <xsl:if test="/DATA/PARAM/@tlist=0">
                                 <xsl:attribute name="CHECKED"/>
                              </xsl:if>
                              </xsl:element>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CompanyTemplates']"/>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/TXN/PTSMEMBER/@mentorid != 0)">
                              <xsl:element name="INPUT">
                                 <xsl:attribute name="type">radio</xsl:attribute>
                                 <xsl:attribute name="name">TList</xsl:attribute>
                                 <xsl:attribute name="id">TList</xsl:attribute>
                                 ...
                                 <xsl:if test="/DATA/PARAM/@tlist=1">
                                    <xsl:attribute name="CHECKED"/>
                                 </xsl:if>
                              </xsl:element>
                              </xsl:if>
                              <xsl:if test="(/DATA/TXN/PTSMEMBER/@mentorid != 0)">
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MentorTemplates']"/>
                              </xsl:if>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="INPUT">
                              <xsl:attribute name="type">radio</xsl:attribute>
                              ...
                              <xsl:if test="/DATA/PARAM/@tlist=2">
                                 <xsl:attribute name="CHECKED"/>
                              </xsl:if>
                              </xsl:element>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MemberTemplates']"/>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="INPUT">
                              <xsl:attribute name="type">text</xsl:attribute>
                              <xsl:attribute name="name">TMemberID</xsl:attribute>
                              <xsl:attribute name="id">TMemberID</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@tmemberid"/></xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SelectFrom']"/>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                 <xsl:if test="(/DATA/PARAM/@tlist = 0)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CompanyTemplates']"/>
                                 </xsl:if>
                              ...
                              <xsl:if test="(/DATA/PARAM/@tlist = 2)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MemberTemplates']"/>
                                    <xsl:value-of select="/DATA/PARAM/@tmemberid" disable-output-escaping="yes"/>
                              </xsl:if>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                        ...
                        <xsl:if test="(count(/DATA/TXN/PTSGOALS/ENUM) &gt; 1)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="width">140</xsl:attribute>
                                 <xsl:attribute name="align">right</xsl:attribute>
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CopyTemplate']"/>
                                 <xsl:text>:</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              </xsl:element>
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="SELECT">
                                    ...
                                    <xsl:attribute name="onchange"><xsl:text disable-output-escaping="yes"><![CDATA[document.getElementById('GoalName').value = this.options[this.selectedIndex].text;]]></xsl:text></xsl:attribute>
                                    <xsl:for-each select="/DATA/TXN/PTSGOALS/ENUM">
                     ...
                     win.focus();
                        ...
                        <xsl:if test="(count(/DATA/TXN/PTSGOALS/ENUM) &lt;= 1)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoTemplates']"/>
                                 </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="align">center</xsl:attribute>
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:if test="(/DATA/SYSTEM/@userstatus = 1) and (count(/DATA/TXN/PTSGOALS/ENUM) &gt; 1)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
