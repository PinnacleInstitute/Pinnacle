...
pos = InStr(LCASE(reqSysServerPath), "nexxuscertify")
   ...
   If (reqProduct = 0) Then
      ...
      Else
         With oNexxus
            ...
            reqProduct = .Custom(501, 0, reqMemberID, 1)
...
If oLanguage.parseError <> 0 Then
   Response.Write "NexxusCertify Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
xslPage = "NexxusCertify.xsl"
Set oStyle = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oStyle.load server.MapPath(xslPage)
If oStyle.parseError <> 0 Then
   Response.Write "NexxusCertify Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "NexxusCertify Load file (oData) failed with error code " + CStr(oData.parseError)
