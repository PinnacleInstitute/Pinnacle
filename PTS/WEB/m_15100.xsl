...
<xsl:element name="SCRIPT">
   ...
   var UserMenu = new CMenu(UserMenuDef, 'UserMenu'); UserMenu.create();
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="IFRAME">
                                 <xsl:attribute name="src"></xsl:attribute>
                                 <xsl:attribute name="width">100%</xsl:attribute>
                                 <xsl:attribute name="height">1320</xsl:attribute>
                                 <xsl:attribute name="frmheight">1320</xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:attribute name="id">TabMerchants</xsl:attribute>
                           <xsl:element name="TD">
                              <xsl:attribute name="width">100%</xsl:attribute>
                              <xsl:attribute name="align">left</xsl:attribute>
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:element name="IFRAME">
                                 ...
                                 <xsl:attribute name="height">700</xsl:attribute>
                                 <xsl:attribute name="frmheight">700</xsl:attribute>
                                 <xsl:attribute name="id">MerchantsFrame</xsl:attribute>
                                 <xsl:attribute name="name">MerchantsFrame</xsl:attribute>
                                 <xsl:attribute name="class">FrameNoScroll</xsl:attribute>
                                 <xsl:attribute name="frameborder">0</xsl:attribute>
                                 <xsl:attribute name="onload">ShowFrame('TabMerchants')</xsl:attribute>
                                 <xsl:element name="A">
                                    <xsl:attribute name="href"></xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoFrameSupport']"/>
                                 </xsl:element>
