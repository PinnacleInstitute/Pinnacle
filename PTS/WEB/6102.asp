...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "6102URL", reqReturnURL
   SetCache "6102DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "6102")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("6102URL")
         reqReturnData = GetCache("6102DATA")
         SetCache "6102URL", ""
         SetCache "6102DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "6102 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "6102 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "6102 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "6102 Load file (oData) failed with error code " + CStr(oData.parseError)
