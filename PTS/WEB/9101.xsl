      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               <xsl:attribute name="name">PageSection</xsl:attribute>
               ...
               <xsl:element name="SCRIPT">
                  <xsl:attribute name="language">JavaScript</xsl:attribute>
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function DownloadPage(file,lang){ 
               var url, win;
                     ...
                     <xsl:element name="TABLE">
                                 ...
                                 <xsl:attribute name="width">600</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FindPageSection']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">500</xsl:attribute>
                                          <xsl:attribute name="align">right</xsl:attribute>
                                          ...
                                          <xsl:element name="A">
                                             ...
                                             <xsl:attribute name="href">9102.asp?contentpage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewPageSection']"/>
                                          </xsl:element>
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23)">
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="href">91Import.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/></xsl:attribute>
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23)">
                                             <xsl:element name="A">
                                                <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                                <xsl:attribute name="onclick">w=window.open(this.href,"LanguageManager","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                <xsl:attribute name="href">9199.asp?contentpage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/></xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='LanguageManager']"/>
                                             </xsl:element>
                                          </xsl:if>
                                       </xsl:element>
                                    </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='PageFindText']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSPAGESECTIONS/PTSFINDTYPEIDS/ENUM">
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:attribute name="valign">Bottom</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='PageSectionName']"/>
                                    </xsl:element>
                                    <xsl:element name="TD">
                                       <xsl:attribute name="align">left</xsl:attribute>
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSPAGESECTIONS/PTSPAGESECTION">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">left</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="@pagesectionname"/>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">9103.asp?PageSectionID=<xsl:value-of select="@pagesectionid"/>&amp;contentpage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23)">
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">ExportPageSection.asp?PageSectionID=<xsl:value-of select="@pagesectionid"/></xsl:attribute>
                                                   <xsl:element name="IMG">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="onclick">DownloadPage(<xsl:value-of select="concat('&quot;', @filename, '&quot;,&quot;', @language, '&quot;')"/>)</xsl:attribute>
                                                <xsl:element name="IMG">
                                             ...
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">#_</xsl:attribute>
                                                <xsl:attribute name="onclick">UploadPage(<xsl:value-of select="@pagesectionid"/>)</xsl:attribute>
                                                <xsl:element name="IMG">
                                 ...
                                 <xsl:choose>
                                    <xsl:when test="(count(/DATA/TXN/PTSPAGESECTIONS/PTSPAGESECTION) = 0)">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             <xsl:attribute name="colspan">4</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@companyid &gt; 0)">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ImageManager']"/>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:attribute name="class">prompt</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ImageManagerText']"/>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
                              <xsl:element name="TD">
