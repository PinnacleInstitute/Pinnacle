...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "5001URL", reqReturnURL
   SetCache "5001DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "5001")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("5001URL")
      reqReturnData = GetCache("5001DATA")
      SetCache "5001URL", ""
      SetCache "5001DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "5001 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "5001 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "5001 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "5001 Load file (oData) failed with error code " + CStr(oData.parseError)
