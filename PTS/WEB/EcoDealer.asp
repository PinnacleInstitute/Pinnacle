...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      If pos > 0 Then
         tmpRef = left(reqSysServerName, pos-1)
      End If
      ...
      Else
         With oMember
            ...
            If (.MemberID <> 0) Then
               Response.Redirect "http://heartland.pinnaclep.com/pp.asp?p=92&m=" + .MemberID
			Else
               Response.Redirect "http://heartland.pinnaclep.com/sections/company/582/corporate/home_tmp.html"
            End If
         End With
      End If
      Set oMember = Nothing
