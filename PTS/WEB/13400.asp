...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "13400URL", reqReturnURL
   SetCache "13400DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "13400")
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         ...
         If (reqProcess = 2) Then
            ...
            Set oCis = server.CreateObject("ptsCisUser.CCis")
            If oCis Is Nothing Then
               DoError Err.Number, Err.Source, "Unable to Create Object - ptsCisUser.CCis"
            Else
               With oCis
         ...
         If (reqProcess = 24) Then
            Total = 0
            ExportWallet reqCompanyID, 11, reqToDate, 0, tmpTotal, tmpFile, tmpAmount
         ...
         If (reqProcess = 30) Then
            ...
            Set oCiss = server.CreateObject("ptsCisUser.CCiss")
            If oCiss Is Nothing Then
               DoError Err.Number, Err.Source, "Unable to Create Object - ptsCisUser.CCiss"
            Else
               With oCiss
                  .SysCurrentLanguage = reqSysLanguage
                  .CustomList 3, 0, 0, 0
...
xmlTransaction = xmlTransaction +  xmlCiss
...
fileLanguage = "Language" + "\13400[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\13400[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "13400 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "13400 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "13400 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "13400 Load file (oData) failed with error code " + CStr(oData.parseError)
