<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Add Activity'"/>
      ...
      <xsl:element name="BODY">
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:attribute name="onload">document.getElementById('MetricTypeID').focus()</xsl:attribute>
            </xsl:otherwise>
         </xsl:choose>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="INPUT">
                              ...
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@isresult"/></xsl:attribute>
                           </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MetricTypeID']"/>
                              <xsl:text>:</xsl:text>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 <xsl:attribute name="name">MetricTypeID</xsl:attribute>
                                 <xsl:attribute name="id">MetricTypeID</xsl:attribute>
                                 <xsl:attribute name="onchange"><xsl:text disable-output-escaping="yes"><![CDATA[doSubmit(1,"");]]></xsl:text></xsl:attribute>
                                 <xsl:for-each select="/DATA/TXN/PTSMETRICTYPES/ENUM">
                        ...
                        <xsl:if test="(/DATA/TXN/PTSMETRIC/@metrictypeid != 0) and (/DATA/TXN/PTSMETRICTYPE/@pts != 0)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">2</xsl:attribute>
                                 <xsl:attribute name="width">100%</xsl:attribute>
                           ...
                           <xsl:if test="(/DATA/TXN/PTSMETRICTYPE/@isqty = 0)">
                              <xsl:element name="INPUT">
                                 <xsl:attribute name="type">hidden</xsl:attribute>
                                 <xsl:attribute name="name">Qty</xsl:attribute>
                                 <xsl:attribute name="id">Qty</xsl:attribute>
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSMETRIC/@qty"/></xsl:attribute>
                              </xsl:element>
                           </xsl:if>
                           ...
                           <xsl:element name="TR">
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="INPUT">
                                 <xsl:attribute name="type">text</xsl:attribute>
                                 <xsl:attribute name="name">MetricDate</xsl:attribute>
                                 <xsl:attribute name="id">MetricDate</xsl:attribute>
                                 <xsl:attribute name="size">10</xsl:attribute>
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSMETRIC/@metricdate"/></xsl:attribute>
                                 </xsl:element>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 <xsl:element name="IMG">
                                    ...
                                    <xsl:attribute name="border">0</xsl:attribute>
                                    <xsl:attribute name="onclick">CalendarPopup(document.forms[0], document.getElementById('MetricDate'))</xsl:attribute>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
                           ...
                           <xsl:if test="(/DATA/TXN/PTSMETRIC/@inputoptions != '')">
                              <xsl:for-each select="/DATA/TXN/PTSMETRIC/INPUTOPTIONSS/INPUTOPTIONS">
                           ...
                           <xsl:if test="(/DATA/TXN/PTSMETRICTYPE/@required != '')">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">2</xsl:attribute>
                                    <xsl:attribute name="width">100%</xsl:attribute>
                           ...
                           <xsl:if test="(not(/DATA/TXN/PTSMETRICTYPE/@required))">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">2</xsl:attribute>
                                    <xsl:attribute name="width">100%</xsl:attribute>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="TEXTAREA">
                                    ...
                                    <xsl:value-of select="/DATA/TXN/PTSMETRIC/@note"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/TXN/PTSMETRIC/@metrictypeid != 0) and (/DATA/TXN/PTSMETRICTYPE/@pts != 0)">
                                 <xsl:element name="INPUT">
                                    ...
                                    <xsl:attribute name="class">bigbutton</xsl:attribute>
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='LogAnother']"/>
                                    </xsl:attribute>
