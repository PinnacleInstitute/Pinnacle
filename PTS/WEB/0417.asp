...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0417URL", reqReturnURL
   SetCache "0417DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0417")
...
reqIsClass =  Numeric(GetInput("IsClass", reqPageData))
reqIsAssess =  Numeric(GetInput("IsAssess", reqPageData))
reqIsCertify =  Numeric(GetInput("IsCertify", reqPageData))
reqIsGoal =  Numeric(GetInput("IsGoal", reqPageData))
reqIsProject =  Numeric(GetInput("IsProject", reqPageData))
reqIsSales =  Numeric(GetInput("IsSales", reqPageData))
reqIsSignIn =  Numeric(GetInput("IsSignIn", reqPageData))
reqIsActivity =  Numeric(GetInput("IsActivity", reqPageData))
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("0417URL")
      reqReturnData = GetCache("0417DATA")
      SetCache "0417URL", ""
      SetCache "0417DATA", ""
...
xmlParam = xmlParam + " isclass=" + Chr(34) + CStr(reqIsClass) + Chr(34)
xmlParam = xmlParam + " isassess=" + Chr(34) + CStr(reqIsAssess) + Chr(34)
xmlParam = xmlParam + " iscertify=" + Chr(34) + CStr(reqIsCertify) + Chr(34)
xmlParam = xmlParam + " isgoal=" + Chr(34) + CStr(reqIsGoal) + Chr(34)
xmlParam = xmlParam + " isproject=" + Chr(34) + CStr(reqIsProject) + Chr(34)
xmlParam = xmlParam + " issales=" + Chr(34) + CStr(reqIsSales) + Chr(34)
xmlParam = xmlParam + " issignin=" + Chr(34) + CStr(reqIsSignIn) + Chr(34)
xmlParam = xmlParam + " isactivity=" + Chr(34) + CStr(reqIsActivity) + Chr(34)
...
If oLanguage.parseError <> 0 Then
   Response.Write "0417 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0417 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0417 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0417 Load file (oData) failed with error code " + CStr(oData.parseError)
