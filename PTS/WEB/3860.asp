...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "3860URL", reqReturnURL
   SetCache "3860DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "3860")
...
reqRevenue =  Numeric(GetInput("Revenue", reqPageData))
...
Select Case CLng(reqActionCode)
   ...
   tmpData = ""
   tmpLabels = ""
   For Each oCompany in oCompanys
      With oCompany
         ...
         Case 2:
            reqCount = reqCount + .Quantity
            tmpLabels = tmpLabels + .CompanyType + "|"
            tmpData = tmpData + .Quantity + "|"
         Case 3:
            reqCount = reqCount + .Quantity
            tmpLabels = tmpLabels + .CompanyType + "|"
         ...
         Case 4:
            reqCount = reqCount + 1
            reqMembers = reqMembers + .Amount
            reqRevenue = reqRevenue + .Quantity
   ...
   Case 4:
      ...
      reqRevenue = FormatCurrency(reqRevenue,0)
   End Select
...
xmlParam = xmlParam + " revenue=" + Chr(34) + CStr(reqRevenue) + Chr(34)
xmlParam = xmlParam + " />"
...
fileLanguage = "Language\3860.xml"
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "3860 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "3860 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "3860 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "3860 Load file (oData) failed with error code " + CStr(oData.parseError)
