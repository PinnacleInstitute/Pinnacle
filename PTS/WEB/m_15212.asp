...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_15212URL", reqReturnURL
   SetCache "m_15212DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_15212")
...
Function NewShopper(opt)
   ...
   reqPayment2ID = 0
   If (opt <> 0) Then
      reqLogonConsumer = GetCache("CONSUMERLOGON")
   End If
End Function
...
Sub SetupOrder()
   ...
   End If
   If (xmlError = "") Then
      SetCache "CONSUMERLOGON", reqLogonConsumer
   End If
End Sub
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("m_15212URL")
      reqReturnData = GetCache("m_15212DATA")
      SetCache "m_15212URL", ""
      SetCache "m_15212DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_15212 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_15212 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_15212 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_15212 Load file (oData) failed with error code " + CStr(oData.parseError)
