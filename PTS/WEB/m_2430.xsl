                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:element name="INPUT">
                                                ...
                                                <xsl:attribute name="id">Timer</xsl:attribute>
                                                <xsl:attribute name="value">00:00:00</xsl:attribute>
                                                <xsl:attribute name="style">BORDER:none; COLOR:white; BACKGROUND:#eaeaea; TEXT-ALIGN:right;</xsl:attribute>
                                             </xsl:element>
                                             </xsl:if>
                                       </xsl:element>
                                 </xsl:element>
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <script type="text/javascript">
                                       ...
                                       var attributes = {};
                                       swfobject.embedSWF("PinnaclePlayer.swf", "FlashContent", "300", "200", "9.0.0", false, flashvars, params, attributes);
                                    </script>
                                    <div id="FlashContent">
                                       <xsl:element name="A">
                                          <xsl:attribute name="onclick">w=window.open(this.href,"_Player","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                       ...
                                       <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(@islink != 0)">
                                             <xsl:element name="A">
                                                ...
                                                <xsl:element name="IMG">
                                                   <xsl:attribute name="src">Images/File.gif</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>
