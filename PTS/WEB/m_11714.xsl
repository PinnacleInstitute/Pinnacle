                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='LeaderSummary']"/>
                              <xsl:text>:</xsl:text>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">ColumnHeader</xsl:attribute>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@rpt = 3)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ResultsActivities']"/>
                                 </xsl:if>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSMETRICS/PTSMETRIC">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">left</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51) or (/DATA/PARAM/@groupid = /DATA/SYSTEM/@memberid) or (/DATA/PARAM/@ownercontestid != 0)">
                                                <xsl:element name="A">
                                                   <xsl:attribute name="href">m_11713.asp?MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;MetricTypeID=<xsl:value-of select="@metrictypeid"/>&amp;FromDate=<xsl:value-of select="/DATA/PARAM/@fromdate"/>&amp;ToDate=<xsl:value-of select="/DATA/PARAM/@todate"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                 ...
                                 <xsl:attribute name="width">100%</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:element name="b">
                                          <xsl:value-of select="/DATA/PARAM/@qty" disable-output-escaping="yes"/>
                                          </xsl:element>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">15%</xsl:attribute>
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:element name="b">
                                          <xsl:value-of select="/DATA/PARAM/@points" disable-output-escaping="yes"/>
                                          </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
