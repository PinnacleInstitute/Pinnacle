                     ...
                     <xsl:element name="TABLE">
                                 ...
                                 <xsl:attribute name="width">600</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='LookupProspect']"/>
                                       </xsl:element>
                                    </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='LookupText']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                                 ...
                                 <xsl:element name="TABLE">
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="class">ColumnTitle</xsl:attribute>
                                          <xsl:attribute name="valign">Bottom</xsl:attribute>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Date1']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="width">10%</xsl:attribute>
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:element name="font">
                                                ...
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">0421.asp?MemberID=<xsl:value-of select="@memberid"/></xsl:attribute>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:element name="font">
                                                ...
                                                <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                <xsl:value-of select="@prospecttype"/>
                                                <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
