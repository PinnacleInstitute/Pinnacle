...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1081URL", reqReturnURL
   SetCache "1081DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1081")
...
fileLanguage = "Language\1081.xml"
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "1081 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1081 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1081 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1081 Load file (oData) failed with error code " + CStr(oData.parseError)
