...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "13901URL", reqReturnURL
   SetCache "13901DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "13901")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
               ...
               Else
                  With oMember
                     ...
                     tmpTo = .Email
                        ...
                        tmpSender = "support@silverheartmax.com"
                        tmpFrom = "support@silverheartmax.com"
                        If reqMembership = 10 Then
         ...
         Set oSilverHeart = server.CreateObject("ptsSilverHeartUser.CSilverHeart")
         If oSilverHeart Is Nothing Then
            DoError Err.Number, Err.Source, "Unable to Create Object - ptsSilverHeartUser.CSilverHeart"
         Else
            With oSilverHeart
               .SysCurrentLanguage = reqSysLanguage
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("13901URL")
      reqReturnData = GetCache("13901DATA")
      SetCache "13901URL", ""
      SetCache "13901DATA", ""
...
fileLanguage = "Language" + "\13901[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\13901[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "13901 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "13901 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "13901 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "13901 Load file (oData) failed with error code " + CStr(oData.parseError)
