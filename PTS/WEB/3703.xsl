   ...
   <xsl:template match="/">
      ...
      <xsl:element name="BODY">
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:attribute name="onload">document.getElementById('AddressType').focus()</xsl:attribute>
            </xsl:otherwise>
         </xsl:choose>
                        ...
                        <xsl:if test="(/DATA/PARAM/@popup &lt; 3)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AddressType']"/>
                                 <xsl:text>:</xsl:text>
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="SELECT">
                                    <xsl:attribute name="name">AddressType</xsl:attribute>
                                    <xsl:attribute name="id">AddressType</xsl:attribute>
                                    <xsl:for-each select="/DATA/TXN/PTSADDRESS/PTSADDRESSTYPES/ENUM">
                              ...
                              <xsl:element name="IMG">
                                 ...
                                 <xsl:if test="(/DATA/TXN/PTSADDRESS/@isactive = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
