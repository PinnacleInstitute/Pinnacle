...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "11714URL", reqReturnURL
   SetCache "11714DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "11714")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionReturn):
      ...
      reqReturnURL = GetCache("11714URL")
      reqReturnData = GetCache("11714DATA")
      SetCache "11714URL", ""
      SetCache "11714DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "11714 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "11714 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "11714 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "11714 Load file (oData) failed with error code " + CStr(oData.parseError)
