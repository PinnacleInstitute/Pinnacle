...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "9805URL", reqReturnURL
   SetCache "9805DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "9805")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("9805URL")
         reqReturnData = GetCache("9805DATA")
         SetCache "9805URL", ""
         SetCache "9805DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "9805 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "9805 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "9805 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "9805 Load file (oData) failed with error code " + CStr(oData.parseError)
