                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">pageheading</xsl:attribute>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@mode = 2)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Replied']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@mode = 3)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='RepliedLastVisit']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@mode = 4)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='RepliedThirtyDays']"/>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>
