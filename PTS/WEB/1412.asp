...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1412URL", reqReturnURL
   SetCache "1412DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1412")
...
If (reqSysUserGroup = 41) And (reqMemberID <> 0) And (reqMemberID <> reqSysMemberID) Then
   AbortUser()
End If
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionReturn):
      ...
      reqReturnURL = GetCache("1412URL")
      reqReturnData = GetCache("1412DATA")
      SetCache "1412URL", ""
      SetCache "1412DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "1412 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1412 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1412 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1412 Load file (oData) failed with error code " + CStr(oData.parseError)
