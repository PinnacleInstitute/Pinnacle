...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1011URL", reqReturnURL
   SetCache "1011DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1011")
...
If (reqSysUserGroup = 41) And (InStr(reqSysUserOptions,"V") = 0) Then
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("1011URL")
      reqReturnData = GetCache("1011DATA")
      SetCache "1011URL", ""
      SetCache "1011DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "1011 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1011 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1011 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1011 Load file (oData) failed with error code " + CStr(oData.parseError)
