...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0456URL", reqReturnURL
   SetCache "0456DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0456")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      End If
      If (reqReference = "") Then
         DoError 10116, "", "Oops, Please specify who referred you."
      End If
      If (xmlError = "") Then
         LoadCompanyOptions
      End If
...
fileLanguage = "Language" + "\0456[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\0456[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "0456 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0456 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0456 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0456 Load file (oData) failed with error code " + CStr(oData.parseError)
