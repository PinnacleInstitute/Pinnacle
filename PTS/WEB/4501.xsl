      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               <xsl:attribute name="name">Suggestion</xsl:attribute>
               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                                 ...
                                 <xsl:attribute name="width">800</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FindSuggestion']"/>
                                       </xsl:element>
                                    </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSSUGGESTIONS/PTSFINDTYPEIDS/ENUM">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:element name="OPTION">
                                    ...
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Unread']"/>
                                 </xsl:element>
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">2</xsl:attribute>
                                    <xsl:if test="$tmp='2'"><xsl:attribute name="SELECTED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Read']"/>
                                 </xsl:element>
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">3</xsl:attribute>
                                    <xsl:if test="$tmp='3'"><xsl:attribute name="SELECTED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Accept']"/>
                                 </xsl:element>
                                 <xsl:element name="OPTION">
                        ...
                        <xsl:if test="(/DATA/BOOKMARK/@searchtype != 0) or (/DATA/PARAM/@orgid &gt; 0) or (/DATA/PARAM/@companyid &gt; 0)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="width">800</xsl:attribute>
                                 <xsl:attribute name="align">left</xsl:attribute>
                                 ...
                                 <xsl:element name="TABLE">
                                    ...
                                    <xsl:for-each select="/DATA/TXN/PTSSUGGESTIONS/PTSSUGGESTION">
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             <xsl:attribute name="align">left</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="@suggestiondate"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="align">left</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">4503.asp?SuggestionID=<xsl:value-of select="@suggestionid"/>&amp;contentpage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                             <xsl:element name="b">
                                       ...
                                       <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23)">
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="A">
                                                   <xsl:attribute name="href">0403.asp?MemberID=<xsl:value-of select="@memberid"/>&amp;contentpage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             #<xsl:value-of select="@suggestionid"/>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                    ...
                                    <xsl:choose>
                                       <xsl:when test="(count(/DATA/TXN/PTSSUGGESTIONS/PTSSUGGESTION) = 0)">
                                          <xsl:element name="TR">
                                             <xsl:element name="TD">
                                                <xsl:attribute name="colspan">4</xsl:attribute>
                                                <xsl:attribute name="align">left</xsl:attribute>
