...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "HomeURL", reqReturnURL
   SetCache "HomeDATA", reqReturnData
End If
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oHTMLFile
            ...
            .Load 
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            If (Len(.Data) < 10) And (reqG <> 0) Then
               .Filename = "home.htm"
               .Load 
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            End If
...
If oCommon.parseError <> 0 Then
   Response.Write "Home Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
