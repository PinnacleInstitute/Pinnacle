<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Retail Customers'"/>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:element name="IMG">
                                    <xsl:attribute name="src">Images/Retail48.png</xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">440</xsl:attribute>
                                    <xsl:if test="$tmp='440'"><xsl:attribute name="SELECTED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Price']"/>
                                 </xsl:element>
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">474</xsl:attribute>
                                    <xsl:if test="$tmp='474'"><xsl:attribute name="SELECTED"/></xsl:if>
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSMEMBERS/PTSMEMBER">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="onclick">ViewCustomer(<xsl:value-of select="@memberid"/>)</xsl:attribute>
                                                <xsl:element name="IMG">
                                       ...
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:if test="(@initprice != '$0.00')">
                                                <xsl:value-of select="@initprice"/>
                                             </xsl:if>
                                          <xsl:if test="(@initprice = '$0.00')">
                                                <xsl:element name="IMG">
