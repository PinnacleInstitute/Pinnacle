                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewNote']"/>
                                              ...
                                              | 
                                             <xsl:element name="A">
                                                <xsl:attribute name="onclick">w=window.open(this.href,"Print","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                <xsl:attribute name="href">9010.asp?OwnerType=<xsl:value-of select="/DATA/PARAM/@ownertype"/>&amp;OwnerID=<xsl:value-of select="/DATA/PARAM/@ownerid"/>&amp;Title=<xsl:value-of select="/DATA/PARAM/@title"/></xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSNOTES/PTSFINDTYPEIDS/ENUM">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 21) or ((@islocked = 0) and (@authuserid = /DATA/SYSTEM/@userid))">
                                                ...
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">9003.asp?NoteID=<xsl:value-of select="@noteid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                   <xsl:element name="IMG">
