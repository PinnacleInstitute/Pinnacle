      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               var url, win;
               url = "FastStart.html"
               win = window.open(url,"FastStart","top=10,left=10,height=750,width=850,resizable=yes,status=no,toolbar=no,menubar=no,location=no,titlebar=no,scrollbars=1");
               win.focus();
             }]]></xsl:text>
               </xsl:element>
                                    ...
                                    <xsl:attribute name="width">750</xsl:attribute>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                             <xsl:element name="b">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FAFPack']"/>
                                             </xsl:element>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:element name="font">
                                                ...
                                                <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;&amp;#160;&amp;#160;&amp;#160;</xsl:text>
                                                <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;&amp;#160;</xsl:text>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FAFPack1']"/>
                                             </xsl:element>
                                          </xsl:element>
                                       </xsl:element>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="class">PageHeading</xsl:attribute>
                                    ...
                                    <xsl:if test="(/DATA/PARAM/@membership = 2) and (/DATA/PARAM/@membership = 3)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SelectedAffiliate']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 4) and (/DATA/PARAM/@membership = 5)">
