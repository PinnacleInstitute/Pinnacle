<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Barter Credits'"/>
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               <xsl:element name="SCRIPT">
                  ...
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function NewBarterCredit(){ 
          ...
          window.location = url
               ...
               <xsl:element name="SCRIPT">
                  <xsl:attribute name="language">JavaScript</xsl:attribute>
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function TransferCredits(){ 
          var t = document.getElementById('OwnerType').value
          var i = document.getElementById('OwnerID').value
          ...
          window.location = url
               ...
               <xsl:element name="SCRIPT">
                  <xsl:attribute name="language">JavaScript</xsl:attribute>
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function PurchaseCredits(){ 
          var t = document.getElementById('OwnerType').value
          var i = document.getElementById('OwnerID').value
          var url = '';
          if( t == 4 ) {
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSBARTERCREDITS/PTSFINDTYPEIDS/ENUM">
                              ...
                              <xsl:element name="INPUT">
                                 ...
                                 <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[PurchaseCredits()]]></xsl:text></xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/PARAM/@user2fa = 1)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Transfer']"/>
                                    </xsl:attribute>
                                    <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[TransferCredits()]]></xsl:text></xsl:attribute>
                                 </xsl:element>
                              </xsl:if>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewBarterCredit']"/>
                                    </xsl:attribute>
                                    <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[NewBarterCredit()]]></xsl:text></xsl:attribute>
                                 </xsl:element>
                              </xsl:if>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="INPUT">
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CreditDate']"/>
                                    </xsl:element>
                                    <xsl:element name="TD">
                                       <xsl:attribute name="align">center</xsl:attribute>
                                       <xsl:attribute name="width">15%</xsl:attribute>
                                    ...
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:attribute name="class">ColumnTitle</xsl:attribute>
                                       <xsl:attribute name="valign">Bottom</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CreditType']"/>
                                    </xsl:element>
                                    <xsl:element name="TD">
                                       <xsl:attribute name="align">center</xsl:attribute>
                                       <xsl:attribute name="width">12%</xsl:attribute>
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSBARTERCREDITS/PTSBARTERCREDIT">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51)">
                                                <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                <xsl:element name="A">
                                                   <xsl:attribute name="href">17403.asp?BarterCreditID=<xsl:value-of select="@bartercreditid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:variable name="tmp4"><xsl:value-of select="../PTSCREDITTYPES/ENUM[@id=current()/@credittype]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp4]"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                 ...
                                 <xsl:choose>
                                    <xsl:when test="(count(/DATA/TXN/PTSBARTERCREDITS/PTSBARTERCREDIT) = 0)">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             <xsl:attribute name="colspan">8</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
