<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Marketing Ads'"/>
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               <xsl:element name="SCRIPT">
                  ...
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function ViewLink(id){ 
          var url, win;
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MemberLeadAdsText']"/>
                                       ...
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="onclick">ViewLink(<xsl:value-of select="@leadadid"/>)</xsl:attribute>
                                                <xsl:element name="IMG">
                                                   <xsl:attribute name="src">Images/LeadAd/<xsl:value-of select="@image"/></xsl:attribute>
