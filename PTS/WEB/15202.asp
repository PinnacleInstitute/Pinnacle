...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "15202URL", reqReturnURL
   SetCache "15202DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "15202")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("15202URL")
      reqReturnData = GetCache("15202DATA")
      SetCache "15202URL", ""
      SetCache "15202DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "15202 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "15202 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "15202 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "15202 Load file (oData) failed with error code " + CStr(oData.parseError)
