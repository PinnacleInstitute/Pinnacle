...
pos = InStr(LCASE(reqSysServerPath), "10708")
...
If oStyle.parseError <> 0 Then
   Response.Write "10708 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oHTMLFile
            .Filename = "SoftwareInstallation.htm"
      ...
      tmpSubject = "CloudZow! Software Installation"
...
If oLanguage.parseError <> 0 Then
   Response.Write "10708 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "10708 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "10708 Load file (oData) failed with error code " + CStr(oData.parseError)
