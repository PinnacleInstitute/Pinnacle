...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_2112URL", reqReturnURL
   SetCache "m_2112DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_2112")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNextLesson):
      ...
      If (xmlError = "") Then
         ...
         If (reqNextLessonID > 0) Then
            Response.Redirect "m_2430.asp" & "?LessonID=" & reqNextLessonID & "&SessionID=" & reqSessionID & "&CourseID=" & reqCourseID & "&Lessons=" & reqLessons & "&ContentPage=" & reqContentPage & "&Popup=" & reqPopup & "&ReturnURL=" & reqPageURL & "&ReturnData=" & reqPageData
         End If
      End If
   ...
   Case CLng(cActionReturnLesson):
      ...
      If (xmlError = "") Then
         ...
         Response.Redirect "m_2430.asp" & "?LessonID=" & reqLessonID & "&SessionID=" & reqSessionID & "&CourseID=" & reqCourseID & "&Lessons=" & reqLessons & "&ContentPage=" & reqContentPage & "&Popup=" & reqPopup & "&ReturnURL=" & reqPageURL & "&ReturnData=" & reqPageData
      End If
   ...
   Case CLng(cActionReturnClass):
      ...
      If (xmlError = "") Then
         ...
         Response.Redirect "m_1330.asp" & "?SessionID=" & reqSessionID & "&CourseID=" & reqCourseID & "&ContentPage=" & reqContentPage & "&Popup=" & reqPopup
      End If
   ...
   Case CLng(cActionRetakeQuiz):
      ...
      Response.Redirect "m_2112.asp" & "?LessonID=" & reqLessonID & "&SessionID=" & reqSessionID & "&CourseID=" & reqCourseID & "&Lessons=" & reqLessons & "&ContentPage=" & reqContentPage & "&Popup=" & reqPopup & "&ReturnURL=" & reqPageURL & "&ReturnData=" & reqPageData
End Select
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_2112 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_2112 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_2112 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_2112 Load file (oData) failed with error code " + CStr(oData.parseError)
