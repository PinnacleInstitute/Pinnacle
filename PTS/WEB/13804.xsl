<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'GCR Dashboard'"/>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:element name="IMG">
                                    <xsl:attribute name="src">Images/Company/<xsl:value-of select="/DATA/TXN/PTSMEMBER/@companyid"/>/Dashboard.png</xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GCRDashboard']"/>
                                  - 
                                             ...
                                             <xsl:attribute name="style">border: 1px #5084A2 solid</xsl:attribute>
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         ...
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q1 = 2)">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Trial14']"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q1 = 3)">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Active30']"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         ...
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q2 = 4)">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoSTPUSA']"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                ...
                                                <xsl:element name="TR">
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="align">right</xsl:attribute>
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CollectorQualified']"/>
                                                      <xsl:text>:</xsl:text>
                                                      <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 1)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Collector5']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q1 = 0) and (/DATA/TXN/PTSMEMBER/@title &gt; 1)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Collector10']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q1 != 0) and (/DATA/TXN/PTSMEMBER/@title != 1)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='None']"/>
                                                         </xsl:if>
                                                ...
                                                <xsl:element name="TR">
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         ...
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 6)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='D1Team']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 7)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='D2Team']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title &gt;= 8)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='D3Team']"/>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TR">
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title &lt; 5)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='No']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 5)">
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         ...
                                                         <xsl:if test="(/DATA/TXN/PTSDASH/@q3 != 0)">
                                                            ...
                                                            <xsl:if test="(/DATA/TXN/PTSMEMBER/@title &gt;= 8)">
                                                               <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Level15']"/>
                                                            </xsl:if>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
