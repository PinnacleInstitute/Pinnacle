...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_0103URL", reqReturnURL
   SetCache "m_0103DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_0103")
...
m_CheckSecurity reqSysUserID, reqSysUserGroup, 1, 52, "m_MemberHome.asp"
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("m_0103URL")
         reqReturnData = GetCache("m_0103DATA")
         SetCache "m_0103URL", ""
         SetCache "m_0103DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_0103 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_0103 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_0103 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_0103 Load file (oData) failed with error code " + CStr(oData.parseError)
