                        ...
                        <xsl:if test="(/DATA/PARAM/@mode = 1)">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:attribute name="class">PageHeading</xsl:attribute>
                                    <xsl:if test="(/DATA/PARAM/@errno = 1)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TimesError']"/>
                                    </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@errno = 2)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='DelayError']"/>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                       <xsl:value-of select="/DATA/PARAM/@days" disable-output-escaping="yes"/>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='DelayError2']"/>
                                 </xsl:if>
                              </xsl:element>
                           </xsl:element>

                        </xsl:if>
                        <xsl:if test="(/DATA/PARAM/@mode != 1) and (/DATA/TXN/PTSASSESSMENT/@assessmenttype = 1)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="width">600</xsl:attribute>
                                 <xsl:attribute name="align">left</xsl:attribute>
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="INPUT">
                                    ...
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TakeAssessment']"/>
                                    </xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@mode = 2)">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TakeExternal']"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
