...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "9198URL", reqReturnURL
   SetCache "9198DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "9198")
...
fileLanguage = "Language\9198.xml"
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "9198 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "9198 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "9198 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "9198 Load file (oData) failed with error code " + CStr(oData.parseError)
