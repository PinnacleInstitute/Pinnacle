...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_11721URL", reqReturnURL
   SetCache "m_11721DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_11721")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      Response.Redirect "m_11723.asp" & "?MemberID=" & reqMemberID & "&ReturnURL=" & reqPageURL
End Select
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_11721 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_11721 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_11721 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_11721 Load file (oData) failed with error code " + CStr(oData.parseError)
