<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="/DATA/LANGUAGE/LABEL[@name='Commissions']"/>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:value-of select="/DATA/PARAM/@payoutid" disable-output-escaping="yes"/>
                           </xsl:element>
                           <xsl:element name="TD">
                              <xsl:attribute name="width">300</xsl:attribute>
                              ...
                              <xsl:element name="A">
                                 <xsl:attribute name="href">0803.asp?PayoutID=<xsl:value-of select="/DATA/PARAM/@payoutid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSCOMMISSIONS/PTSCOMMISSION">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">right</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:if test="(/DATA/SYSTEM/@usergroup &gt; 23) and (@payoutid &gt; 0)">
