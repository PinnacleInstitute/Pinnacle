   ...
   <xsl:template match="/">
      ...
      <xsl:element name="BODY">
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:attribute name="onload">document.getElementById('IsSignIn').focus()</xsl:attribute>
            </xsl:otherwise>
         </xsl:choose>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MentorNotification']"/>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MentorNotifyText']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/PARAM/@issignin = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
                        ...
                        <xsl:if test="(contains(/DATA/PARAM/@options, 'K'))">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="value">1</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@isclass = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
                        ...
                        <xsl:if test="(contains(/DATA/PARAM/@options, 'L'))">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="value">1</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@isassess = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
                        ...
                        <xsl:if test="(contains(/DATA/PARAM/@options, 'L'))">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="value">1</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@iscertify = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
                        ...
                        <xsl:if test="(contains(/DATA/PARAM/@options, 'F')) or (contains(/DATA/PARAM/@options, 'f'))">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="value">1</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@isproject = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
                        ...
                        <xsl:if test="(contains(/DATA/PARAM/@options, 'E'))">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="value">1</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@issales = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
                        ...
                        <xsl:if test="(contains(/DATA/PARAM/@options, 'l'))">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="INPUT">
                                 <xsl:attribute name="type">checkbox</xsl:attribute>
                                 <xsl:attribute name="name">IsActivity</xsl:attribute>
                                 <xsl:attribute name="id">IsActivity</xsl:attribute>
                                 <xsl:attribute name="value">1</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@isactivity = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IsActivity']"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="value">1</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@isresult = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
