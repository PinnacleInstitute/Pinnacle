...
Function LD_SendApiRequest(byVal bvRequest, byVal bvAction) 'returns an MSXML DOMDocument.
	...
	If g_LD_Test Then Response.Write "<BR><BR>Request: " & Server.HTMLEncode(bvRequest)
	...
	If g_LD_Test Then Response.Write "<BR><BR>Response: " & Server.HTMLEncode(oHTTP.responseText)
