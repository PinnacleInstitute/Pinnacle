                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="INPUT">
                              ...
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@lessonid"/></xsl:attribute>
                           </xsl:element>
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                                 ...
                                 <xsl:attribute name="width">600</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="A">
                                             <xsl:attribute name="href">2303.asp?LessonID=<xsl:value-of select="/DATA/PARAM/@lessonid"/></xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="A">
                                             ...
                                             <xsl:attribute name="href">2102.asp?LessonID=<xsl:value-of select="/DATA/PARAM/@lessonid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/></xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewQuizQuestion']"/>
                                          </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                        ...
                        <xsl:if test="(count(/DATA/TXN/PTSQUIZQUESTIONS/PTSQUIZQUESTION) = 0)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">2</xsl:attribute>
                                 <xsl:attribute name="width">600</xsl:attribute>
                        ...
                        <xsl:if test="(count(/DATA/TXN/PTSQUIZQUESTIONS/PTSQUIZQUESTION) &gt; 0)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:attribute name="class">Prompt</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='QuizHelpEmployee']"/>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='QuizIntro']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SCRIPT">
                                 ...
                                 <![CDATA[   CKEDITOR.replace('Data', { toolbar:'simple', height:100 } );  ]]>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                        ...
                        <xsl:element name="TR">
                           <xsl:for-each select="/DATA/TXN/PTSQUIZQUESTIONS/PTSQUIZQUESTION[position()]">
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:attribute name="valign">center</xsl:attribute>
                                          ...
                                          <xsl:attribute name="name">S<xsl:value-of select="@quizquestionid"/></xsl:attribute>
                                          <xsl:attribute name="id">S<xsl:value-of select="@quizquestionid"/></xsl:attribute>
                                          <xsl:attribute name="value"><xsl:value-of select="@seq"/></xsl:attribute>
                                          <xsl:attribute name="size">1</xsl:attribute>
                                          </xsl:element>
                                          <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                       <xsl:if test="(@israndom != 0)">
                                             <xsl:element name="IMG">
                                          ...
                                          <xsl:element name="A">
                                             <xsl:attribute name="href">2103.asp?QuizQuestionID=<xsl:value-of select="@quizquestionid"/>&amp;LessonID=<xsl:value-of select="/DATA/PARAM/@lessonid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/></xsl:attribute>
                                       ...
                                       <xsl:if test="(@mediatype &gt; 1)">
                                          ...
                                          <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                           (
                                          <xsl:element name="A">
                                             <xsl:attribute name="href">2002.asp?QuizQuestionID=<xsl:value-of select="@quizquestionid"/>&amp;LessonID=<xsl:value-of select="/DATA/PARAM/@lessonid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/></xsl:attribute>
                                          add choice
                                          </xsl:element>
                                          )
                                    </xsl:element>
                                    ...
                                    <xsl:for-each select="./PTSQUIZCHOICEIDS/ENUM[position()]">
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="@selected='on'">
                                                   <xsl:attribute name="CHECKED"/>
                                                </xsl:if>
                                                </xsl:element>
                                                <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                <xsl:element name="A">
                                                   <xsl:attribute name="href">2003.asp?QuizChoiceID=<xsl:value-of select="@id"/>&amp;LessonID=<xsl:value-of select="/DATA/PARAM/@lessonid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/></xsl:attribute>
