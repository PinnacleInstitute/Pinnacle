<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Lead Program Report'"/>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:element name="BR"/>
                              <xsl:if test="(/DATA/PARAM/@affiliateid != 0)">
                              ...
                              <xsl:if test="(/DATA/PARAM/@memberid != 0)">
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@memberid = 0) and (/DATA/PARAM/@affiliateid = 0)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CompanyLeads']"/>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>
                     ...
                     document.getElementById('ToDate').value = todate.getMonth()+1 + "/" + todate.getDate() + "/" + todate.getFullYear();
                              ...
                              <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23)">
                                 <xsl:element name="INPUT">
                                    ...
                                    <xsl:attribute name="onclick">doSubmit(6,'<xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ConfirmClear']"/>')</xsl:attribute>
                                 </xsl:element>
                              </xsl:if>
                           </xsl:element>
                        </xsl:element>
                        ...
                        <xsl:if test="(/DATA/SYSTEM/@actioncode = 5)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="width">650</xsl:attribute>
                                    ...
                                    <xsl:attribute name="width">600</xsl:attribute>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:element name="b">
                                             <xsl:value-of select="/DATA/PARAM/@rate" disable-output-escaping="yes"/>
                                             </xsl:element>
                                          </xsl:element>
                                       </xsl:element>
