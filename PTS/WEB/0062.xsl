<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="/DATA/LANGUAGE/LABEL[@name='Report']"/>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:if test="(/DATA/PARAM/@report = 1)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ActivityReport']"/>
                              </xsl:element>
                           </xsl:element>
                        </xsl:if>
                        ...
                        <xsl:if test="(/DATA/PARAM/@report = 2)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ReminderReport']"/>
                              </xsl:element>
                           </xsl:element>
                        </xsl:if>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                              <xsl:value-of select="/DATA/PARAM/@user" disable-output-escaping="yes"/>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:value-of select="/DATA/PARAM/@owner" disable-output-escaping="yes"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:element name="TABLE">
                                       ...
                                       <xsl:for-each select="/DATA/TXN/PTSNOTES/PTSNOTE">
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                <xsl:attribute name="align">left</xsl:attribute>
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                   <xsl:if test="(@isreminder != 0)">
                                                      <xsl:element name="IMG">
                                                         <xsl:attribute name="src">Images/IsReminder.gif</xsl:attribute>
                                                         <xsl:attribute name="border">0</xsl:attribute>
                                                      </xsl:element>
                                                   </xsl:if>
                                                   <xsl:if test="(@isfrozen != 0)">
                                                      <xsl:element name="IMG">
                                                         <xsl:attribute name="src">Images/IsFrozen.gif</xsl:attribute>
                                                         <xsl:attribute name="border">0</xsl:attribute>
                                                      </xsl:element>
                                                   </xsl:if>
                                                   <xsl:if test="(@islocked != 0)">
                                                      <xsl:element name="IMG">
                                                   ...
                                                   <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                   <xsl:if test="(@ownertype = 38)">
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="class">NavBar</xsl:attribute>
                                                         <xsl:attribute name="onclick">w=window.open(this.href,"Owner","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                         <xsl:attribute name="href">3803.asp?CompanyID=<xsl:value-of select="@ownerid"/></xsl:attribute>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Company']"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                                   <xsl:if test="(@ownertype = 4)">
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="class">NavBar</xsl:attribute>
                                                         <xsl:attribute name="onclick">w=window.open(this.href,"Owner","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                         <xsl:attribute name="href">0403.asp?MemberID=<xsl:value-of select="@ownerid"/></xsl:attribute>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Member']"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                                   <xsl:if test="(@ownertype = 6)">
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="class">NavBar</xsl:attribute>
                                                         <xsl:attribute name="onclick">w=window.open(this.href,"Owner","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                         <xsl:attribute name="href">0603.asp?AffiliateID=<xsl:value-of select="@ownerid"/></xsl:attribute>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Affiliate']"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                                   <xsl:if test="(@ownertype = 3)">
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="class">NavBar</xsl:attribute>
                                                         <xsl:attribute name="onclick">w=window.open(this.href,"Owner","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                         <xsl:attribute name="href">0303.asp?TrainerID=<xsl:value-of select="@ownerid"/></xsl:attribute>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Trainer']"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                                   <xsl:if test="(@ownertype = 81)">
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="class">NavBar</xsl:attribute>
                                                         <xsl:attribute name="onclick">w=window.open(this.href,"Owner","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                         <xsl:attribute name="href">8103.asp?ProspectID=<xsl:value-of select="@ownerid"/></xsl:attribute>
                                                   ...
                                                   <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                   <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 21) or ((@islocked = 0) and (@authuserid = /DATA/SYSTEM/@userid))">
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="class">NavBar</xsl:attribute>
                                                         <xsl:attribute name="onclick">w=window.open(this.href,"EditNote","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                         <xsl:attribute name="href">9003.asp?NoteID=<xsl:value-of select="@noteid"/>&amp;Popup=1</xsl:attribute>
                                       ...
                                       <xsl:choose>
                                          <xsl:when test="(count(/DATA/TXN/PTSNOTES/PTSNOTE) = 0)">
                                             <xsl:element name="TR">
                                                <xsl:element name="TD">
                                                   <xsl:attribute name="colspan">1</xsl:attribute>
                                                   <xsl:attribute name="align">left</xsl:attribute>
