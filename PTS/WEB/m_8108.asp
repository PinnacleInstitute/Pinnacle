...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_8108URL", reqReturnURL
   SetCache "m_8108DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_8108")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("m_8108URL")
         reqReturnData = GetCache("m_8108DATA")
         SetCache "m_8108URL", ""
         SetCache "m_8108DATA", ""
...
fileLanguage = "Language" + "\m_8108[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\m_8108[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "m_8108 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_8108 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_8108 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_8108 Load file (oData) failed with error code " + CStr(oData.parseError)
