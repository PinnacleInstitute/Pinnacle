...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8804URL", reqReturnURL
   SetCache "8804DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8804")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("8804URL")
         reqReturnData = GetCache("8804DATA")
         SetCache "8804URL", ""
         SetCache "8804DATA", ""
   ...
   Case CLng(cActionTestEmail):
      ...
      If (tmpEmail <> "") Then
         ...
         If (xmlError = "") Then
            Response.Redirect "8808.asp" & "?EmailID=" & reqEmailID & "&MailReturnURL=" & "8804.asp?EmailID=" & reqEmailID & "%26TestEmail=" + tmpEmail 
         End If
      End If
...
If oLanguage.parseError <> 0 Then
   Response.Write "8804 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8804 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8804 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8804 Load file (oData) failed with error code " + CStr(oData.parseError)
