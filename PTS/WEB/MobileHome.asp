...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "MobileHomeURL", reqReturnURL
   SetCache "MobileHomeDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "mobilehome")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      End If
      Set oMember = Nothing
      GetMenuColors reqC, reqG, MenuBehindColor, reqMenuTopColor, reqMenuTopBGColor, reqMenuColor, reqMenuBGColor, MenuShadowColor, MenuBDColor, MenuOverColor, MenuOverBGColor, MenuDividerColor, MenuBehindImage, MenuTopImage, MenuImage
      ...
      If (InStr(reqSysUserOptions,"h") <> 0) Then
         xmlIcons2 = "<ICONS2>"
         xmlIcons2 = xmlIcons2 + "<ICON name=""AddContact"" action=""ShowTab('TabMarketing', 1)"" image=""m_ContactAdd.gif""/>"
         xmlIcons2 = xmlIcons2 + "<ICON name=""Contacts"" action=""ShowTab('TabMarketing', 2)"" image=""m_Contact.gif""/>"
      ...
      End If
      If (InStr(reqSysUserOptions,")") <> 0) Then
         xmlIcons3 = xmlIcons3 + "<ICON name=""Credits"" action=""ShowTab('TabFinancial', 4)"" image=""m_Credit.gif""/>"
      End If
      If (InStr(reqSysUserOptions,";") <> 0) Then
      ...
      If (InStr(reqSysUserOptions,"w") <> 0) Then
         ...
         End If
         xmlIcons4 = xmlIcons4 + "<ICON name=""Signout"" action=""ShowTab('TabAccount', 6)"" image=""m_Close.gif""/>"
      ...
      If (InStr(reqSysUserOptions,"S") <> 0) Or (InStr(reqSysUserOptions,"R") <> 0) Or (InStr(reqSysUserOptions,"m") <> 0) Then
         ...
         End If
         xmlIcons5 = xmlIcons5 + "<ICON name=""Website"" action=""ShowTab('TabHelp', 4)"" image=""m_Website.gif""/>"
         xmlIcons5 = xmlIcons5 + "</ICONS5>"
      End If
      If (InStr(reqSysUserOptions,"B") <> 0) Then
         xmlIcons6 = "<ICONS6>"
         If (InStr(reqSysUserOptions,"4") <> 0) Then
            xmlIcons6 = xmlIcons6 + "<ICON name=""TeamTraining"" action=""ShowTab('TabTraining', 4)"" image=""m_TeamTraining.gif""/>"
         End If
         If (InStr(reqSysUserOptions,"G") <> 0) Then
            xmlIcons6 = xmlIcons6 + "<ICON name=""Mentoring"" action=""ShowTab('TabTraining', 5)"" image=""m_Mentor.gif""/>"
         End If
         If (InStr(reqSysUserOptions,"K") <> 0) Then
            xmlIcons6 = xmlIcons6 + "<ICON name=""Classes"" action=""ShowTab('TabTraining', 1)"" image=""m_Class.gif""/>"
         End If
         If (InStr(reqSysUserOptions,"L") <> 0) Then
            xmlIcons6 = xmlIcons6 + "<ICON name=""Assessments"" action=""ShowTab('TabTraining', 2)"" image=""m_Assessment.gif""/>"
         End If
         If (InStr(reqSysUserOptions,"M") <> 0) Then
            xmlIcons6 = xmlIcons6 + "<ICON name=""Catalog"" action=""ShowTab('TabTraining', 3)"" image=""m_Catalog.gif""/>"
         End If
         xmlIcons6 = xmlIcons6 + "</ICONS6>"
      End If
      If (InStr(reqSysUserOptions,"/") <> 0) Then
         xmlIcons7 = "<ICONS7>"
         xmlIcons7 = xmlIcons7 + "<ICON name=""TaxEstimator"" action=""ShowTab('TabMoney', 1)"" image=""m_Money.gif""/>"
         xmlIcons7 = xmlIcons7 + "</ICONS7>"
      End If
End Select
...
xmlTransaction = xmlTransaction +  xmlIcons6
xmlTransaction = xmlTransaction +  xmlIcons7
...
fileLanguage = "Language" + "\MobileHome[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\MobileHome[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "MobileHome Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "MobileHome Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
xslPage = "MobileHome.xsl"
Set oStyle = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oStyle.load server.MapPath(xslPage)
If oStyle.parseError <> 0 Then
   Response.Write "MobileHome Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "MobileHome Load file (oData) failed with error code " + CStr(oData.parseError)
