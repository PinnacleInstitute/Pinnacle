                     ...
                     <xsl:element name="TABLE">
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="class">PageHeading</xsl:attribute>
                                             ...
                                             <xsl:value-of select="/DATA/TXN/PTSPAYOUT/@payoutid"/>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:if test="(/DATA/TXN/PTSPAYOUT/@show != 0)">
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">gray</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Hidden']"/>
                                                </xsl:element>
                                                <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             </xsl:if>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@wallet = 0) or (/DATA/TXN/PTSPAYOUT/@paytype = 91)">
                                                ...
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">0805.asp?PayoutID=<xsl:value-of select="/DATA/TXN/PTSPAYOUT/@payoutid"/></xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="INPUT">
                                 ...
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSPAYOUT/@show"/></xsl:attribute>
                              </xsl:element>
                              </xsl:if>
                           </xsl:element>
                        </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:if test="(/DATA/SYSTEM/@userstatus = 1) and (/DATA/PARAM/@txn != 5)">
                                 <xsl:element name="INPUT">
                              ...
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/PARAM/@makepayout != 0)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MakePayout']"/>
                                    </xsl:attribute>
                              ...
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/SYSTEM/@usergroup = 1) and (/DATA/PARAM/@txn != 5) and (/DATA/TXN/PTSPAYOUT/@status != 2)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
