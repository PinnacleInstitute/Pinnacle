...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_LoginURL", reqReturnURL
   SetCache "m_LoginDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_login")
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_Login Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_Login Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_Login Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_Login Load file (oData) failed with error code " + CStr(oData.parseError)
