...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "04103URL", reqReturnURL
   SetCache "04103DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "04103")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      tmpNameFirst = Request.Form.Item("NameFirst")
      tmpNameLast = Request.Form.Item("NameLast")
      tmpTaxIDType = Request.Form.Item("TaxIDType")
      ...
      If (xmlError = "") Then
         ValidLogon
      End If
      If (xmlError = "") And (reqIsAgree2 = 0) And (reqComputers > 0) Then
...
fileLanguage = "Language\04103[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\04103[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "04103 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "04103 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "04103 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "04103 Load file (oData) failed with error code " + CStr(oData.parseError)
