...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "NewsLetterURL", reqReturnURL
   SetCache "NewsLetterDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "newsletter")
...
If oLanguage.parseError <> 0 Then
   Response.Write "NewsLetter Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "NewsLetter Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
xslPage = "NewsLetter.xsl"
Set oStyle = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oStyle.load server.MapPath(xslPage)
If oStyle.parseError <> 0 Then
   Response.Write "NewsLetter Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "NewsLetter Load file (oData) failed with error code " + CStr(oData.parseError)
