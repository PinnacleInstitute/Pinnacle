...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "NexxusGiftURL", reqReturnURL
   SetCache "NexxusGiftDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "nexxusgift")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("NexxusGiftURL")
         reqReturnData = GetCache("NexxusGiftDATA")
         SetCache "NexxusGiftURL", ""
         SetCache "NexxusGiftDATA", ""
...
fileLanguage = "Language" + "\NexxusGift[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\NexxusGift[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "NexxusGift Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "NexxusGift Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
xslPage = "NexxusGift.xsl"
Set oStyle = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oStyle.load server.MapPath(xslPage)
If oStyle.parseError <> 0 Then
   Response.Write "NexxusGift Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "NexxusGift Load file (oData) failed with error code " + CStr(oData.parseError)
