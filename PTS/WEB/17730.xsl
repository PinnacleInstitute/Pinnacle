<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Seminar Emails'"/>
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               <xsl:element name="SCRIPT">
                  ...
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function NewEmail(){ 
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SeminarEmails']"/>
                           </xsl:element>
                           <xsl:element name="TD">
                              <xsl:attribute name="width">375</xsl:attribute>
                              ...
                              <xsl:element name="INPUT">
                                 ...
                                 <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[NewEmail()]]></xsl:text></xsl:attribute>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   ...
                                                   <xsl:element name="A">
                                                      <xsl:attribute name="href">17731.asp?SeminarID=<xsl:value-of select="/DATA/PARAM/@seminarid"/>&amp;Day=<xsl:value-of select="@name"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                   ...
                                                   <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                   <xsl:element name="A">
                                                      <xsl:attribute name="onclick">w=window.open(this.href,"PreviewEmail","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                      <xsl:attribute name="href">17732.asp?SeminarID=<xsl:value-of select="/DATA/PARAM/@seminarid"/>&amp;Day=<xsl:value-of select="@name"/></xsl:attribute>
                                                      <xsl:element name="IMG">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">17730.asp?SeminarID=<xsl:value-of select="/DATA/PARAM/@seminarid"/>&amp;DeleteFile=<xsl:value-of select="@name"/></xsl:attribute>
                                                   <xsl:element name="IMG">
