...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8012URL", reqReturnURL
   SetCache "8012DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8012")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("8012URL")
      reqReturnData = GetCache("8012DATA")
      SetCache "8012URL", ""
      SetCache "8012DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "8012 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8012 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8012 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8012 Load file (oData) failed with error code " + CStr(oData.parseError)
