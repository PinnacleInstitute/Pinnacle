...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "9312URL", reqReturnURL
   SetCache "9312DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "9312")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionReturn):
      ...
      reqReturnURL = GetCache("9312URL")
      reqReturnData = GetCache("9312DATA")
      SetCache "9312URL", ""
      SetCache "9312DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "9312 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "9312 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "9312 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "9312 Load file (oData) failed with error code " + CStr(oData.parseError)
