...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8105URL", reqReturnURL
   SetCache "8105DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8105")
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oSalesCampaigns
            .SysCurrentLanguage = reqSysLanguage
            xmlSalesCampaigns = xmlSalesCampaigns + .EnumCompany(tmpCompanyID, tmpGroupID, tmpSalesCampaignID, , CLng(reqSysUserID))
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
         End With
      End If
   ...
   Case CLng(cActionUpdate):
      ...
      Else
         With oProspect
            ...
            .Load CLng(reqProspectID), CLng(reqSysUserID)
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            oldSalesCampaignID = .SalesCampaignID
            .FBDate = 0
            .CloseDate = 0
            .DeadDate = 0
            .Date1 = 0
            ...
            .Date9 = 0
            .Date10 = 0
            newSalesCampaignID = Request.Form.Item("SalesCampaignID")
            .SalesCampaignID = newSalesCampaignID
      ...
      If (oldSalesCampaignID <> 0) Then
         ...
         Else
            With oSalesCampaign
               .SysCurrentLanguage = reqSysLanguage
               .Load newSalesCampaignID, CLng(reqSysUserID)
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
               newSalesCampaignName = .SalesCampaignName
            End With
         End If
         ...
         Else
            With oNote
               ...
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
               .Notes = "CHANGED Sales Campaign to " & newSalesCampaignName
               .AuthUserID = 1
               .NoteDate = Now
               .OwnerType = 81
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("8105URL")
         reqReturnData = GetCache("8105DATA")
         SetCache "8105URL", ""
         SetCache "8105DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "8105 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8105 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8105 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8105 Load file (oData) failed with error code " + CStr(oData.parseError)
