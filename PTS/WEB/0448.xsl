<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Referred Customers'"/>
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               <xsl:element name="SCRIPT">
                  ...
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function ViewSales(id){ 
               var url, win;
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="onclick">ViewSales(<xsl:value-of select="@memberid"/>)</xsl:attribute>
