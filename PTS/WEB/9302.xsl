<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'New Page'"/>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@pagetype = 1)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewEmailLead']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@pagetype = 2)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewEmailPresentation']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@pagetype = 3)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewEmailProspect']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@pagetype = 4)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewEmailContact']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@pagetype = 5)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewEmailCustomer']"/>
                                 </xsl:if>
                           ...
                           <xsl:if test="(/DATA/PARAM/@pagetype = 3)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ProspectCategory']"/>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                           ...
                           <xsl:if test="(/DATA/PARAM/@pagetype = 4)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:attribute name="class">prompt</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ContactCategory']"/>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                           ...
                           <xsl:if test="(/DATA/PARAM/@pagetype = 5)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:attribute name="class">prompt</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CustomerCategory']"/>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
