...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_HomeURL", reqReturnURL
   SetCache "m_HomeDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_home")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionSignIn):
      ...
      Response.Redirect "m_0101.asp" & "?Lgn=" & tmpLgn & "&Pwd=" & tmpPwd & "&Page=" & "MobileHome.asp"
End Select
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_Home Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_Home Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_Home Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_Home Load file (oData) failed with error code " + CStr(oData.parseError)
