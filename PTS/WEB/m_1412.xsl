                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">prompt</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@pagetype = 1)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SelectLeadProgram']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@pagetype = 2)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SelectPresentation']"/>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="(@image != '')">
                                                      <xsl:if test="(@pagetype = 1)">
                                                         <xsl:element name="A">
                                                            <xsl:attribute name="href">m_8108.asp?MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;LeadCampaignID=<xsl:value-of select="@leadcampaignid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/></xsl:attribute>
                                                      ...
                                                      <xsl:if test="(@pagetype = 2)">
                                                         <xsl:element name="A">
                                                            <xsl:attribute name="href">m_8113.asp?MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;LeadCampaignID=<xsl:value-of select="@leadcampaignid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/></xsl:attribute>
                                                            <xsl:element name="IMG">
                                                               <xsl:attribute name="src">Images/LeadCampaign/<xsl:value-of select="@image"/></xsl:attribute>
                                                               <xsl:attribute name="width">110</xsl:attribute>
                                                               <xsl:attribute name="align">absmiddle</xsl:attribute>
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="(@pagetype = 1)">
                                                      ...
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                                         <xsl:attribute name="href">m_1413.asp?LeadCampaignID=<xsl:value-of select="@leadcampaignid"/>&amp;MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                         <xsl:element name="IMG">
                                                            <xsl:attribute name="src">Images/usage24.gif</xsl:attribute>
                                                            <xsl:attribute name="align">absmiddle</xsl:attribute>
                                                            <xsl:attribute name="border">0</xsl:attribute>
                                                            <xsl:attribute name="alt"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ReferralLink']"/></xsl:attribute>
                                                            <xsl:attribute name="title"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ReferralLink']"/></xsl:attribute>
                                                         </xsl:element>
                                                      </xsl:element>
                                                      <xsl:element name="BR"/>
                                                      <xsl:element name="A">
