               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:value-of select="/DATA/TXN/PTSPAYMENT/@paymentid"/>
                              <xsl:if test="(/DATA/TXN/PTSPAYMENT/@ownertype = 52)">
                                    <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                    <xsl:element name="A">
                                       <xsl:attribute name="onclick">w=window.open(this.href,"_blank","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                       <xsl:attribute name="href">5203.asp?SalesOrderID=<xsl:value-of select="/DATA/PARAM/@salesorderid"/></xsl:attribute>
                                       <xsl:element name="IMG">
                                          <xsl:attribute name="src">Images/shoppingcart16.png</xsl:attribute>
                              ...
                              <xsl:if test="(/DATA/TXN/PTSPAYMENT/@ownertype = 04)">
                                    <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                    <xsl:element name="A">
                                       <xsl:attribute name="onclick">w=window.open(this.href,"_blank","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                       <xsl:attribute name="href">0475.asp?MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;Code=2&amp;ContentPage=3&amp;Popup=1</xsl:attribute>
                                       <xsl:element name="IMG">
                                    ...
                                    <xsl:element name="A">
                                       <xsl:attribute name="onclick">w=window.open(this.href,"_blank","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                       <xsl:attribute name="href">0403.asp?MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;ContentPage=3&amp;Popup=1</xsl:attribute>
                                       <xsl:element name="IMG">
                              ...
                              <xsl:if test="(/DATA/PARAM/@message = '')">
                                    <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                    ...
                                    <xsl:if test="(/DATA/PARAM/@txn = 9)">
                                       <xsl:element name="font">
                                          <xsl:attribute name="color">red</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ProductOrdered']"/>
                                       </xsl:element>
                                    </xsl:if>
                              </xsl:if>
                              <xsl:if test="(/DATA/PARAM/@message != '')">
                                    ...
                                    <xsl:element name="font">
                                       <xsl:attribute name="color">red</xsl:attribute>
                                    <xsl:value-of select="/DATA/PARAM/@message" disable-output-escaping="yes"/>
                                    </xsl:element>
                              </xsl:if>
                           </xsl:element>
                        </xsl:element>
                              ...
                              <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:element name="font">
                                       ...
                                       <xsl:value-of select="/DATA/TXN/PTSPAYMENT/@tokentype"/>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                       <xsl:value-of select="/DATA/TXN/PTSPAYMENT/@tokenowner"/>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                       <xsl:value-of select="/DATA/TXN/PTSPAYMENT/@token"/>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:if>
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/TXN/PTSPAYMENT/@commstatus = 2) or (/DATA/TXN/PTSPAYMENT/@commstatus = 4)">
                                 <xsl:element name="IMG">
                     ...
                     win.focus();
                        ...
                        <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 21)">
                           <xsl:element name="TR">
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSPAYMENT/@productid"/></xsl:attribute>
                                 </xsl:element>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='PaidID']"/>
                                 <xsl:text>:</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 <xsl:element name="INPUT">
                                 <xsl:attribute name="type">text</xsl:attribute>
                                 <xsl:attribute name="name">PaidID</xsl:attribute>
                                 <xsl:attribute name="id">PaidID</xsl:attribute>
                                 <xsl:attribute name="size">5</xsl:attribute>
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSPAYMENT/@paidid"/></xsl:attribute>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                        </xsl:if>
                        ...
                        <xsl:if test="(/DATA/PARAM/@companyid = 17)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="align">right</xsl:attribute>
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Fulfill']"/>
                                 <xsl:text>:</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              </xsl:element>
                              <xsl:element name="TD">
                                 ...
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Coins']"/>
                                 <xsl:text>:</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 <xsl:element name="INPUT">
                                 <xsl:attribute name="type">text</xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@companyid = 21) and (/DATA/TXN/PTSPAYMENT/@purpose = 100)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="width">160</xsl:attribute>
                                 <xsl:attribute name="align">right</xsl:attribute>
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CertificateQty']"/>
                                 <xsl:text>:</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              </xsl:element>
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="size">5</xsl:attribute>
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSPAYMENT/@retail"/></xsl:attribute>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                        ...
                        <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 21) or (/DATA/SYSTEM/@usergroup = 51) or (contains(/DATA/SYSTEM/@useroptions, 'V'))">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">2</xsl:attribute>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 win.focus();
                                    ...
                                    <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                    <xsl:if test="(/DATA/TXN/PTSPAYMENT/@status &lt;= 1)">
                                       <xsl:element name="INPUT">
                                          <xsl:attribute name="type">button</xsl:attribute>
                                          <xsl:attribute name="class">smbutton</xsl:attribute>
                                          <xsl:attribute name="value">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='UpdatePaymentMethod']"/>
                                          </xsl:attribute>
                                          <xsl:attribute name="onclick">doSubmit(5,'<xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ConfirmUpdateMethod']"/>')</xsl:attribute>
                                       </xsl:element>
                                    </xsl:if>
                              </xsl:element>
                           </xsl:element>

                           <xsl:if test="(/DATA/PARAM/@hidepayment = 0)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">2</xsl:attribute>
                                    <xsl:attribute name="width">600</xsl:attribute>
                           ...
                           <xsl:if test="(/DATA/PARAM/@hidepayment != 0)">
                              <xsl:element name="INPUT">
                                 ...
                                 <xsl:attribute name="name">Description</xsl:attribute>
                                 <xsl:attribute name="id">Description</xsl:attribute>
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSPAYMENT/@description"/></xsl:attribute>
                              </xsl:element>
                           </xsl:if>

                        </xsl:if>
                        <xsl:if test="(/DATA/SYSTEM/@usergroup != 1) and (not(contains(/DATA/SYSTEM/@useroptions, 'V')))">
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">Description</xsl:attribute>
                              <xsl:attribute name="id">Description</xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:if test="(/DATA/SYSTEM/@userstatus = 1) and (/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51) or (/DATA/SYSTEM/@usergroup = 52)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
                              ...
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="((/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51) or (/DATA/SYSTEM/@usergroup = 52)) and (/DATA/TXN/PTSPAYMENT/@status &lt; 3) and (/DATA/TXN/PTSPAYMENT/@paytype = 14)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='RequestBitcoin']"/>
                                    </xsl:attribute>
                                    <xsl:attribute name="onclick">doSubmit(8,'<xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ConfirmRequestBitcoin']"/>')</xsl:attribute>
                                 </xsl:element>
                              </xsl:if>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/SYSTEM/@userstatus = 1) and (/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51) or (/DATA/SYSTEM/@usergroup = 52)">
                              ...
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="((/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51)) and (/DATA/TXN/PTSPAYMENT/@commstatus = 2)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Reclaim']"/>
                                    </xsl:attribute>
                                    <xsl:attribute name="onclick">doSubmit(6,'<xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ConfirmReclaim']"/>')</xsl:attribute>
                                 </xsl:element>
                              </xsl:if>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/SYSTEM/@userstatus = 1) and (/DATA/SYSTEM/@usergroup &lt;= 21) and (/DATA/TXN/PTSPAYMENT/@status &lt;= 1)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ClearMethod']"/>
                                    </xsl:attribute>
                                    <xsl:attribute name="onclick">doSubmit(7,'<xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ConfirmClear']"/>')</xsl:attribute>
                                 </xsl:element>
                              </xsl:if>
                           </xsl:element>
                        </xsl:element>
