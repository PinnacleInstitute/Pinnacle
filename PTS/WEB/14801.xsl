                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="TABLE">
                                    ...
                                    <xsl:attribute name="width">750</xsl:attribute>
                                       ...
                                       <xsl:if test="(/DATA/TXN/PTSMEMBER/@title &gt;= 2) and (/DATA/TXN/PTSMEMBER/@level = 1)">
                                          <xsl:element name="TR">
                                             <xsl:element name="TD">
                                                <xsl:attribute name="colspan">3</xsl:attribute>
                                                <xsl:attribute name="height">12</xsl:attribute>
                                       ...
                                       <xsl:if test="(/DATA/TXN/PTSMEMBER/@title &gt;= 2) and (/DATA/TXN/PTSMEMBER/@level &gt;= 2)">
                                          <xsl:element name="TR">
                                             <xsl:element name="TD">
                                                <xsl:attribute name="colspan">3</xsl:attribute>
                                                <xsl:attribute name="height">12</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="align">left</xsl:attribute>
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership18_4']"/>
                                             </xsl:element>
                                          </xsl:element>
