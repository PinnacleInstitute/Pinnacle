...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "4802URL", reqReturnURL
   SetCache "4802DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "4802")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      If (xmlError = "") Then
         Response.Redirect "4803.asp" & "?ApptID=" & ApptID & "&Updated=" & 3
      End If
End Select
...
If oLanguage.parseError <> 0 Then
   Response.Write "4802 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "4802 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "4802 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "4802 Load file (oData) failed with error code " + CStr(oData.parseError)
