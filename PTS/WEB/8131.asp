...
pos = InStr(LCASE(reqSysServerPath), "8131")
...
If oStyle.parseError <> 0 Then
   Response.Write "8131 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oNewsLetter
            ...
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            tmpNewsLetterName = .NewsLetterName
            xmlNewsLetter = .XML()
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
         End With
      End If
      Set oNewsLetter = Nothing
      tmpSubject = "Subscription: " + tmpNewsLetterName
...
fileLanguage = "Language" + "\8131[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\8131[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "8131 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8131 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8131 Load file (oData) failed with error code " + CStr(oData.parseError)
