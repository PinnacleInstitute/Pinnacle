<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Survey Report'"/>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:element name="BR"/>
                                 <xsl:value-of select="/DATA/TXN/PTSSURVEY/@enddate"/>
                                  - 
                                 <xsl:value-of select="/DATA/TXN/PTSSURVEY/@enddate"/>
                                 <xsl:element name="BR"/>
                        ...
                        <xsl:element name="TR">
                           <xsl:for-each select="/DATA/TXN/PTSSURVEYQUESTIONS/PTSSURVEYQUESTION">
                                 ...
                                 <xsl:if test="(count(/DATA/TXN/PTSSURVEYANSWERS/PTSSURVEYANSWER[(@answer != '') and (@surveyquestionid = current()/@surveyquestionid) ]) &gt; 0)">
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          <xsl:attribute name="colspan">3</xsl:attribute>
                                          <xsl:attribute name="height">6</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:for-each select="/DATA/TXN/PTSSURVEYANSWERS/PTSSURVEYANSWER[(@surveyquestionid = current()/@surveyquestionid)]">
                                             <xsl:if test="(@answer != '')">
                                                <xsl:element name="TR">
                                                   <xsl:element name="TD">
                                                      <xsl:attribute name="width">15</xsl:attribute>
                                                         ...
                                                         <xsl:attribute name="width">620</xsl:attribute>
                                                            ...
                                                            <xsl:element name="TR">
                                                               <xsl:element name="TD">
                                                                  ...
                                                                  <xsl:attribute name="align">left</xsl:attribute>
                                                                  <xsl:attribute name="valign">top</xsl:attribute>
                                                                  <xsl:value-of select="@answerdate"/>
                                                                  <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                                   - 
                                                               </xsl:element>
                                                               <xsl:element name="TD">
