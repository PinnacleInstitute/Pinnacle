<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'My Courses'"/>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="A">
                                    ...
                                    <xsl:attribute name="href">11Import.asp?TrainerID=<xsl:value-of select="/DATA/PARAM/@trainerid"/></xsl:attribute>
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSCOURSES/PTSCOURSE">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">2311.asp?CourseID=<xsl:value-of select="@courseid"/>&amp;ContentPage=3&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                <xsl:element name="IMG">
                                             ...
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="href">1330.asp?CourseID=<xsl:value-of select="@courseid"/>&amp;ContentPage=3&amp;Popup=1</xsl:attribute>
                                                <xsl:element name="IMG">
