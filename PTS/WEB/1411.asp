...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1411URL", reqReturnURL
   SetCache "1411DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1411")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oLeadCampaigns
            ...
            .ListGroup CLng(reqGroupID), CLng(reqPageType)
   ...
   Case CLng(cActionReturn):
      ...
      reqReturnURL = GetCache("1411URL")
      reqReturnData = GetCache("1411DATA")
      SetCache "1411URL", ""
      SetCache "1411DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "1411 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1411 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1411 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1411 Load file (oData) failed with error code " + CStr(oData.parseError)
