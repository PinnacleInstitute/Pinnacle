                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23)">
                                    ...
                                    <xsl:element name="A">
                                       ...
                                       <xsl:attribute name="href">5250.asp?C=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;Me=<xsl:value-of select="/DATA/PARAM/@memberid"/></xsl:attribute>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:element name="TR">
                                    ...
                                    <xsl:element name="TD">
                                       <xsl:attribute name="align">left</xsl:attribute>
                                       <xsl:attribute name="width">61%</xsl:attribute>
                                       <xsl:attribute name="class">ColumnTitle</xsl:attribute>
                                       <xsl:attribute name="valign">Bottom</xsl:attribute>
