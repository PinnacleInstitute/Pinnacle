<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Sales Orders'"/>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                                 ...
                                 <xsl:element name="A">
                                    ...
                                    <xsl:attribute name="href">5250.asp?Me=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;C=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;N=1</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51)">
                                                ...
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">5203.asp?SalesOrderID=<xsl:value-of select="@salesorderid"/>&amp;ContentPage=3&amp;Popup=1</xsl:attribute>
                                                   <xsl:element name="IMG">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="href">5216.asp?SalesOrderID=<xsl:value-of select="@salesorderid"/></xsl:attribute>
                                                <xsl:element name="IMG">
