...
pos = InStr(LCASE(reqSysServerPath), "8829")
...
If oStyle.parseError <> 0 Then
   Response.Write "8829 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oLanguage.parseError <> 0 Then
   Response.Write "8829 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8829 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8829 Load file (oData) failed with error code " + CStr(oData.parseError)
