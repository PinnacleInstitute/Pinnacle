                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 21) or (/DATA/SYSTEM/@usergroup = 51)">
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">0113.asp?AuthUserID=<xsl:value-of select="/DATA/TXN/PTSORG/@authuserid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                             <xsl:element name="b">
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 21) or (/DATA/SYSTEM/@usergroup = 51)">
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="href">0107.asp?AuthUserID=<xsl:value-of select="/DATA/TXN/PTSORG/@authuserid"/>&amp;Popup=1</xsl:attribute>
                                             <xsl:element name="b">
                        ...
                        <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 21) or (/DATA/SYSTEM/@usergroup = 51)">
                           ...
                           <xsl:element name="TR">
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSORG/DESCRIPTION/comment()"/></xsl:attribute>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                        </xsl:if>
