                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:if test="(/DATA/PARAM/@v != '')">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:value-of select="/DATA/PARAM/@v" disable-output-escaping="yes"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                        </xsl:if>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="b">
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='JoinNowText']"/>
                                 <xsl:element name="BR"/>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='JoinNowText2']"/>
                                 <xsl:element name="BR"/><xsl:element name="BR"/>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='JoinNowText3']"/>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
