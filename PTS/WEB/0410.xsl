      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               <xsl:element name="SCRIPT">
                  <xsl:attribute name="language">JavaScript</xsl:attribute>
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function ViewNotify(id){ 
          var url, win;
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="IFRAME">
                                 <xsl:attribute name="src">9011.asp?OwnerType=-4&amp;OwnerID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;NewDate=<xsl:value-of select="/DATA/PARAM/@newdate"/>&amp;Title=<xsl:value-of select="/DATA/PARAM/@title"/></xsl:attribute>
                                 <xsl:attribute name="width">600</xsl:attribute>
                                 ...
                                 <xsl:element name="A">
                                    <xsl:attribute name="href">9011.asp?OwnerType=-4&amp;OwnerID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;NewDate=<xsl:value-of select="/DATA/PARAM/@newdate"/>&amp;Title=<xsl:value-of select="/DATA/PARAM/@title"/></xsl:attribute>
                                       ...
                                       <xsl:element name="TR">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                ...
                                                <xsl:if test="(@mentorid != 0)">
                                                      ...
                                                      <xsl:element name="A">
                                                         ...
                                                         <xsl:attribute name="href">0410.asp?MemberID=<xsl:value-of select="@memberid"/>&amp;M=<xsl:value-of select="/DATA/PARAM/@m"/>&amp;ContentPage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;Popup=<xsl:value-of select="/DATA/PARAM/@popup"/></xsl:attribute>
                                                         <xsl:element name="IMG">
                                                ...
                                                <xsl:if test="(not(@notifymentor))">
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="href">#_</xsl:attribute>
                                                         <xsl:attribute name="onclick">ViewNotify(<xsl:value-of select="@memberid"/>)</xsl:attribute>
                                                         <xsl:element name="IMG">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                ...
                                                <xsl:element name="A">
                                                   <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                                   <xsl:attribute name="href">0410.asp?MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;RemoveID=<xsl:value-of select="@memberid"/>&amp;ContentPage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;Popup=<xsl:value-of select="/DATA/PARAM/@popup"/></xsl:attribute>
                                                   <xsl:element name="IMG">
