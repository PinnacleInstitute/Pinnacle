...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "17105URL", reqReturnURL
   SetCache "17105DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "17105")
...
reqCustomFields =  GetInput("CustomFields", reqPageData)
reqTest =  Numeric(GetInput("Test", reqPageData))
reqDisplay =  Numeric(GetInput("Display", reqPageData))
reqValues =  GetInput("Values", reqPageData)
...
xmlParam = xmlParam + " customfields=" + Chr(34) + CleanXML(reqCustomFields) + Chr(34)
xmlParam = xmlParam + " test=" + Chr(34) + CStr(reqTest) + Chr(34)
xmlParam = xmlParam + " display=" + Chr(34) + CStr(reqDisplay) + Chr(34)
xmlParam = xmlParam + " values=" + Chr(34) + CleanXML(reqValues) + Chr(34)
xmlParam = xmlParam + " />"
...
If oLanguage.parseError <> 0 Then
   Response.Write "17105 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "17105 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "17105 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "17105 Load file (oData) failed with error code " + CStr(oData.parseError)
