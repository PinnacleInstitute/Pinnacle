<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Support Documents'"/>
                     ...
                     <xsl:element name="TABLE">
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="IMG">
                                             <xsl:attribute name="src">Images/faq.gif</xsl:attribute>
                                             <xsl:attribute name="border">0</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="width">600</xsl:attribute>
                                                ...
                                                <xsl:element name="TR">
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SupportDocuments']"/>
                                                   </xsl:element>
                                                </xsl:element>
                                                <xsl:element name="TR">
                                                   <xsl:element name="TD">
                                                ...
                                                <xsl:element name="TR">
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SupportDocumentText']"/>
                                                   </xsl:element>
                                                </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SearchDate']"/>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="INPUT">
                              <xsl:attribute name="type">text</xsl:attribute>
                              <xsl:attribute name="name">SearchDate</xsl:attribute>
                              <xsl:attribute name="id">SearchDate</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@searchdate"/></xsl:attribute>
                              ...
                              <xsl:element name="IMG">
                                 ...
                                 <xsl:attribute name="border">0</xsl:attribute>
                                 <xsl:attribute name="onclick">CalendarPopup(document.forms[0], document.getElementById('SearchDate'))</xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="INPUT">
                                 <xsl:attribute name="type">submit</xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:attribute name="class">ColumnHeader</xsl:attribute>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SearchTypeText']"/>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:variable name="tmp"><xsl:value-of select="/DATA/PARAM/@orgid"/></xsl:variable>
                                 <xsl:for-each select="/DATA/TXN/PTSORGS/ENUM">
                        ...
                        <xsl:if test="(/DATA/PARAM/@orgid != 0) or (/DATA/PARAM/@searchtext != '') or (/DATA/PARAM/@searchdate != '')">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="width">750</xsl:attribute>
                                 <xsl:attribute name="align">left</xsl:attribute>
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                                ...
                                                <xsl:if test="(@islink = 0)">
                                                   <xsl:element name="A">
                                                      <xsl:attribute name="onclick">w=window.open(this.href,"blank","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                      <xsl:attribute name="href">Attachments/<xsl:value-of select="concat(@parenttype,'/',@parentid,'/',@filename)"/></xsl:attribute>
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="@attachname"/>
                                                   </xsl:element>
                                                   </xsl:element>
                                             ...
                                             <xsl:if test="(@islink != 0)">
                                                   <xsl:if test="(/DATA/SYSTEM/@usergroup != 41) or (contains(/DATA/SYSTEM/@useroptions, 's'))">
                                                      <xsl:element name="A">
                                                         ...
                                                         <xsl:attribute name="href">9202.asp?EntityID=80&amp;ItemID=<xsl:value-of select="@attachmentid"/>&amp;Name=<xsl:value-of select="translate(@attachname,'&amp;',' ')"/>&amp;URL=<xsl:value-of select="@filename"/>&amp;IsPopup=1</xsl:attribute>
                                                         <xsl:element name="IMG">
                                             ...
                                             <xsl:if test="(@islink = 0)">
                                                   <xsl:if test="(/DATA/SYSTEM/@usergroup != 41) or (contains(/DATA/SYSTEM/@useroptions, 's'))">
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="onclick">w=window.open(this.href,"shortcut","width=400, height=150");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                         <xsl:attribute name="href">9202.asp?EntityID=80&amp;ItemID=<xsl:value-of select="@attachmentid"/>&amp;Name=<xsl:value-of select="translate(@attachname,'&amp;',' ')"/>&amp;URL=Attachments/<xsl:value-of select="concat(@parenttype,'/',@parentid,'/',@filename)"/>&amp;IsPopup=1</xsl:attribute>
                                                         <xsl:element name="IMG">
                                                            <xsl:attribute name="src">Images/Shortcut.gif</xsl:attribute>
                                                            <xsl:attribute name="border">0</xsl:attribute>
                                                         </xsl:element>
