<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Project Report'"/>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ProjectsReport']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="(@status = 2)">
                                                   ...
                                                   <xsl:element name="A">
                                                      ...
                                                      <xsl:attribute name="href">7503.asp?ProjectID=<xsl:value-of select="@projectid"/>&amp;ProjectMemberID=<xsl:value-of select="/DATA/TXN/PTSPROJECT/@memberid"/></xsl:attribute>
