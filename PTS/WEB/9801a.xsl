                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AddNewsStories']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:variable name="tmp"><xsl:value-of select="/DATA/TXN/PTSNEWSS/@findtypeid"/></xsl:variable>
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">9812</xsl:attribute>
                                    <xsl:if test="$tmp='9812'"><xsl:attribute name="SELECTED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ActiveDate']"/>
                                 </xsl:element>
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">9810</xsl:attribute>
                                    <xsl:if test="$tmp='9810'"><xsl:attribute name="SELECTED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Title']"/>
                                 </xsl:element>
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">9811</xsl:attribute>
                                    <xsl:if test="$tmp='9811'"><xsl:attribute name="SELECTED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Description']"/>
                                 </xsl:element>
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">9814</xsl:attribute>
                                    <xsl:if test="$tmp='9814'"><xsl:attribute name="SELECTED"/></xsl:if>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="INPUT">
                                 ...
                                 <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[window.parent.doSubmit(5,'')]]></xsl:text></xsl:attribute>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
