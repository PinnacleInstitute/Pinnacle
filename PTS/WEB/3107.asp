...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "3107URL", reqReturnURL
   SetCache "3107DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "3107")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      If (reqI <> 0) Then
         SetCache "CERTID", reqMemberAssessID
         ...
         Else
            With oMemberAssess
               ...
               .Load reqMemberAssessID, CLng(reqSysUserID)
   ...
   Set oFileSys = Nothing
      ...
      End If
      If (reqI = 0) Then
         reqMemberAssessID = GetCache("CERTID")
         ...
         Else
            With oMemberAssess
               ...
               tmpDate = FormatDateTime(.CompleteDate, 2)
               tmpScore = .Result
            End With
         End If
         Set oMemberAssess = Nothing
         ...
         Else
            With oAddresss
               .SysCurrentLanguage = reqSysLanguage
               .ListOwnerType 04, tmpMemberID, 2
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
         ...
         Else
            With oHTMLFile
               ...
               .Path = reqSysWebDirectory + "Sections\Assessment\" + CStr(tmpAssessmentID)
...
If oLanguage.parseError <> 0 Then
   Response.Write "3107 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "3107 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "3107 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "3107 Load file (oData) failed with error code " + CStr(oData.parseError)
