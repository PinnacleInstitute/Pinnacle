...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "ChannelURL", reqReturnURL
   SetCache "ChannelDATA", reqReturnData
End If
...
pos = InStr(reqSysServerPath, "Channel")
...
reqChannel =  Numeric(GetInput("Channel", reqPageData))
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oNewss
            .ListNews CLng(reqCompanyID), CLng(reqChannel)
