...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "2432URL", reqReturnURL
   SetCache "2432DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "2432")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      If (reqH = 0) Then
         reqH = 240
      End If
      If (InStr(reqV,".rm") > 0) Or (InStr(reqV,".ram") > 0) Then
         reqY = 1
      End If
      If (InStr(reqV,".swf") > 0) Or (InStr(reqV,".flv") > 0) Or (InStr(reqV,".fla") > 0) Then
         reqY = 2
      End If
      ...
      If (reqP <> "") Then
         ...
         Else
            With oHTMLFile
               ...
               End If
               If (reqC <> 0) Then
                  .Path = reqSysWebDirectory + "Sections\Company\" + CStr(reqC)
               End If
...
xmlConfig = xmlConfig + " />"
xmlParam = "<PARAM"
xmlParam = xmlParam + " v=" + Chr(34) + CleanXML(reqV) + Chr(34)
...
xmlParam = xmlParam + " u=" + Chr(34) + CleanXML(reqU) + Chr(34)
...
fileLanguage = "Language" + "\2432[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\2432[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "2432 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "2432 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "2432 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "2432 Load file (oData) failed with error code " + CStr(oData.parseError)
