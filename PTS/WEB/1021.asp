...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1021URL", reqReturnURL
   SetCache "1021DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1021")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      reqFromDate = DateAdd("m", -12, reqToDate)
      If (reqSysCompanyID = 14) Then
...
Else
   With oPayments
      ...
      reqBookmark = .FindMember(reqFindTypeID, reqBookmark, reqSearchText, reqDirection, CLng(reqMemberID), CDate(reqFromDate), tmpToDate, CLng(reqSysUserID))
      If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
...
If oLanguage.parseError <> 0 Then
   Response.Write "1021 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1021 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1021 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1021 Load file (oData) failed with error code " + CStr(oData.parseError)
