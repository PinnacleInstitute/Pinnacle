<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Legacy Processing'"/>
               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@process = 60)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ExportDataOrders']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 61)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ExportDataItems']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 62)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ExportDataPayments']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 63)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ExportDataBonuses']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 64)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ListBinaryOverage']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 65)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ListMissingBilling']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 66)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ListMissingPayment']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 67)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ListMissingAddress']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 68)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SalesTeamExceptions']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 69)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='BillingExceptions']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 70)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderExceptions']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 71)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='PayoutExceptions']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 72)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewDeclinedPayments']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 73)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MemberByTitle']"/>
                                 </xsl:if>
                        ...
                        <xsl:if test="(/DATA/PARAM/@process = 12) or (/DATA/PARAM/@process = 39) or (/DATA/PARAM/@process = 47) or (/DATA/PARAM/@process = 54) or (/DATA/PARAM/@process = 60) or (/DATA/PARAM/@process = 61) or (/DATA/PARAM/@process = 62) or (/DATA/PARAM/@process = 63)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">1</xsl:attribute>
                                 <xsl:attribute name="height">12</xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@process = 2) or (/DATA/PARAM/@process = 11) or (/DATA/PARAM/@process = 21) or (/DATA/PARAM/@process = 24) or (/DATA/PARAM/@process = 25) or (/DATA/PARAM/@process = 35) or (/DATA/PARAM/@process = 28) or (/DATA/PARAM/@process = 48) or (/DATA/PARAM/@process = 49) or (/DATA/PARAM/@process = 78)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">1</xsl:attribute>
                                 <xsl:attribute name="height">12</xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@result != '')">
                           ...
                           <xsl:if test="(/DATA/PARAM/@process = 5) or (/DATA/PARAM/@process = 53) or (/DATA/PARAM/@process = 72)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">1</xsl:attribute>
                                    <xsl:attribute name="height">12</xsl:attribute>
                              ...
                              <xsl:for-each select="/DATA/TXN/PTSMEMBERS/PTSMEMBER">
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@process = 5) or (/DATA/PARAM/@process = 72)">
                                                <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                <xsl:element name="A">
                           ...
                           <xsl:if test="(/DATA/PARAM/@process = 29) or (/DATA/PARAM/@process = 55) or (/DATA/PARAM/@process = 64) or (/DATA/PARAM/@process = 65) or (/DATA/PARAM/@process = 66) or (/DATA/PARAM/@process = 67) or (/DATA/PARAM/@process = 68) or (/DATA/PARAM/@process = 69) or (/DATA/PARAM/@process = 70) or (/DATA/PARAM/@process = 71)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">1</xsl:attribute>
                                    <xsl:attribute name="height">12</xsl:attribute>
                           ...
                           <xsl:if test="(/DATA/PARAM/@process = 73) or (/DATA/PARAM/@process = 75)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">1</xsl:attribute>
                                    <xsl:attribute name="height">12</xsl:attribute>
                           ...
                           <xsl:if test="(/DATA/PARAM/@process = 30)">
                              ...
                              <xsl:element name="TR">
                                 <xsl:for-each select="/DATA/TXN/PTSLEGACYS/PTSLEGACY">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">800</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
