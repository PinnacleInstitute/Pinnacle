...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_15005aURL", reqReturnURL
   SetCache "m_15005aDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_15005a")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionLogonMerchant):
      ...
      If (xmlError = "") And (reqUserKey = "") Then
         ...
         If (StaffAccess = 0) Then
            Response.Redirect "m_15000.asp" & "?MerchantID=" & Result & "&ReturnURL=" & reqPageURL & "&ReturnData=" & reqPageData
         End If

         If (StaffAccess <> 0) Then
            Response.Redirect "m_15212.asp" & "?MerchantID=" & Result & "&Popup=" & 2 & "&ReturnURL=" & reqPageURL & "&ReturnData=" & reqPageData
         End If
      End If
   ...
   Case CLng(cActionLogonConsumer):
      ...
      If (xmlError = "") And (reqUserKey = "") Then
         ...
         Response.Redirect "m_15100.asp" & "?ConsumerID=" & Result & "&ReturnURL=" & reqPageURL & "&ReturnData=" & reqPageData
      End If
   ...
   Case CLng(cActionForgotPasswordMerchant):
      ...
      Else
         With oMerchant
            .SysCurrentLanguage = reqSysLanguage
            Result = CLng(.LogonMerchant(reqLogonMerchant))
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            If (Result > 0) Then
      ...
      If (tmpMerchantID <> 0) Then
         ...
         Else
            ...
            oHTTP.open "GET", tmpServer + "15006.asp" & "?MerchantID=" & tmpMerchantID
            oHTTP.send
         End If
         Set oHTTP = Nothing
      End If
   ...
   Case CLng(cActionForgotPasswordConsumer):
      ...
      Else
         With oConsumer
            .SysCurrentLanguage = reqSysLanguage
            Result = CLng(.LogonMerchant(reqLogonConsumer))
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            If (Result > 0) Then
      ...
      If (tmpConsumerID <> 0) Then
         ...
         Else
            tmpServer = "http://" + reqSysServerName + reqSysServerPath
            oHTTP.open "GET", tmpServer + "15007.asp" & "?ConsumerID=" & tmpConsumerID
            oHTTP.send
         End If
         Set oHTTP = Nothing
      End If
...
fileLanguage = "Language" + "\m_15005[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\m_15005[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "m_15005a Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_15005a Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
xslPage = "m_15005a.xsl"
Set oStyle = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oStyle.load server.MapPath(xslPage)
If oStyle.parseError <> 0 Then
   Response.Write "m_15005a Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_15005a Load file (oData) failed with error code " + CStr(oData.parseError)
