                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MyPayments']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSPAYMENTS/PTSPAYMENT">
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">left</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:variable name="tmp2"><xsl:value-of select="../PTSPAYTYPES/ENUM[@id=current()/@paytype]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp2]"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
