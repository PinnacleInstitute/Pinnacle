   ...
   <xsl:template match="/">
      ...
      <xsl:element name="BODY">
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:attribute name="onload">document.getElementById('<xsl:value-of select="position()"/>').focus()</xsl:attribute>
            </xsl:otherwise>
         </xsl:choose>
                        ...
                        <xsl:for-each select="/DATA/TXN/PTSQUESTIONS/PTSQUESTION">
                              ...
                              <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="value"><xsl:value-of select="@answer"/></xsl:attribute>
