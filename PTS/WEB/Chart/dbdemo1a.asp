...
Dim services(11)
Do While Not rs.EOF
	software(rs.fields("ArrayIndex").Value) = rs.fields("Software").Value
	hardware(rs.fields("ArrayIndex").Value) = rs.fields("Hardware").Value
	services(rs.fields("ArrayIndex").Value) = rs.fields("Services").Value
	rs.MoveNext
Loop
rs.Close()
...
Call layer.addDataSet(software, -1, "Software")
Call layer.addDataSet(hardware, -1, "Hardware")
Call layer.addDataSet(services, -1, "Services")
