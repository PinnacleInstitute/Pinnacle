...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0204URL", reqReturnURL
   SetCache "0204DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0204")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oHTMLFile
            .Filename = "EmployeeNews" + CSTR(reqSysUserGroup) + ".htm"
      ...
      Else
         With oHTMLFile
            .Filename = "Employee" + CSTR(reqSysUserGroup) + ".htm"
            .Path = reqSysWebDirectory + "Sections\"
            .Language = reqSysLanguage
            .Project = SysProject
            .Load 
...
If oLanguage.parseError <> 0 Then
   Response.Write "0204 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0204 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0204 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0204 Load file (oData) failed with error code " + CStr(oData.parseError)
