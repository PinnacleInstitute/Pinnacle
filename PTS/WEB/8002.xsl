                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/PARAM/@parenttype != 24)">
                                    <xsl:if test="(/DATA/PARAM/@mini = 0)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AddText']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@mini != 0)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AddMiniText']"/>
                                    </xsl:if>
                              </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@parenttype = 24)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AddHomeworkText']"/>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="TEXTAREA">
                                    ...
                                    <xsl:attribute name="cols">65</xsl:attribute>
