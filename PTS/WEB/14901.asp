...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "14901URL", reqReturnURL
   SetCache "14901DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "14901")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("14901URL")
      reqReturnData = GetCache("14901DATA")
      SetCache "14901URL", ""
      SetCache "14901DATA", ""
...
fileLanguage = "Language" + "\14901[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\14901[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "14901 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "14901 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "14901 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "14901 Load file (oData) failed with error code " + CStr(oData.parseError)
