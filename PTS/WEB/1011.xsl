                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="A">
                                    ...
                                    <xsl:attribute name="href">1005.asp?OwnerType=<xsl:value-of select="/DATA/PARAM/@ownertype"/>&amp;OwnerID=<xsl:value-of select="/DATA/PARAM/@ownerid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
