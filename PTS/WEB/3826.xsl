                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@mode = 1)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CalcEnrollment']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@mode = 2)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CalcTuition']"/>
                                 </xsl:if>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@mode = 11)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CalcFastStart']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@mode = 12)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CalcLeadership']"/>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>

                        <xsl:if test="(/DATA/PARAM/@mode = 1) or (/DATA/PARAM/@mode = 2) or (/DATA/PARAM/@mode = 11) or (/DATA/PARAM/@mode = 12)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">1</xsl:attribute>
                                 <xsl:attribute name="height">12</xsl:attribute>
