...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8113URL", reqReturnURL
   SetCache "8113DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8113")
         ...
         With oProspect
            ...
            .Description = Request.Form.Item("Description")
                  ...
                  For x = 1 To 10
                    ...
                    phone = trim(Request.Form.Item("Phone" & x))
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      If (xmlError = "") And (reqPopup = 0) Then
         reqReturnURL = GetCache("8113URL")
         reqReturnData = GetCache("8113DATA")
         SetCache "8113URL", ""
         SetCache "8113DATA", ""
...
fileLanguage = "Language" + "\8113[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\8113[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "8113 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8113 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8113 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8113 Load file (oData) failed with error code " + CStr(oData.parseError)
