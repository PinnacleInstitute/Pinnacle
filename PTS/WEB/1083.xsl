                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="id">Commission</xsl:attribute>
                              <xsl:attribute name="size">10</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSPAYMENT/@commission"/></xsl:attribute>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                        ...
                        <xsl:if test="(/DATA/SYSTEM/@usergroup &gt; 21)">
                           ...
                           <xsl:if test="(/DATA/SYSTEM/@usergroup &gt; 21)">
                              <xsl:element name="INPUT">
                                 ...
                                 <xsl:attribute name="name">PayType</xsl:attribute>
                                 <xsl:attribute name="id">PayType</xsl:attribute>
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSPAYMENT/@paytype"/></xsl:attribute>
                              </xsl:element>
                           </xsl:if>
