<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Project Notes Report'"/>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="class">PageHeading</xsl:attribute>
                                    ...
                                    <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ViewOnlyNotes']"/>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                     ...
                     document.getElementById('ToDate').value = todate.getMonth()+1 + "/" + todate.getDate() + "/" + todate.getFullYear();
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="value">3</xsl:attribute>
                              <xsl:if test="/DATA/PARAM[@search=3]">
                                 <xsl:attribute name="CHECKED"/>
                              </xsl:if>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='StartsWith']"/>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="INPUT">
                              <xsl:attribute name="type">radio</xsl:attribute>
                              ...
                              <xsl:attribute name="id">Search</xsl:attribute>
                              <xsl:attribute name="value">4</xsl:attribute>
                              <xsl:if test="/DATA/PARAM[@search=4]">
                                 <xsl:attribute name="CHECKED"/>
                              </xsl:if>
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="b">
                                    <xsl:if test="(/DATA/PARAM/@report = 2)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TotalActivities']"/>
                                       <xsl:text>:</xsl:text>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@report = 1)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TotalReminders']"/>
                                       <xsl:text>:</xsl:text>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@report = 3)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TotalStartingWith']"/>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                       <xsl:value-of select="/DATA/PARAM/@searchtext" disable-output-escaping="yes"/>
                                       :
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@report = 4)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TotalContaining']"/>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                       <xsl:value-of select="/DATA/PARAM/@searchtext" disable-output-escaping="yes"/>
                                       :
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                   ...
                                                   <xsl:if test="(@ownertype = 75)">
                                                      <xsl:element name="A">
                                                         ...
                                                         <xsl:attribute name="href">7503.asp?ProjectID=<xsl:value-of select="@ownerid"/></xsl:attribute>
                                                      <xsl:value-of select="@data1"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                                <xsl:if test="(@ownertype = 74)">
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="class">NavBar</xsl:attribute>
                                                         <xsl:attribute name="onclick">w=window.open(this.href,"Task","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                         <xsl:attribute name="href">7403.asp?TaskID=<xsl:value-of select="@ownerid"/></xsl:attribute>
                                                      <xsl:value-of select="@data2"/>
                                                      </xsl:element>
                                                      <xsl:value-of select="concat(' (', @data1,')')"/>
                                                </xsl:if>
                                                    - 
                                                   <xsl:value-of select="/DATA/TXN/PTS/@data3"/>
                                                   <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                   <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 21) or ((@islocked = 0) and (@authuserid = /DATA/SYSTEM/@userid))">
                                                      ...
                                                      (<xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='editnote']"/>)
                                                      </xsl:element>
                                                   </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
