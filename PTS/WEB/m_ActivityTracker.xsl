<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Activity Tracker'"/>
...
<xsl:element name="SCRIPT">
   ...
   var UserMenu = new CMenu(UserMenuDef, 'UserMenu'); UserMenu.create();
                        ...
                        <xsl:element name="TR">
                           <xsl:attribute name="id">TabActivity</xsl:attribute>
                           <xsl:element name="TD">
                              <xsl:attribute name="width">100%</xsl:attribute>
                              <xsl:attribute name="align">left</xsl:attribute>
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:element name="IFRAME">
                                 ...
                                 <xsl:attribute name="id">ActivityFrame</xsl:attribute>
                                 <xsl:attribute name="name">ActivityFrame</xsl:attribute>
                                 <xsl:attribute name="class">FrameNoScroll</xsl:attribute>
                                 <xsl:attribute name="frameborder">0</xsl:attribute>
                                 <xsl:attribute name="onload">ShowFrame('TaActivity')</xsl:attribute>
                                 <xsl:element name="A">
