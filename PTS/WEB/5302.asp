...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "5302URL", reqReturnURL
   SetCache "5302DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "5302")
...
End If
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("5302URL")
         reqReturnData = GetCache("5302DATA")
         SetCache "5302URL", ""
         SetCache "5302DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "5302 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "5302 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "5302 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "5302 Load file (oData) failed with error code " + CStr(oData.parseError)
