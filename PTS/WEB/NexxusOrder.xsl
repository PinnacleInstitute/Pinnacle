                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">GiftAmt</xsl:attribute>
                              <xsl:attribute name="id">GiftAmt</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@giftamt"/></xsl:attribute>
                           </xsl:element>
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">GiftAmtRetail</xsl:attribute>
                              <xsl:attribute name="id">GiftAmtRetail</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@giftamtretail"/></xsl:attribute>
                           </xsl:element>
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">Price1</xsl:attribute>
                              <xsl:attribute name="id">Price1</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@price1"/></xsl:attribute>
                           </xsl:element>
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">Price2</xsl:attribute>
                              <xsl:attribute name="id">Price2</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@price2"/></xsl:attribute>
                           </xsl:element>
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">Price3</xsl:attribute>
                              <xsl:attribute name="id">Price3</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@price3"/></xsl:attribute>
                           </xsl:element>
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">Price4</xsl:attribute>
                              <xsl:attribute name="id">Price4</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@price4"/></xsl:attribute>
                           </xsl:element>
                        ...
                        <xsl:if test="(/DATA/PARAM/@g &lt; 0)">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="font">
                                    <xsl:attribute name="color">red</xsl:attribute>
                                    <xsl:if test="(/DATA/PARAM/@g = -1)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GiftNotAvailable']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@g = -2)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GiftNotValid']"/>
                                    </xsl:if>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                        ...
                        <xsl:if test="(/DATA/PARAM/@mode = 1)">
                           ...
                           <xsl:element name="TR">
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="font">
                                    ...
                                    <xsl:attribute name="name">Existing</xsl:attribute>
                                    <xsl:attribute name="id">Existing</xsl:attribute>
                                    <xsl:attribute name="value">1</xsl:attribute>
                                    <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[ShowContact();]]></xsl:text></xsl:attribute>
                                    <xsl:if test="(/DATA/PARAM/@existing = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Existing']"/>
                                    </xsl:element>
                                 </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                           ...
                           <xsl:element name="TR">
                              <xsl:attribute name="id">ExistingContact</xsl:attribute>
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="align">right</xsl:attribute>
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ExistingMemberID']"/>
                                 <xsl:text>:</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              </xsl:element>
                              <xsl:element name="TD">
                           ...
                           <xsl:element name="TR">
                              <xsl:attribute name="id">NewContact</xsl:attribute>
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">3</xsl:attribute>
                                 <xsl:attribute name="width">750</xsl:attribute>
                                 <xsl:attribute name="align">right</xsl:attribute>
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:element name="TABLE">
                                       ...
                                       <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@g = 0) or (/DATA/PARAM/@giftamt = 50)">
                                             <xsl:element name="TR">
                                                <xsl:element name="TD">
                                                   <xsl:attribute name="colspan">3</xsl:attribute>
                                                   <xsl:attribute name="height">6</xsl:attribute>
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:element name="b">
                                                         ...
                                                         <xsl:if test="(/DATA/PARAM/@price4 != '')">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SpecialPrice']"/>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                            <xsl:value-of select="/DATA/PARAM/@price4" disable-output-escaping="yes"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                      </xsl:element>
                                                      <xsl:element name="BR"/>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_1a']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>

                                          <xsl:if test="(/DATA/PARAM/@g = 0) or (/DATA/PARAM/@giftamt = 25)">
                                             <xsl:element name="TR">
                                                <xsl:element name="TD">
                                                   <xsl:attribute name="colspan">3</xsl:attribute>
                                                   <xsl:attribute name="height">6</xsl:attribute>
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:element name="b">
                                                         ...
                                                         <xsl:if test="(/DATA/PARAM/@price3 != '')">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SpecialPrice']"/>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                            <xsl:value-of select="/DATA/PARAM/@price3" disable-output-escaping="yes"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                      </xsl:element>
                                                      <xsl:element name="BR"/>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_2a']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>

                                          <xsl:if test="(/DATA/PARAM/@g = 0) or (/DATA/PARAM/@giftamt = 10)">
                                             <xsl:element name="TR">
                                                <xsl:element name="TD">
                                                   <xsl:attribute name="colspan">3</xsl:attribute>
                                                   <xsl:attribute name="height">6</xsl:attribute>
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:element name="b">
                                                         ...
                                                         <xsl:if test="(/DATA/PARAM/@price2 != '')">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SpecialPrice']"/>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                            <xsl:value-of select="/DATA/PARAM/@price2" disable-output-escaping="yes"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                      </xsl:element>
                                                      <xsl:element name="BR"/>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_3a']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@g = 0) or (/DATA/PARAM/@giftamt = 10)">
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:element name="b">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_4']"/>
                                                         <xsl:if test="(/DATA/PARAM/@price2 != '')">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                      ...
                                                      <xsl:element name="BR"/>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_4a']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@g = 0) or (/DATA/PARAM/@giftamt = 10)">
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:element name="b">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_5']"/>
                                                         <xsl:if test="(/DATA/PARAM/@price2 != '')">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                      ...
                                                      <xsl:element name="BR"/>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_5a']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>

                                          <xsl:if test="(/DATA/PARAM/@g = 0) or (/DATA/PARAM/@giftamt = 2)">
                                             <xsl:element name="TR">
                                                <xsl:element name="TD">
                                                   <xsl:attribute name="colspan">3</xsl:attribute>
                                                   <xsl:attribute name="height">6</xsl:attribute>
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:element name="b">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_6']"/>
                                                         <xsl:if test="(/DATA/PARAM/@price1 != '')">
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">red</xsl:attribute>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SpecialPrice']"/>
                                                            <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                            <xsl:value-of select="/DATA/PARAM/@price1" disable-output-escaping="yes"/>
                                                            </xsl:element>
                                                         </xsl:if>
                                                      </xsl:element>
                                                      <xsl:element name="BR"/>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_6a']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>
                           ...
                           <xsl:if test="(/DATA/PARAM/@g &gt; 0)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:attribute name="class">PageHeading</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GiftCertificate']"/>
                                       <xsl:value-of select="/DATA/PARAM/@g" disable-output-escaping="yes"/>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='for$']"/>
                                       <xsl:value-of select="/DATA/PARAM/@giftamtretail" disable-output-escaping="yes"/>
                                 </xsl:element>
                              </xsl:element>
                              ...
                              <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:if test="(/DATA/PARAM/@membership = 1)">
                                          ...
                                          <xsl:element name="BR"/>
                                          <xsl:if test="(/DATA/PARAM/@g = 0)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_1b']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 2)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_2']"/>
                                          ...
                                          <xsl:element name="BR"/>
                                          <xsl:if test="(/DATA/PARAM/@g = 0)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_2b']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 3)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_3']"/>
                                          ...
                                          <xsl:element name="BR"/>
                                          <xsl:if test="(/DATA/PARAM/@g = 0)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_3b']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 4)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_4']"/>
                                          ...
                                          <xsl:element name="BR"/>
                                          <xsl:if test="(/DATA/PARAM/@g = 0)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_4b']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 5)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_5']"/>
                                          ...
                                          <xsl:element name="BR"/>
                                          <xsl:if test="(/DATA/PARAM/@g = 0)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_5b']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 6)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_6']"/>
                                          ...
                                          <xsl:element name="BR"/>
                                          <xsl:if test="(/DATA/PARAM/@g = 0)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_6b']"/>
                                          </xsl:if>
                                    </xsl:if>
                                 </xsl:element>
                              </xsl:element>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="INPUT">
                                    ...
                                    <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[ this.disabled = true; doSubmit(2,"");]]></xsl:text></xsl:attribute>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
