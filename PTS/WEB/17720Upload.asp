...
'	.MaxFileBytes = 50 * 1024
	...
	.UpLoadPath = Request.ServerVariables("APPL_PHYSICAL_PATH") & "Seminar\"
...
If Err.number <> 0 Then
	Response.Redirect "17720.asp?FileName=" + FileName + "&UploadError=" & Err.Number & "&UploadErrorDesc=" & Err.Description
Else
	Response.Redirect "17720.asp?FileName=" + FileName + "&Status=1"
End If
