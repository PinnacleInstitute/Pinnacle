...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "15000URL", reqReturnURL
   SetCache "15000DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "15000")
...
fileLanguage = "Language" + "\15000[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\15000[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "15000 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "15000 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
s=s+   "<ITEM label=""mDashboard"" width=""75"" menuwidth=""175"" height=""30"" menuheight=""30"">"
s=s+      "<IMAGE name=""Home.gif"" width=""18"" height=""18""/>"
s=s+      "<LINK name=""JAVA(ShowTab('TabDashboard',1))""/>"
s=s+   "</ITEM>"
      If (reqUser2FA <> 0) Then
s=s+   "<ITEM label=""mSales"" width=""75"" menuwidth=""125"" height=""30"" menuheight=""30"">"
s=s+      "<IMAGE name=""Finance.gif"" width=""18"" height=""18""/>"
s=s+      "<ITEM label=""mPurchases"" width=""100"" menuwidth=""125"">"
s=s+         "<IMAGE name=""Finance.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabSales',1))""/>"
s=s+      "</ITEM>"
s=s+      "<ITEM label=""mRewards"" width=""100"" menuwidth=""125"">"
s=s+         "<IMAGE name=""mNXC.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabSales',2))""/>"
s=s+      "</ITEM>"
s=s+      "<ITEM label=""mPromotions"" width=""125"" menuwidth=""125"">"
s=s+         "<IMAGE name=""Promo.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabSales',3))""/>"
s=s+      "</ITEM>"
s=s+      "<DIVIDER/>"
s=s+      "<ITEM label=""mConsumers"" width=""125"" menuwidth=""125"">"
s=s+         "<IMAGE name=""Prospect.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabSales',4))""/>"
s=s+      "</ITEM>"
s=s+      "<ITEM label=""mSearch"">"
s=s+         "<IMAGE name=""Search.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabSales',5))""/>"
s=s+      "</ITEM>"
s=s+      "<DIVIDER/>"
s=s+      "<ITEM label=""mStatements"">"
s=s+         "<IMAGE name=""Finance.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabSales',6))""/>"
s=s+      "</ITEM>"
s=s+      "<ITEM label=""mBonuses"">"
s=s+         "<IMAGE name=""Finance.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabSales',7))""/>"
s=s+      "</ITEM>"
s=s+      "<DIVIDER/>"
s=s+      "<ITEM label=""mReports"">"
s=s+         "<IMAGE name=""Report.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabSales',8))""/>"
s=s+      "</ITEM>"
s=s+   "</ITEM>"
      End If
      If (reqUser2FA <> 0) Then
s=s+   "<ITEM label=""mAccount"" width=""100"" menuwidth=""150"" height=""30"" menuheight=""30"">"
s=s+      "<IMAGE name=""MyInfo.gif"" width=""18"" height=""18""/>"
s=s+      "<ITEM label=""mProfile"">"
s=s+         "<IMAGE name=""Prospect.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabAccount',1))""/>"
s=s+      "</ITEM>"
s=s+      "<ITEM label=""mBilling"">"
s=s+         "<IMAGE name=""Finance.gif"" width=""18"" height=""18""/>"
...
s=s+   "</ITEM>"
      End If
      If (reqUser2FA <> 0) Then
s=s+   "<ITEM label=""mSetup"" width=""75"" menuwidth=""150"" height=""30"" menuheight=""30"">"
...
s=s+      "</ITEM>"
s=s+      "<DIVIDER/>"
s=s+      "<ITEM label=""mStaff"">"
s=s+         "<IMAGE name=""Prospect.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabSetup',3))""/>"
s=s+      "</ITEM>"
s=s+      "<ITEM label=""mCoin"">"
s=s+         "<IMAGE name=""mCoin.gif"" width=""18"" height=""18""/>"
...
s=s+   "</ITEM>"
      End If
s=s+   "<ITEM label=""mHelp"" width=""100"" menuwidth=""175"" height=""30"" menuheight=""30"">"
...
s=s+         "<LINK name=""15005"" nodata=""true""/>"
s=s+      "</ITEM>"
s=s+   "</ITEM>"
s=s+"</MENU>"
xmlUserMenu = s
...
If oStyle.parseError <> 0 Then
   Response.Write "15000 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "15000 Load file (oData) failed with error code " + CStr(oData.parseError)
