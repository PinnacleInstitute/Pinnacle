...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0811URL", reqReturnURL
   SetCache "0811DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0811")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("0811URL")
      reqReturnData = GetCache("0811DATA")
      SetCache "0811URL", ""
      SetCache "0811DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "0811 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0811 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0811 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0811 Load file (oData) failed with error code " + CStr(oData.parseError)
