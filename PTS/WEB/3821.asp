...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "3821URL", reqReturnURL
   SetCache "3821DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "3821")
...
If oLanguage.parseError <> 0 Then
   Response.Write "3821 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "3821 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "3821 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "3821 Load file (oData) failed with error code " + CStr(oData.parseError)
