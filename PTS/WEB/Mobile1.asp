...
pos = InStr(LCASE(reqSysServerPath), "mobile1")
...
If oLanguage.parseError <> 0 Then
   Response.Write "Mobile1 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "Mobile1 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "Mobile1 Load file (oData) failed with error code " + CStr(oData.parseError)
