...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "2912URL", reqReturnURL
   SetCache "2912DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "2912")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("2912URL")
         reqReturnData = GetCache("2912DATA")
         SetCache "2912URL", ""
         SetCache "2912DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "2912 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "2912 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "2912 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "2912 Load file (oData) failed with error code " + CStr(oData.parseError)
