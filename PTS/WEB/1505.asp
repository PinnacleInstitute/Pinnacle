...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1505URL", reqReturnURL
   SetCache "1505DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1505")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("1505URL")
         reqReturnData = GetCache("1505DATA")
         SetCache "1505URL", ""
         SetCache "1505DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "1505 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1505 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1505 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1505 Load file (oData) failed with error code " + CStr(oData.parseError)
