         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="TR">
               <xsl:element name="TD">
                  ...
                  <xsl:element name="A">
                     <xsl:attribute name="href">https://www.cloudzow.com/10712.asp?MachineID=<xsl:value-of select="/DATA/PARAM/@machineid"/></xsl:attribute>
                  <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ConvertComputerText']"/>
                  </xsl:element>
               </xsl:element>
            </xsl:element>
