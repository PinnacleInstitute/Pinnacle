                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Pay']"/>
                           </xsl:element>
                        </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AddressText']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:attribute name="onchange"><xsl:text disable-output-escaping="yes"><![CDATA[ToggleType();]]></xsl:text></xsl:attribute>
                                 <xsl:variable name="tmp"><xsl:value-of select="/DATA/TXN/PTSBILLING/@commtype"/></xsl:variable>
                                 <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (contains(/DATA/PARAM/@paymentoptions, '1'))">
                                    <xsl:element name="OPTION">
                                       <xsl:attribute name="value">2</xsl:attribute>
                                       <xsl:if test="$tmp='2'"><xsl:attribute name="SELECTED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='DirectDeposit']"/>
                                    </xsl:element>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (contains(/DATA/PARAM/@paymentoptions, '2'))">
                                    <xsl:element name="OPTION">
                                       <xsl:attribute name="value">3</xsl:attribute>
                                       <xsl:if test="$tmp='3'"><xsl:attribute name="SELECTED"/></xsl:if>
                                 ...
                                 <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (contains(/DATA/PARAM/@paymentoptions, '3'))">
                                    <xsl:element name="OPTION">
                                 ...
                                 <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51)">
                                    ...
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoComm']"/>
                                    </xsl:element>
                                 </xsl:if>
                              </xsl:element>
                           </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="SELECT">
                                             ...
                                             <xsl:if test="(contains(/DATA/PARAM/@paymentoptions, '4'))">
                                                <xsl:element name="OPTION">
                                             ...
                                             <xsl:if test="(contains(/DATA/PARAM/@paymentoptions, '5'))">
                                                <xsl:element name="OPTION">
                                             ...
                                             <xsl:if test="(contains(/DATA/PARAM/@paymentoptions, '6'))">
                                                <xsl:element name="OPTION">
                                             ...
                                             <xsl:if test="(contains(/DATA/PARAM/@paymentoptions, '7'))">
                                                <xsl:element name="OPTION">
                                             ...
                                             <xsl:if test="(contains(/DATA/PARAM/@paymentoptions, '8'))">
                                                <xsl:element name="OPTION">
                                             ...
                                             <xsl:if test="(contains(/DATA/PARAM/@paymentoptions, '9'))">
                                                <xsl:element name="OPTION">
                                             ...
                                             <xsl:if test="(contains(/DATA/PARAM/@paymentoptions, '0'))">
                                                <xsl:element name="OPTION">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="((/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51) or (/DATA/SYSTEM/@usergroup = 52)) and (/DATA/PARAM/@wallettype = 11) and (/DATA/PARAM/@walletname = '')">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CreateWallet']"/>
                                    </xsl:attribute>
