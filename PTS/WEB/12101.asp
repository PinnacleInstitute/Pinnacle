...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "12101URL", reqReturnURL
   SetCache "12101DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "12101")
...
Select Case CLng(reqActionCode)
            ...
            Else
               With oMember
                  ...
                  tmpTo = .Email
                     ...
                     tmpSender = "support@zazzed.com"
                     tmpFrom = "support@zazzed.com"
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("12101URL")
      reqReturnData = GetCache("12101DATA")
      SetCache "12101URL", ""
      SetCache "12101DATA", ""
...
fileLanguage = "Language" + "\12101[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\12101[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "12101 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "12101 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "12101 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "12101 Load file (oData) failed with error code " + CStr(oData.parseError)
