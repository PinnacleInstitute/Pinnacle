...
If Err.number <> 0 Then
	Response.Redirect "0620.asp?ProductID=" & tmpProductID & "&CompanyID=" & tmpCompanyID & "&UploadError=" & Err.Number & "&UploadErrorDesc=" & Err.Description
Else
	Response.Redirect "0603.asp?ProductID=" & tmpProductID & "&UploadImageFile=" & NewFileName
End If
