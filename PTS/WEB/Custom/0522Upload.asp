...
'	.FileExtensionList "jpg", "gif", "bmp"
	.UpLoadPath = Request.ServerVariables("APPL_PHYSICAL_PATH") + "Library"
	'.FileName = "NewName"
	.Upload
...
If Err.number <> 0 Then
	Response.Redirect "0522.asp?ProductID=" & GetCache("PRODUCTID") & "&UploadError=" & Err.Number & "&UploadErrorDesc=" & Err.Description
Else
	Response.Redirect "0503.asp?UploadDigitalFile=" & NewFileName
End If
%>