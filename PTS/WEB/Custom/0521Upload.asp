...
If Err.number <> 0 Then
	Response.Redirect "0521.asp?ProductID=" & GetCache("PRODUCTID") & "&UploadError=" & Err.Number & "&UploadErrorDesc=" & Err.Description
Else
	Response.Redirect "0503.asp?UploadThumbnail=" & NewFileName
End If
%>