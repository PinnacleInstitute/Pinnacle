...
If Err.number <> 0 Then
	Response.Redirect "2305.asp?UploadError=" & Err.Number & "&UploadErrorDesc=" & Err.Description & "&CourseID=" & CourseID & "&LessonID=" & LessonID
Else
	Response.Redirect "2305.asp?UploadImageFile=" & NewFileName & "&CourseID=" & CourseID & "&LessonID=" & LessonID
End If
