...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_1022URL", reqReturnURL
   SetCache "m_1022DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_1022")
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_1022 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_1022 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_1022 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_1022 Load file (oData) failed with error code " + CStr(oData.parseError)
