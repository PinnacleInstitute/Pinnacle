                        ...
                        <xsl:if test="(/DATA/TXN/PTSASSESSMENT/@assessmenttype &gt;= 3)">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:element name="A">
                                    <xsl:attribute name="href">m_3414.asp?AssessmentID=<xsl:value-of select="/DATA/PARAM/@assessmentid"/>&amp;MemberAssessID=<xsl:value-of select="/DATA/PARAM/@memberassessid"/>&amp;MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
