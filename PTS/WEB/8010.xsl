                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="A">
                                             ...
                                             <xsl:attribute name="href">8002.asp?ParentID=<xsl:value-of select="/DATA/PARAM/@parentid"/>&amp;ParentType=<xsl:value-of select="/DATA/PARAM/@parenttype"/>&amp;CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:value-of select="@attachname"/>
                                                <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                <xsl:element name="A">
                                                   <xsl:attribute name="href">8003.asp?AttachmentID=<xsl:value-of select="@attachmentid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
