...
pos = InStr(LCASE(reqSysServerPath), "10709")
...
If oStyle.parseError <> 0 Then
   Response.Write "10709 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      End If
      Set oMember = Nothing
      tmpSubject = "Become a CloudZow Affiliate"
...
If oLanguage.parseError <> 0 Then
   Response.Write "10709 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "10709 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "10709 Load file (oData) failed with error code " + CStr(oData.parseError)
