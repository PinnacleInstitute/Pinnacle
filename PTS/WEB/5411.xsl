      ...
      <xsl:element name="BODY">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               win = window.open(url,"MemberTeams","top=100,left=100,height=200,width=320,resizable=yes,status=no,toolbar=no,menubar=no,location=no,titlebar=no,scrollbars=1");
               win.focus();
             }]]></xsl:text>
               </xsl:element>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@line = 2)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Team2Members']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@line = 3)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Team3Members']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@line = 4)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Team4Members']"/>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSDOWNLINES/PTSFINDTYPEIDS/ENUM">
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ChildName']"/>
                                    </xsl:element>
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="onclick">ViewTeams(<xsl:value-of select="@childid"/>)</xsl:attribute>
                                                <xsl:element name="IMG">
