                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                                       ...
                                       <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                   <xsl:element name="b">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_0']"/>
                                                   </xsl:element>
                                                   <xsl:element name="BR"/>
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_0a']"/>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="TR">
                                             <xsl:element name="TD">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="(contains(/DATA/PARAM/@paymentoptions, 'F'))">
                                                   ...
                                                   <xsl:if test="(contains(/DATA/PARAM/@paymentoptions, 'R'))">
                                                         ...
                                                         <xsl:if test="/DATA/TXN/PTSBILLING/@paytype=16">
                                                            <xsl:attribute name="CHECKED"/>
                                                         </xsl:if>
                                                         </xsl:element>
                                                         <xsl:element name="IMG">
                                                            <xsl:attribute name="src">Images/PayType16.gif</xsl:attribute>
                                                            <xsl:attribute name="align">absmiddle</xsl:attribute>
                                                            <xsl:attribute name="border">0</xsl:attribute>
                                                            <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[CheckType(16);]]></xsl:text></xsl:attribute>
                                                         </xsl:element>
                                                   </xsl:if>
                                                </xsl:if>
                        ...
                        <xsl:if test="(/DATA/PARAM/@mode = 5)">
                              ...
                              <xsl:element name="INPUT">
                                 <xsl:attribute name="type">hidden</xsl:attribute>
                                 <xsl:attribute name="name">OptFld1</xsl:attribute>
                                 <xsl:attribute name="id">OptFld1</xsl:attribute>
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@optfld1"/></xsl:attribute>
                              </xsl:element>
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">3</xsl:attribute>
...
**
                                             ...
                                             <xsl:if test="(/DATA/TXN/PTSBILLING/@paytype = 16)">
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NexxusPayments']"/>
                                             </xsl:if>
                                             <xsl:if test="(/DATA/TXN/PTSBILLING/@paytype &lt; 7)">
