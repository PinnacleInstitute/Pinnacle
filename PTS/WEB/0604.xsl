<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Affiliate Back-Office'"/>
               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSLEADCAMPAIGNS/PTSLEADCAMPAIGN">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">1413.asp?LeadCampaignID=<xsl:value-of select="@leadcampaignid"/>&amp;MemberID=<xsl:value-of select="/DATA/TXN/PTSAFFILIATE/@memberid"/>&amp;AffiliateID=<xsl:value-of select="/DATA/PARAM/@affiliateid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">1413.asp?LeadCampaignID=<xsl:value-of select="@leadcampaignid"/>&amp;MemberID=<xsl:value-of select="/DATA/TXN/PTSAFFILIATE/@memberid"/>&amp;AffiliateID=<xsl:value-of select="/DATA/PARAM/@affiliateid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Usage']"/>
                                             </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                                    <xsl:element name="TR">
                        ...
                        <xsl:if test="(/DATA/SYSTEM/@usergroup != 61)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">1</xsl:attribute>
