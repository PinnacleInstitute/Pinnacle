...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "11520URL", reqReturnURL
   SetCache "11520DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "11520")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      reqLanguage = "en"
      If Len(reqFileName) = 0 Then reqFileName = "Drip" + CSTR(reqDripPageID) + "[" + reqLanguage + "]"
...
If oLanguage.parseError <> 0 Then
   Response.Write "11520 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "11520 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "11520 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "11520 Load file (oData) failed with error code " + CStr(oData.parseError)
