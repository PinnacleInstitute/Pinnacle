                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(@rewardtype = 2)">
                                             ...
                                             <xsl:if test="(@status = 2)">
                                                ...
                                                <xsl:variable name="tmp7"><xsl:value-of select="../PTSSTATUSS/ENUM[@id=current()/@status]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp7]"/>
                                                </xsl:element>
                                             </xsl:if>
                                             <xsl:if test="(@status = 3)">
                                                <xsl:variable name="tmp8"><xsl:value-of select="../PTSSTATUSS/ENUM[@id=current()/@status]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp8]"/>
                                             </xsl:if>
                                             <xsl:if test="(@status &gt; 3)">
                                                <xsl:element name="font">
