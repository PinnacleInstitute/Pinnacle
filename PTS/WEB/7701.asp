...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "7701URL", reqReturnURL
   SetCache "7701DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "7701")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      Response.Redirect "8101.asp" & "?CompanyID=" & reqCompanyID
...
If oLanguage.parseError <> 0 Then
   Response.Write "7701 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "7701 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "7701 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "7701 Load file (oData) failed with error code " + CStr(oData.parseError)
