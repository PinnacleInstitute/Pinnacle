...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1107URL", reqReturnURL
   SetCache "1107DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1107")
      ...
      If (reqI = 0) Then
         ...
         Else
            With oHTMLFile
               ...
               .Path = reqSysWebDirectory + "Sections\Course\" & CStr(tmpCourseID)
...
If oLanguage.parseError <> 0 Then
   Response.Write "1107 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1107 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1107 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1107 Load file (oData) failed with error code " + CStr(oData.parseError)
