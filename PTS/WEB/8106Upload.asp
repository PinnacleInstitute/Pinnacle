...
Else
   Dim oFileSys, oFile
	Dim SalesCampaignID, ProspectName, Member, NameFirst, NameLast, Title
   ...
   Set oFileSys = Nothing
	...
	If cnt = 0 Then cnt = -1
	Response.Redirect "8106.asp?MemberID=" & MemberID & "&CompanyID=" & CompanyID & "&Prospects=" & cnt
End If
