...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "17311URL", reqReturnURL
   SetCache "17311DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "17311")
...
If oLanguage.parseError <> 0 Then
   Response.Write "17311 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "17311 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "17311 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "17311 Load file (oData) failed with error code " + CStr(oData.parseError)
