...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0430URL", reqReturnURL
   SetCache "0430DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0430")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionContinue):
      ...
      If (reqEnroll = 1) Then
         ...
         Response.Redirect tmpRedirect + "0101.asp" & "?ReturnURL=" & reqPageURL & "&ReturnData=" & reqPageData
      End If

      If (reqEnroll = 0) Then
            tmpRedirect = "http://" + reqSysServerName + reqSysServerPath
         Response.Redirect tmpRedirect + "0404.asp" & "?MemberID=" & reqMemberID & "&ReturnURL=" & reqPageURL & "&ReturnData=" & reqPageData
      End If
End Select
...
If oLanguage.parseError <> 0 Then
   Response.Write "0430 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0430 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0430 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0430 Load file (oData) failed with error code " + CStr(oData.parseError)
