                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="INPUT">
                              ...
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSRESOURCE/@memberid"/></xsl:attribute>
                           </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:if test="(/DATA/TXN/PTSRESOURCE/@share = 0)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ResourcesUsing']"/>
                                    <xsl:text>:</xsl:text>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 </xsl:if>
                                 <xsl:value-of select="/DATA/TXN/PTSRESOURCE/@memberid"/>
                           </xsl:element>
                        </xsl:element>
