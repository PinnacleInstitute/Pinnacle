               ...
               <xsl:element name="TD">
                  ...
                  <xsl:element name="b">
                     <xsl:element name="A">
                        ...
                        <xsl:attribute name="href"><xsl:value-of select="concat('http://', /DATA/SYSTEM/@servername, /DATA/SYSTEM/@serverpath)"/>1812.asp?N=<xsl:value-of select="/DATA/PARAM/@newsletterid"/>&amp;C=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;M={m-id}&amp;R={id}</xsl:attribute>
                     <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewsLetterArchive']"/>
                     </xsl:element>
                      | 
                     <xsl:element name="A">
                        <xsl:attribute name="href"><xsl:value-of select="concat('http://', /DATA/SYSTEM/@servername, /DATA/SYSTEM/@serverpath)"/>8107.asp?ProspectID={id}&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
