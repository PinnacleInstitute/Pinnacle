...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_0427URL", reqReturnURL
   SetCache "m_0427DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_0427")
...
reqQuestion =  GetInput("Question", reqPageData)
reqAnswer =  GetInput("Answer", reqPageData)
...
xmlParam = xmlParam + " question=" + Chr(34) + CleanXML(reqQuestion) + Chr(34)
xmlParam = xmlParam + " answer=" + Chr(34) + CleanXML(reqAnswer) + Chr(34)
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_0427 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_0427 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_0427 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_0427 Load file (oData) failed with error code " + CStr(oData.parseError)
