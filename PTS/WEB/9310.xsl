<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Page'"/>
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               <xsl:element name="SCRIPT">
                  ...
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function SelectPage(id,nam){ 
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="INPUT">
                              ...
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@path"/></xsl:attribute>
                           </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SelectRSSPage']"/>
                           </xsl:element>
                        </xsl:element>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(@status != 1)">
                                             ...
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="onclick">SelectPage(<xsl:value-of select="@pageid"/>,'<xsl:value-of select="@pagename"/>')</xsl:attribute>
                                             <xsl:element name="b">
