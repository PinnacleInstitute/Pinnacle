...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "3211URL", reqReturnURL
   SetCache "3211DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "3211")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("3211URL")
      reqReturnData = GetCache("3211DATA")
      SetCache "3211URL", ""
      SetCache "3211DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "3211 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "3211 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "3211 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "3211 Load file (oData) failed with error code " + CStr(oData.parseError)
