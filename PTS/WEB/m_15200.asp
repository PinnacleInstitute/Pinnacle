...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_15200URL", reqReturnURL
   SetCache "m_15200DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_15200")
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oReward
            ...
            reqTotal = CCur(.TotalReward(CLng(reqConsumerID), 0))
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_15200 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_15200 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_15200 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_15200 Load file (oData) failed with error code " + CStr(oData.parseError)
