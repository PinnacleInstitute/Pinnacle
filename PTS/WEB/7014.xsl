                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/PARAM/@template = 1)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MemberSuccessTracks']"/>
                              </xsl:if>
                              <xsl:if test="(/DATA/PARAM/@template = 2)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ProspectSuccessTracks']"/>
                              </xsl:if>
                              <xsl:if test="(contains(/DATA/SYSTEM/@useroptions, 'U'))">
                                    ...
                                    <xsl:element name="A">
                                       ...
                                       <xsl:attribute name="href">Tutorial.asp?Lesson=33&amp;contentpage=3&amp;popup=1</xsl:attribute>
                                       <xsl:element name="IMG">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="b">
                                 ...
                                 <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                 <xsl:element name="A">
                                    <xsl:attribute name="href">7002.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;Template=<xsl:value-of select="/DATA/PARAM/@template"/>&amp;ContentPage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                              ...
                              <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23)">
                                    ...
                                    <xsl:element name="A">
                                       ...
                                       <xsl:attribute name="href">70Import.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/></xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/PARAM/@template = 1)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MemberSuccessTrackText']"/>
                              </xsl:if>
                              <xsl:if test="(/DATA/PARAM/@template = 2)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ProspectSuccessTrackText']"/>
                              </xsl:if>
                           </xsl:element>
                        </xsl:element>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:element name="A">
                                                ...
                                                <xsl:element name="IMG">
                                                   ...
                                                   <xsl:attribute name="align">absmiddle</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                   <xsl:attribute name="alt"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='EditTrack']"/></xsl:attribute>
                                                   <xsl:attribute name="title"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='EditTrack']"/></xsl:attribute>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">7004.asp?GoalID=<xsl:value-of select="@goalid"/>&amp;ContentPage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                <xsl:element name="IMG">
                                                   <xsl:attribute name="src">Images/GoalEdit.gif</xsl:attribute>
                                                   <xsl:attribute name="align">absmiddle</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                   <xsl:attribute name="alt"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='EditGoal']"/></xsl:attribute>
                                                   <xsl:attribute name="title"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='EditGoal']"/></xsl:attribute>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="A">
                                                <xsl:attribute name="onclick">w=window.open(this.href,"Preview","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                <xsl:attribute name="href">7012.asp?GoalID=<xsl:value-of select="@goalid"/></xsl:attribute>
                                                <xsl:element name="IMG">
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23)">
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">ExportGoal.asp?GoalID=<xsl:value-of select="@goalid"/></xsl:attribute>
                                                   <xsl:element name="IMG">
