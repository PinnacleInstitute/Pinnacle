...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "PlayProgressURL", reqReturnURL
   SetCache "PlayProgressDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "playprogress")
