...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "9320URL", reqReturnURL
   SetCache "9320DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "9320")
      ...
      If (reqStatus = 0) Then
         ...
         Else
            With oPage
               ...
               tmpLang = .Language
               If Len(reqFileName) = 0 Then reqFileName = CSTR(reqPageID) + "[" + tmpLang + "]"
...
If oLanguage.parseError <> 0 Then
   Response.Write "9320 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "9320 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "9320 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "9320 Load file (oData) failed with error code " + CStr(oData.parseError)
