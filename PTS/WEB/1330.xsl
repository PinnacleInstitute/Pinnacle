                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="(/DATA/TXN/PTSSESSION/@passinggrade &gt; 0)">
                                                      <xsl:element name="A">
                                                         ...
                                                         <xsl:attribute name="href">1321.asp?SessionID=<xsl:value-of select="/DATA/TXN/PTSSESSION/@sessionid"/></xsl:attribute>
                                                         <xsl:element name="IMG">
                                                ...
                                                <xsl:if test="(contains(/DATA/SYSTEM/@useroptions, 'U'))">
                                                      <xsl:element name="A">
                                                         ...
                                                         <xsl:attribute name="href">Tutorial.asp?Lesson=13&amp;contentpage=3&amp;popup=1</xsl:attribute>
                                                         <xsl:element name="IMG">
                                                   ...
                                                   <xsl:if test="(not(/DATA/TXN/PTSSESSION/@totalrating))">
                                                      <xsl:element name="IMG">
                                                         <xsl:attribute name="src">Images/star0.gif</xsl:attribute>
                                                         <xsl:attribute name="border">0</xsl:attribute>
                                                      </xsl:element>
                                                   </xsl:if>
                                                <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23)">
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="href">1313.asp?CourseID=<xsl:value-of select="/DATA/TXN/PTSCOURSE/@courseid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                         <xsl:element name="IMG">
                              ...
                              <xsl:if test="(/DATA/PARAM/@sessionid != 0)">
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:attribute name="align">left</xsl:attribute>
                                       <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ClickStudent']"/>
                                          <xsl:text>:</xsl:text>
                                          <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                          <xsl:element name="A">
                                             <xsl:attribute name="href">1305.asp?SessionID=<xsl:value-of select="/DATA/PARAM/@sessionid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                          <xsl:element name="b">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:element name="TABLE">
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             <xsl:attribute name="align">left</xsl:attribute>
                                             <xsl:attribute name="width">57%</xsl:attribute>
                                             <xsl:attribute name="class">ColumnTitle</xsl:attribute>
                                             <xsl:attribute name="valign">Bottom</xsl:attribute>
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="class">ColumnTitle</xsl:attribute>
                                             <xsl:attribute name="valign">Bottom</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Final']"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="align">right</xsl:attribute>
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                   <xsl:if test="(@ispassquiz = 1)">
                                                      ...
                                                      <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                                      <xsl:element name="A">
                                                         <xsl:attribute name="href">2430.asp?LessonID=<xsl:value-of select="@lessonid"/>&amp;SessionID=<xsl:value-of select="/DATA/PARAM/@sessionid"/>&amp;CourseID=<xsl:value-of select="/DATA/PARAM/@courseid"/>&amp;MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;Lessons=<xsl:value-of select="/DATA/PARAM/@lessons"/>&amp;ContentPage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;Popup=<xsl:value-of select="/DATA/PARAM/@popup"/></xsl:attribute>
                                                         <xsl:element name="IMG">
                              ...
                              <xsl:if test="(/DATA/PARAM/@sessionid &gt; 0)">
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                       <xsl:if test="(/DATA/TXN/PTSSESSION/@status &gt;= 5) and ((/DATA/TXN/PTSCOURSE/@nocertificate = 0) or (/DATA/SYSTEM/@usergroup != 41))">
                                          <xsl:element name="INPUT">
                                             <xsl:attribute name="type">button</xsl:attribute>
                                             <xsl:attribute name="value">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='PrintCertificate']"/>
                                             </xsl:attribute>
