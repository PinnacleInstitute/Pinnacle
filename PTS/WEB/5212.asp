...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "5212URL", reqReturnURL
   SetCache "5212DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "5212")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      If (reqSysUserGroup = 99) And (reqCompanyID <> 0) Then
      ...
      Else
         With oSalesOrders
            ...
            .ListPromotion CLng(reqPromotionID)
            ...
            xmlSalesOrders = xmlSalesOrders + .XML()
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
         End With
      End If
...
If oLanguage.parseError <> 0 Then
   Response.Write "5212 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "5212 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "5212 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "5212 Load file (oData) failed with error code " + CStr(oData.parseError)
