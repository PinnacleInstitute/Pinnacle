                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="IMG">
                                 ...
                                 <xsl:attribute name="src">Images/msg.gif</xsl:attribute>
                              ...
                              <xsl:if test="(@modifyid &gt; 0) and (@parentid &gt; 0)">
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="A">
                                          <xsl:attribute name="href">8303.asp?BoardUserID=<xsl:value-of select="@modifyid"/>&amp;contentpage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                       <xsl:element name="i">
   ...
   <xsl:template match="/">
      ...
      <xsl:element name="BODY">
         ...
         <xsl:element name="SCRIPT">
            ...
            nodeImg.src = "Images/msg.gif";

            var nodeOpenImg = new Image();
            nodeOpenImg.src = "Images/msg.gif";
                                 ...
                                 <xsl:attribute name="width">750</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MessageTreeText']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">125</xsl:attribute>
                                          <xsl:attribute name="align">right</xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SPAN">
                                 ...
                                 <xsl:attribute name="style">WIDTH: 750; HEIGHT: 300; BORDER: none; OVERFLOW: visible;</xsl:attribute>
                                 <xsl:call-template name="TreeNode">
