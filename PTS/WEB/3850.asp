...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "3850URL", reqReturnURL
   SetCache "3850DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "3850")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      Response.Redirect "3803.asp" & "?CompanyID=" & CompanyID & "&ReturnURL=" & GetCache("3850URL")
End Select
...
If oLanguage.parseError <> 0 Then
   Response.Write "3850 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "3850 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "3850 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "3850 Load file (oData) failed with error code " + CStr(oData.parseError)
