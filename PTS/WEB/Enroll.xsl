               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                           ...
                           <xsl:if test="(/DATA/PARAM/@getmemberid != 0)">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:attribute name="class">PageHeading</xsl:attribute>
                                       <xsl:if test="(/DATA/PARAM/@companyid != 8)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GetMemberID']"/>
                                       </xsl:if>
                                       <xsl:if test="(/DATA/PARAM/@companyid = 8)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GetMemberID8']"/>
                                       </xsl:if>
                                 </xsl:element>
                              </xsl:element>
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                    ...
                                    <xsl:element name="A">
                                       ...
                                       <xsl:attribute name="onclick">alert('<xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CompanyNameTip']"/>');</xsl:attribute>
                                       <xsl:element name="IMG">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:element name="font">
                                       ...
                                       <xsl:attribute name="color">#cc003a</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership7_Try']"/>
                                    </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                                       ...
                                       <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="align">left</xsl:attribute>
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership8_1']"/>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="align">left</xsl:attribute>
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership8_2']"/>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="align">left</xsl:attribute>
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership8_3']"/>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="align">left</xsl:attribute>
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership8_4']"/>
                                             </xsl:element>
                                          </xsl:element>
                                       ...
                                       <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="IMG">
                                                   <xsl:attribute name="src">Images/Company/14/Enroll-HDR.gif</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="IMG">
                                                   <xsl:attribute name="src">Images/Company/14/Enroll2.gif</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="IMG">
                                                   <xsl:attribute name="src">Images/Company/14/Enroll3.gif</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="IMG">
                                                   <xsl:attribute name="src">Images/Company/14/Enroll1.gif</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="IMG">
                                                   <xsl:attribute name="src">Images/Company/14/Enroll-FTR.gif</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                       ...
                                       <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="align">left</xsl:attribute>
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership15_1']"/>
                                             </xsl:element>
                                          </xsl:element>
                                       ...
                                       <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="align">left</xsl:attribute>
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership16_1']"/>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@groupid != 0)">
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="align">left</xsl:attribute>
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership16_2']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>
                                       ...
                                       <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">blue</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership17_Text']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="/DATA/PARAM/@membership=7">
                                                   <xsl:attribute name="CHECKED"/>
                                                </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="b">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership17_7']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="b">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership17_5']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="b">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership17_4']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="b">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership17_3']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="b">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership17_1']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                       ...
                                       <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">red</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership18_Text']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                       ...
                                       <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="b">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership20_1']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="align">left</xsl:attribute>
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                   <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                                      <xsl:element name="b">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership20_2']"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                                   <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                                      <xsl:element name="b">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership20_2i']"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                   <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                                      <xsl:element name="b">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership20_3']"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                                   <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                                      <xsl:element name="b">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership20_3i']"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                   <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                                      <xsl:element name="b">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership20_4']"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                                   <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                                      <xsl:element name="b">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership20_4i']"/>
                                                      </xsl:element>
                                                   </xsl:if>
                                             </xsl:element>
                                          </xsl:element>
                                       ...
                                       <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">blue</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_Text']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="b">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_1']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="b">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_2']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:element name="b">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_3']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:element>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:attribute name="class">prompt</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership21_Text2']"/>
                                             </xsl:element>
                                          </xsl:element>
                        ...
                        <xsl:if test="(/DATA/PARAM/@mode = 4)">
                           ...
                           <xsl:if test="(/DATA/PARAM/@companyid = 9) and (/DATA/PARAM/@membership = 5)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">3</xsl:attribute>
                                    <xsl:attribute name="width">750</xsl:attribute>
                           ...
                           <xsl:if test="(/DATA/PARAM/@companyid = 11) and (/DATA/PARAM/@membership = 8)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">3</xsl:attribute>
                                    <xsl:attribute name="width">750</xsl:attribute>
                           ...
                           <xsl:if test="(/DATA/PARAM/@companyid = 16) and (/DATA/PARAM/@membership = 2)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">3</xsl:attribute>
                                    <xsl:attribute name="width">750</xsl:attribute>
                                    ...
                                    <xsl:element name="font">
                                       <xsl:attribute name="color">red</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoPaymentText3']"/>
                                    </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                              ...
                              <xsl:if test="(/DATA/PARAM/@membership = 1)">
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="font">
                                          <xsl:attribute name="color">blue</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GCRPaymentText10']"/>
                                       </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                                 <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="font">
                                          <xsl:attribute name="color">blue</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GCRPaymentText11']"/>
                                       </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="font">
                                          <xsl:attribute name="color">blue</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GCRPaymentText12']"/>
                                       </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="font">
                                          <xsl:attribute name="color">blue</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GCRPaymentText13']"/>
                                       </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="font">
                                          <xsl:attribute name="color">blue</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GCRPaymentText14']"/>
                                       </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                              ...
                              <xsl:if test="(/DATA/PARAM/@membership != 1)">
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="font">
                                          <xsl:attribute name="color">blue</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GCRPaymentText20']"/>
                                       </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                                 <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="font">
                                          <xsl:attribute name="color">blue</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GCRPaymentText21']"/>
                                       </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="font">
                                          <xsl:attribute name="color">blue</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='GCRPaymentText22']"/>
                                       </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                           ...
                           <xsl:if test="(/DATA/PARAM/@companyid = 14)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:element name="font">
                                       <xsl:attribute name="color">red</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CashPaymentText']"/>
                                    </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                           ...
                           <xsl:if test="(/DATA/PARAM/@nobill = 0) and (/DATA/PARAM/@companyid != 17)">
                              <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="(contains(/DATA/PARAM/@paymentoptions, 'F'))">
                                                   ...
                                                   <xsl:if test="(contains(/DATA/PARAM/@paymentoptions, 'Q'))">
                                                         ...
                                                         <xsl:if test="/DATA/TXN/PTSBILLING/@paytype=15">
                                                            <xsl:attribute name="CHECKED"/>
                                                         </xsl:if>
                                                         </xsl:element>
                                                         <xsl:element name="IMG">
                                                            <xsl:attribute name="src">Images/PayType15.gif</xsl:attribute>
                                                            <xsl:attribute name="align">absmiddle</xsl:attribute>
                                                            <xsl:attribute name="border">0</xsl:attribute>
                                                            <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[CheckType(15);]]></xsl:text></xsl:attribute>
                                                         </xsl:element>
                                                   </xsl:if>
                                                </xsl:if>
                              ...
                              <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:if test="(/DATA/PARAM/@companyid != 15) and (/DATA/PARAM/@companyid != 17)">
                                    ...
                                    <xsl:if test="(/DATA/PARAM/@companyid = 17)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IsAgree2_17']"/>
                                    </xsl:if>
                                    </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                        ...
                        <xsl:if test="(/DATA/PARAM/@mode = 5)">
                              ...
                              <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:if test="(/DATA/PARAM/@nobill = 0)">
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@membership = 2)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership7_2']"/>
                                          </xsl:if>
                                          <xsl:if test="(/DATA/PARAM/@membership = 3)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership7_3']"/>
                                          </xsl:if>
                           ...
                           <xsl:if test="(/DATA/PARAM/@companyid = 11)">
                              <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="class">PageHeading</xsl:attribute>
                                    <xsl:if test="(/DATA/PARAM/@membership = 1)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_1']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 2)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_2']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 3)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_3']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 2) or (/DATA/PARAM/@membership = 3)">
                                       <xsl:if test="(/DATA/PARAM/@orderoption != 0)">
                                             ...
                                             <xsl:element name="font">
                                                <xsl:attribute name="color">blue</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_2a']"/>
                                             </xsl:element>
                                       </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 4)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_4']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 5)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_5']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 6)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_6']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 7)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_7']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 5) or (/DATA/PARAM/@membership = 6) or (/DATA/PARAM/@membership = 7)">
                                       <xsl:if test="(/DATA/PARAM/@orderoption != 0)">
                                             <xsl:element name="BR"/>
                                             <xsl:element name="font">
                                                <xsl:attribute name="color">blue</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_5a']"/>
                                             </xsl:element>
                                       </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 8)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_8']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 9)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_9']"/>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@billday != 0)">
                                          <xsl:element name="font">
                                             <xsl:attribute name="color">purple</xsl:attribute>
                                             <xsl:element name="BR"/><xsl:element name="BR"/>
                                             <xsl:if test="(/DATA/PARAM/@billday = 1)">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='BillDay1']"/>
                                             </xsl:if>
                                             <xsl:if test="(/DATA/PARAM/@billday = 15)">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='BillDay15']"/>
                                             </xsl:if>
                                          </xsl:element>
                                    </xsl:if>
                              ...
                              <xsl:if test="(/DATA/TXN/PTSBILLING/@paytype = 7)">
                                 ...
                                 <xsl:element name="TR">
                                    ...
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="font">
                                          <xsl:attribute name="color">red</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership11_Cash']"/>
                                       </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:if>
                           ...
                           <xsl:if test="(/DATA/PARAM/@companyid = 14)">
                              <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:if test="(/DATA/PARAM/@membership = 1)">
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_1']"/>
                                          </xsl:if>
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_1i']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 2)">
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_2']"/>
                                          </xsl:if>
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_2i']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 3)">
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_3']"/>
                                          </xsl:if>
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_3i']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 4)">
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_4']"/>
                                          </xsl:if>
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_4i']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 5)">
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_5']"/>
                                          </xsl:if>
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_5i']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 6)">
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_6']"/>
                                          </xsl:if>
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_6i']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 7)">
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_7']"/>
                                          </xsl:if>
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_7i']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 8)">
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_8']"/>
                                          </xsl:if>
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_8i']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 9)">
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_9']"/>
                                          </xsl:if>
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_9i']"/>
                                          </xsl:if>
                                    </xsl:if>
                                    <xsl:if test="(/DATA/PARAM/@membership = 10)">
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_10']"/>
                                          </xsl:if>
                                          <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership14_10i']"/>
                                          </xsl:if>
                                    </xsl:if>
                                 </xsl:element>
                              </xsl:element>
                              ...
                              <xsl:if test="(/DATA/PARAM/@membership &gt;= 4)">
                                 ...
                                 <xsl:element name="TR">
                                    ...
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="font">
                                          <xsl:attribute name="color">red</xsl:attribute>
                                       <xsl:if test="(/DATA/PARAM/@orderoption = 1)">
                                             <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption14_1']"/>
                                             </xsl:if>
                                             <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption14_1i']"/>
                                             </xsl:if>
                                       </xsl:if>
                                       <xsl:if test="(/DATA/PARAM/@orderoption = 2)">
                                             <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid = 224)">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption14_2']"/>
                                             </xsl:if>
                                             <xsl:if test="(/DATA/TXN/PTSADDRESS/@countryid != 224)">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OrderOption14_2i']"/>
                                             </xsl:if>
                                       </xsl:if>
                                       </xsl:element>
                                    </xsl:element>
                              ...
                              <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="class">PageHeading</xsl:attribute>
                                       ...
                                       <xsl:if test="(/DATA/PARAM/@membership = 2)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership17_2']"/>
                                       </xsl:if>
                                       <xsl:if test="(/DATA/PARAM/@membership = 3)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership17_3']"/>
                                       </xsl:if>
                                       ...
                                       <xsl:if test="(/DATA/PARAM/@membership = 6)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership17_6']"/>
                                       </xsl:if>
                                       <xsl:if test="(/DATA/PARAM/@membership = 7)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership17_7']"/>
                                       </xsl:if>
                                       <xsl:if test="(/DATA/PARAM/@membership = 8)">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership17_8']"/>
                                       </xsl:if>
                                 </xsl:element>
                              </xsl:element>
                           ...
                           <xsl:element name="SCRIPT">
                              <xsl:attribute name="language">JavaScript</xsl:attribute>
                              <xsl:text disable-output-escaping="yes"><![CDATA[ function RefreshCaptchaImage(valImageId){ 
                  ...
                  if (objImage != undefined) {
                     ...
                     objImage.src = objImage.src.split('?')[0] + '?x=' + now.toUTCString();
                           ...
                           <xsl:if test="(/DATA/PARAM/@iscaptcha != 0)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">3</xsl:attribute>
                                    <xsl:attribute name="height">18</xsl:attribute>
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:element name="IMG">
                                       <xsl:attribute name="src">include/captcha.asp</xsl:attribute>
                                       <xsl:attribute name="id">imgCaptcha</xsl:attribute>
                                       <xsl:attribute name="align">absmiddle</xsl:attribute>
                                       <xsl:attribute name="border">0</xsl:attribute>
                                    </xsl:element>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    <xsl:element name="INPUT">
                                       ...
                                       <xsl:attribute name="value">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewCaptcha']"/>
                                       </xsl:attribute>
                                       <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[RefreshCaptchaImage('imgCaptcha');]]></xsl:text></xsl:attribute>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="align">center</xsl:attribute>
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='WriteCaptcha']"/>
                                    <xsl:text>:</xsl:text>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    <xsl:element name="INPUT">
                                    ...
                                    <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@captcha"/></xsl:attribute>
