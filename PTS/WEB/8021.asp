...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8021URL", reqReturnURL
   SetCache "8021DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8021")
...
reqUploadURL =  GetInput("UploadURL", reqPageData)
...
reqUploadURL = reqUploadURL + "&RetURL=" + "http://" + reqSysServerName + reqSysServerPath + "UploadResult.asp"
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("8021URL")
      reqReturnData = GetCache("8021DATA")
      SetCache "8021URL", ""
      SetCache "8021DATA", ""
...
xmlParam = xmlParam + " uploadurl=" + Chr(34) + CleanXML(reqUploadURL) + Chr(34)
...
If oLanguage.parseError <> 0 Then
   Response.Write "8021 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8021 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8021 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8021 Load file (oData) failed with error code " + CStr(oData.parseError)
