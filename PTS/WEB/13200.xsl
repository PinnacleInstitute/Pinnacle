<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'R180 Processing'"/>
                     ...
                     <xsl:element name="TABLE">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@process = 50)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MemberAds']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@process = 51)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AdvertiserAds']"/>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>

                        <xsl:if test="(/DATA/PARAM/@process = 12) or (/DATA/PARAM/@process = 39) or (/DATA/PARAM/@process = 47) or (/DATA/PARAM/@process = 50) or (/DATA/PARAM/@process = 51)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">1</xsl:attribute>
                                 <xsl:attribute name="height">12</xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@result != '')">
                           ...
                           <xsl:if test="(/DATA/PARAM/@process = 30)">
                              ...
                              <xsl:element name="TR">
                                 <xsl:for-each select="/DATA/TXN/PTSR180S/PTSR180">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">800</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
