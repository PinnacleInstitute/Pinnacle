<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Trainer Assessments'"/>
                     ...
                     <xsl:element name="TABLE">
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="A">
                                             ...
                                             <xsl:attribute name="href">3102.asp?TrainerID=<xsl:value-of select="/DATA/PARAM/@trainerid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewAssessment']"/>
                                          </xsl:element>
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23)">
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="href">31Import.asp?TrainerID=<xsl:value-of select="/DATA/PARAM/@trainerid"/></xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TrainerAssessmentsText']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">3103.asp?AssessmentID=<xsl:value-of select="@assessmentid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23)">
                                                ...
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">ExportAssessment.asp?AssessmentID=<xsl:value-of select="@assessmentid"/></xsl:attribute>
                                                   <xsl:element name="IMG">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:choose>
                                             <xsl:when test="(@istrial='0')">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IsTrialFalse']"/>
                                             </xsl:when>
                                             <xsl:otherwise>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IsTrialTrue']"/>
                                             </xsl:otherwise>
                                          </xsl:choose>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="b">
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">3211.asp?AssessmentID=<xsl:value-of select="@assessmentid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                <xsl:element name="IMG">
