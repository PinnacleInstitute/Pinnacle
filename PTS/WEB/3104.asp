...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "3104URL", reqReturnURL
   SetCache "3104DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "3104")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("3104URL")
         reqReturnData = GetCache("3104DATA")
         SetCache "3104URL", ""
         SetCache "3104DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "3104 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "3104 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "3104 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "3104 Load file (oData) failed with error code " + CStr(oData.parseError)
