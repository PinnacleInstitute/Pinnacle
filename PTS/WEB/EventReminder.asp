...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "EventReminderURL", reqReturnURL
   SetCache "EventReminderDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "eventreminder")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oEvents
            .ListReminder CDate(reqRemindDate)
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
