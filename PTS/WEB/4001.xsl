                                 ...
                                 <xsl:attribute name="width">600</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FindSurvey']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">300</xsl:attribute>
                                          <xsl:attribute name="align">right</xsl:attribute>
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@orgid &gt; 0)">
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="href">4002.asp?contentpage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;OrgID=<xsl:value-of select="/DATA/PARAM/@orgid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewSurvey']"/>
                                             </xsl:element>
                                          </xsl:if>
                                       </xsl:element>
                                    </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSSURVEYS/PTSFINDTYPEIDS/ENUM">
                                    ...
                                    <xsl:for-each select="/DATA/TXN/PTSSURVEYS/PTSSURVEY">
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">4003.asp?SurveyID=<xsl:value-of select="@surveyid"/>&amp;contentpage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:element name="b">
                                                <xsl:element name="A">
                                                   <xsl:attribute name="href">4111.asp?contentpage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;SurveyID=<xsl:value-of select="@surveyid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:element name="b">
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">4160.asp?SurveyID=<xsl:value-of select="@surveyid"/></xsl:attribute>
