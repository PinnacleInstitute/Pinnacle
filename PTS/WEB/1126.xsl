<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Program Courses'"/>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:element name="b">
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='RequiredCredits']"/>
                              <xsl:text>:</xsl:text>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:value-of select="/DATA/TXN/PTSORG/@credits"/>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:if test="(@status = 2)">
                                       ...
                                       <xsl:if test="(@credit &gt; 0)">
                                          ...
                                          (<xsl:value-of select="@credit"/> credits)
                                          </xsl:element>
                                       </xsl:if>
