<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Member Payouts'"/>
                        ...
                        <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51) or (/DATA/SYSTEM/@usergroup = 52)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="A">
                                    <xsl:attribute name="onclick">w=window.open(this.href,"newpayout","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                    <xsl:attribute name="href">0802.asp?OwnerType=<xsl:value-of select="/DATA/PARAM/@ownertype"/>&amp;OwnerID=<xsl:value-of select="/DATA/PARAM/@ownerid"/>&amp;ContentPage=3&amp;PopUp=1</xsl:attribute>
                                 <xsl:element name="b">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSPAYOUTS/PTSPAYOUT">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(@show = 0)">
                                                <xsl:if test="(@paytype &lt;= 3) or (@paytype = 6)">
                                                   <xsl:value-of select="@amount"/>
                                                </xsl:if>
                                                <xsl:if test="(@paytype = 4)">
                                                   <xsl:element name="font">
                                                      <xsl:attribute name="color">green</xsl:attribute>
                                                   <xsl:value-of select="@amount"/>
                                                   </xsl:element>
                                                </xsl:if>
                                                <xsl:if test="(@paytype = 5)">
                                                   <xsl:element name="font">
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51)">
                                                ...
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">0803.asp?PayoutID=<xsl:value-of select="@payoutid"/>&amp;ContentPage=3&amp;PopUp=1</xsl:attribute>
                                                   <xsl:element name="IMG">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:if test="(@status = 3)">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Force']"/>
                                             </xsl:if>
                                       ...
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">left</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:variable name="tmp7"><xsl:value-of select="../PTSPAYTYPES/ENUM[@id=current()/@paytype]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp7]"/>
                                       </xsl:element>
                                    </xsl:element>
                                    <xsl:if test="(@notes != '')">
                                       <xsl:element name="TR">
