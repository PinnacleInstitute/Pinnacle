<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         ...
         <xsl:with-param name="ogtitle"><xsl:value-of select="/DATA/PARAM/@ogtitle"/></xsl:with-param>
         <xsl:with-param name="ogimage"><xsl:value-of select="/DATA/PARAM/@ogimage"/></xsl:with-param>
      </xsl:call-template>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="DIV">
                                             ...
                                             <xsl:attribute name="style">width:878; padding:10; float:left; align:left</xsl:attribute>
                                             <xsl:element name="font">
                                             ...
                                             <xsl:value-of select="/DATA/PARAM/@activedate" disable-output-escaping="yes"/>
                                             </xsl:element>
                                             <xsl:element name="BR"/>
                                             <xsl:element name="font">
                                          ...
                                          <xsl:element name="DIV">
                                             <xsl:attribute name="id">title</xsl:attribute>
                                             <xsl:attribute name="style">width:630; padding:10; float:left; align:left</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSNEWS/@image != '')">
                                                <xsl:element name="IMG">
                                                   <xsl:attribute name="src">Images/News\<xsl:value-of select="/DATA/PARAM/@companyid"/>/<xsl:value-of select="/DATA/TXN/PTSNEWS/@image"/></xsl:attribute>
                                          ...
                                          <xsl:element name="DIV">
                                             ...
                                             <xsl:attribute name="style">width:178; padding:10; float:right;</xsl:attribute>
                                             <xsl:element name="font">
                                                <xsl:attribute name="color">gray</xsl:attribute>
                                             <xsl:if test="(/DATA/TXN/PTSNEWS/@userrole != 0)">
                                                   <xsl:if test="(/DATA/TXN/PTSNEWS/@userrole = 1)">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AuthoredBy']"/>
                                                      <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                      <xsl:value-of select="/DATA/TXN/PTSNEWS/@username"/>
                                                      <xsl:element name="BR"/><xsl:element name="BR"/>
                                                   </xsl:if>
                                                   <xsl:if test="(/DATA/TXN/PTSNEWS/@userrole = 2)">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='PublishedBy']"/>
                                                      <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                      <xsl:value-of select="/DATA/TXN/PTSNEWS/@username"/>
                                                      <xsl:element name="BR"/><xsl:element name="BR"/>
                                                   </xsl:if>
                                                <xsl:if test="(/DATA/PARAM/@avatar != '')">
                                                      <xsl:element name="IMG">
                                                         <xsl:attribute name="src">Images/Member/<xsl:value-of select="/DATA/PARAM/@avatar"/></xsl:attribute>
                                                ...
                                                <xsl:text>:</xsl:text>
                                                <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                <xsl:value-of select="/DATA/TXN/PTSNEWS/@newstopicname"/>
                                                <xsl:element name="BR"/><xsl:element name="BR"/>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TaggedUnder']"/>
                                                <xsl:text>:</xsl:text>
                                                <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                                <xsl:value-of select="/DATA/TXN/PTSNEWS/@tags"/>
                                                <xsl:element name="BR"/><xsl:element name="BR"/>
                                             </xsl:element>
                                          </xsl:element>
                                          <xsl:element name="DIV">
                                             <xsl:attribute name="id">description</xsl:attribute>
                                             <xsl:attribute name="style">width:878; padding:10; float:left;</xsl:attribute>
                                          ...
                                          <xsl:element name="DIV">
                                             ...
                                             <xsl:attribute name="style">width:878; padding:10; float:left;</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSADDTHIS/DATA/comment()" disable-output-escaping="yes"/>
                                          </xsl:element>
                                             <xsl:element name="BR"/>
                                          <xsl:element name="DIV">
                                             <xsl:attribute name="id">comments</xsl:attribute>
                                             <xsl:attribute name="style">width:878; height:5000; padding:10; float:left;</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSDISQUS/DATA/comment()" disable-output-escaping="yes"/>
                                          </xsl:element>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">300</xsl:attribute>
