<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Email Lead Page'"/>
      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CustomEmailNewProspects']"/>
                           </xsl:element>
                        </xsl:element>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">prompt</xsl:attribute>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@prospectid = 0)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='EmailCustomNewProspectText']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@prospectid != 0)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='EmailCustomProspectText']"/>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>
               ...
               if( p != 0 ) {
                  url = "lp.asp?p=" + p + "&m=" + Prospect.MemberID.value + "&preview=1"
                  ...
                  win.focus();
                        ...
                        <xsl:if test="(/DATA/PARAM/@prospectid = 0)">
                                 ...
                                 <xsl:element name="TABLE">
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@namefirst"/></xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@namelast"/></xsl:attribute>
                                          <xsl:attribute name="maxlength">30</xsl:attribute>
                                          <xsl:attribute name="size">25</xsl:attribute>
                                          </xsl:element>
                                          <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                           ...
                           <xsl:element name="TR">
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@phone"/></xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="align">center</xsl:attribute>
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:if test="(/DATA/SYSTEM/@userstatus = 1) and (/DATA/PARAM/@prospectid = 0)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">button</xsl:attribute>
                                    <xsl:attribute name="value">
