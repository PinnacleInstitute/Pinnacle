<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'My Assessment'"/>
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/SYSTEM/@usergroup != 41) or (contains(/DATA/SYSTEM/@useroptions, 's'))">
                                 <xsl:element name="A">
                                    ...
                                    <xsl:attribute name="href">9202.asp?EntityID=34&amp;ItemID=<xsl:value-of select="/DATA/TXN/PTSMEMBERASSESS/@memberassessid"/>&amp;Name=<xsl:value-of select="translate(/DATA/TXN/PTSASSESSMENT/@assessmentname,'&amp;',' ')"/>&amp;URL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/></xsl:attribute>
                                    <xsl:element name="IMG">
                        ...
                        <xsl:if test="(/DATA/TXN/PTSASSESSMENT/@assessmenttype = 2)">
                           <xsl:if test="(/DATA/TXN/PTSMEMBERASSESS/@externalid != '')">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">1</xsl:attribute>
                           ...
                           <xsl:if test="(not(/DATA/TXN/PTSMEMBERASSESS/@externalid))">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">1</xsl:attribute>
                                    <xsl:attribute name="height">12</xsl:attribute>
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:element name="A">
                                       <xsl:attribute name="onclick">w=window.open(this.href,"ExternalAssessment","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                       <xsl:attribute name="href"><xsl:value-of select="/DATA/PARAM/@externalurl"/></xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CompleteAssessment']"/>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
                        ...
                        <xsl:if test="(/DATA/TXN/PTSASSESSMENT/@assessmenttype &gt;= 3)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">1</xsl:attribute>
                                 <xsl:attribute name="height">12</xsl:attribute>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:element name="A">
                                    <xsl:attribute name="href">3414.asp?AssessmentID=<xsl:value-of select="/DATA/PARAM/@assessmentid"/>&amp;MemberAssessID=<xsl:value-of select="/DATA/PARAM/@memberassessid"/>&amp;MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ReviewMasterAssessment']"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
                        ...
                        <xsl:if test="(/DATA/TXN/PTSASSESSMENT/@assessmenttype &gt;= 4)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">1</xsl:attribute>
                                 <xsl:attribute name="height">12</xsl:attribute>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="A">
                                    <xsl:attribute name="href">3414.asp?AssessmentID=<xsl:value-of select="/DATA/PARAM/@assessmentid"/>&amp;MemberAssessID=<xsl:value-of select="/DATA/PARAM/@memberassessid"/>&amp;MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ReviewProgramAssessment']"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
