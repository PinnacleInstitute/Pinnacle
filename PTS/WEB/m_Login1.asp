...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_Login1URL", reqReturnURL
   SetCache "m_Login1DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_login1")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionSignIn):
      ...
      Response.Redirect "0101.asp" & "?Lgn=" & tmpLgn & "&Pwd=" & tmpPwd & "&Page=" & "mobile1.asp?m={id}"
End Select
...
fileLanguage = "Language" + "\m_Login[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\m_Login[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "m_Login1 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_Login1 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
xslPage = "m_Login1.xsl"
Set oStyle = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oStyle.load server.MapPath(xslPage)
If oStyle.parseError <> 0 Then
   Response.Write "m_Login1 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_Login1 Load file (oData) failed with error code " + CStr(oData.parseError)
