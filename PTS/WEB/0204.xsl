                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="A">
                                    ...
                                    <xsl:attribute name="onclick">w=window.open(this.href,"Audit","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                    <xsl:attribute name="href">9901.asp</xsl:attribute>
                                 <xsl:element name="b">
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Audit']"/>
                                 </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                        ...
                        <xsl:if test="(count(/DATA/TXN/PTSSHORTCUTS/PTSSHORTCUT) &gt; 0)">
                           <xsl:for-each select="/DATA/TXN/PTSSHORTCUTS/PTSSHORTCUT[position() mod 10 = 1]">
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       <xsl:attribute name="colspan">10</xsl:attribute>
                                 ...
                                 <xsl:element name="TR">
                                    <xsl:for-each select=".|following-sibling::PTSSHORTCUT[position() &lt; 10]">
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">100</xsl:attribute>
