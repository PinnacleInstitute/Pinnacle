<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Individual Payment Schedule'"/>
                                                   ...
                                                   <xsl:attribute name="style">border: 1px #5084A2 solid</xsl:attribute>
                                                      ...
                                                      <xsl:element name="TR">
                                                         ...
                                                         <xsl:element name="TD">
                                                            ...
                                                            <xsl:element name="font">
                                                               <xsl:attribute name="color">#3266D2</xsl:attribute>
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewBalance']"/>
                                                            </xsl:element>
                                                            </xsl:element>
                                                         </xsl:element>
                                                      </xsl:element>
                                                      ...
                                                      <xsl:for-each select="/DATA/TXN/PTSDAS/PTSDA[(@debtid = current()/@debtid)]">
                                                            <xsl:element name="TR">
                                                               <xsl:attribute name="height">24</xsl:attribute>
                                                               <xsl:element name="TD">
                                                                  <xsl:attribute name="width">100</xsl:attribute>
