...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_12201URL", reqReturnURL
   SetCache "m_12201DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_12201")
...
Select Case CLng(reqActionCode)
            ...
            With oMember
               ...
               If (tmpUpdate <> 0) Then
                  If (xmlError = "") And (reqBillingPrice <> 0) And (reqNoBill = 0) Then
                     ...
                     Result = GetPayment( reqCompanyID, reqMemberID, 0, reqPayType, reqPayDesc, reqBillingPrice, Purpose, tmpProcessor, tmpAcct, PostProcess, EmailBonuses )
                  ...
                  End If
                  If (xmlError = "") Then
                     LogMemberNote reqMemberID, "MEMBERSHIP CHANGE: (" + oldLevel + ") to (" + .Level + ")"
                  End If
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("m_12201URL")
      reqReturnData = GetCache("m_12201DATA")
      SetCache "m_12201URL", ""
      SetCache "m_12201DATA", ""
...
fileLanguage = "Language" + "\m_12201[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\m_12201[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "m_12201 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_12201 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_12201 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_12201 Load file (oData) failed with error code " + CStr(oData.parseError)
