...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_9313URL", reqReturnURL
   SetCache "m_9313DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_9313")
...
reqGroupID1 =  Numeric(GetInput("GroupID1", reqPageData))
reqGroupID2 =  Numeric(GetInput("GroupID2", reqPageData))
reqGroupID3 =  Numeric(GetInput("GroupID3", reqPageData))
reqCategoryID =  Numeric(GetInput("CategoryID", reqPageData))
reqPageType =  Numeric(GetInput("PageType", reqPageData))
reqCategory =  GetInput("Category", reqPageData)
...
Sub LoadCategories()
   ...
   Else
      With oPages
         ...
         xmlCategorys = .EnumPageCategory(CLng(reqCompanyID), reqGroupID, CLng(reqGroupID1), CLng(reqGroupID2), CLng(reqGroupID3), 7, reqCategoryID, "Category", CLng(reqSysUserID))
...
Sub LoadPages()
   ...
   Else
      With oPages
         .SysCurrentLanguage = reqSysLanguage
         .ListPageCategory CLng(reqCompanyID), reqGroupID, CLng(reqGroupID1), CLng(reqGroupID2), CLng(reqGroupID3), 7, reqCategory
         If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
         xmlPages = .XML()
         If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
      End With
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      If (reqGroupID <> 0) Then
         GetResource tmpResource, reqGroupID1, reqGroupID2, reqGroupID3
      End If
      LoadCategories
   ...
   Case CLng(cActionList):
      reqCategory = Request.Form.Item("Category")
      LoadCategories
      If (reqCategoryID <> 0) Then
         LoadPages
      End If
...
xmlParam = xmlParam + " groupid1=" + Chr(34) + CStr(reqGroupID1) + Chr(34)
xmlParam = xmlParam + " groupid2=" + Chr(34) + CStr(reqGroupID2) + Chr(34)
xmlParam = xmlParam + " groupid3=" + Chr(34) + CStr(reqGroupID3) + Chr(34)
xmlParam = xmlParam + " categoryid=" + Chr(34) + CStr(reqCategoryID) + Chr(34)
xmlParam = xmlParam + " pagetype=" + Chr(34) + CStr(reqPageType) + Chr(34)
xmlParam = xmlParam + " category=" + Chr(34) + CleanXML(reqCategory) + Chr(34)
xmlParam = xmlParam + " />"

'-----get the transaction XML
xmlTransaction = "<TXN>"
xmlTransaction = xmlTransaction +  xmlPages
xmlTransaction = xmlTransaction +  xmlCategorys
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_9313 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_9313 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_9313 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_9313 Load file (oData) failed with error code " + CStr(oData.parseError)
