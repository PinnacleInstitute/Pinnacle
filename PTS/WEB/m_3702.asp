...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_3702URL", reqReturnURL
   SetCache "m_3702DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_3702")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("m_3702URL")
         reqReturnData = GetCache("m_3702DATA")
         SetCache "m_3702URL", ""
         SetCache "m_3702DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_3702 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_3702 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_3702 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_3702 Load file (oData) failed with error code " + CStr(oData.parseError)
