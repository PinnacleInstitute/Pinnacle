      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               switch(tab) {
               case 'TabHome': url = '13250.asp'; break;
               case 'TabCompany': url = '13220.asp?option=' + shw; target="CompanyInfo"; break;
               case 'TabTopic': url = '13252.asp?t=' + shw; break;
               case 'TabSearch': url = '13254.asp'; break;
               case 'TabStory': url = '13253.asp?s=' + shw; break;
               case 'TabMember':
               switch(shw) {
                                                                     ...
                                                                     <xsl:for-each select=".|following-sibling::PTSNEWSTOPIC[position() &lt; 3]">
                                                                           ...
                                                                           <xsl:element name="TD">
                                                                              ...
                                                                              <xsl:element name="DIV">
                                                                                 ...
                                                                                 <xsl:element name="A">
                                                                                    <xsl:attribute name="href">#_</xsl:attribute>
                                                                                    <xsl:attribute name="onclick">ShowTab('TabTopic', <xsl:value-of select="@newstopicid"/>)</xsl:attribute>
                                                                                    <xsl:element name="IMG">
