   ...
   <xsl:template match="/">
      ...
      <xsl:element name="BODY">
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:attribute name="onload">document.getElementById('FromSalesCampaign').focus()</xsl:attribute>
            </xsl:otherwise>
         </xsl:choose>
      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            var obj = document.getElementById('FromSalesCampaign');
            var idx = obj.selectedIndex;
            document.getElementById('CopySalesCampaignID').value = obj.options[idx].value;
              }]]></xsl:text>
               </xsl:element>
            ...
            var id = document.getElementById('CopySalesCampaignID').value;
            if( id != 0 )
            {
               var url, win;
               url = "7705.asp?SalesCampaignID=" + id;
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewSalesCampaignText']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CopySalesCampaign']"/>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="INPUT">
                              <xsl:attribute name="type">text</xsl:attribute>
                              <xsl:attribute name="name">CopySalesCampaignID</xsl:attribute>
                              <xsl:attribute name="id">CopySalesCampaignID</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@copysalescampaignid"/></xsl:attribute>
                              ...
                              <xsl:element name="SELECT">
                                 <xsl:attribute name="name">FromSalesCampaign</xsl:attribute>
                                 <xsl:attribute name="id">FromSalesCampaign</xsl:attribute>
