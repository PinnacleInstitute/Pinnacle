                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/PARAM/@usertype" disable-output-escaping="yes"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">9020.asp?Report=<xsl:value-of select="/DATA/PARAM/@report"/>&amp;AuthUserID=<xsl:value-of select="@noteid"/>&amp;FromDate=<xsl:value-of select="/DATA/PARAM/@fromdate"/>&amp;ToDate=<xsl:value-of select="/DATA/PARAM/@todate"/>&amp;User=<xsl:value-of select="@username"/></xsl:attribute>
