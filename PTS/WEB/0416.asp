...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0416URL", reqReturnURL
   SetCache "0416DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0416")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("0416URL")
      reqReturnData = GetCache("0416DATA")
      SetCache "0416URL", ""
      SetCache "0416DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "0416 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0416 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0416 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0416 Load file (oData) failed with error code " + CStr(oData.parseError)
