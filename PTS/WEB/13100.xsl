<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'PB Processing'"/>
               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@process = 29)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ListOrphans']"/>
                                 </xsl:if>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@process = 42)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='UpdateBinarySales']"/>
                                 </xsl:if>
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@process = 50)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CalculateMonthlySales']"/>
                                 </xsl:if>
                           </xsl:element>
                        </xsl:element>

                        <xsl:if test="(/DATA/PARAM/@process = 12) or (/DATA/PARAM/@process = 39) or (/DATA/PARAM/@process = 47)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">1</xsl:attribute>
                                 <xsl:attribute name="height">12</xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@process = 2) or (/DATA/PARAM/@process = 11) or (/DATA/PARAM/@process = 21) or (/DATA/PARAM/@process = 24) or (/DATA/PARAM/@process = 25) or (/DATA/PARAM/@process = 35) or (/DATA/PARAM/@process = 28) or (/DATA/PARAM/@process = 48) or (/DATA/PARAM/@process = 49) or (/DATA/PARAM/@process = 50)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">1</xsl:attribute>
                                 <xsl:attribute name="height">12</xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@result != '')">
                           ...
                           <xsl:if test="(/DATA/PARAM/@process = 30)">
                              ...
                              <xsl:element name="TR">
                                 <xsl:for-each select="/DATA/TXN/PTSPBS/PTSPB">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">800</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
