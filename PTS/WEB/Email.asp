...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "EmailURL", reqReturnURL
   SetCache "EmailDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "email")
...
reqFrom =  GetInput("From", reqPageData)
reqTo =  GetInput("To", reqPageData)
reqCC =  GetInput("CC", reqPageData)
reqBCC =  GetInput("BCC", reqPageData)
reqSubject =  GetInput("Subject", reqPageData)
reqBody =  GetInput("Body", reqPageData)
...
xmlConfig = xmlConfig + " />"
xmlParam = "<PARAM"
xmlParam = xmlParam + " from=" + Chr(34) + CleanXML(reqFrom) + Chr(34)
xmlParam = xmlParam + " to=" + Chr(34) + CleanXML(reqTo) + Chr(34)
xmlParam = xmlParam + " cc=" + Chr(34) + CleanXML(reqCC) + Chr(34)
xmlParam = xmlParam + " bcc=" + Chr(34) + CleanXML(reqBCC) + Chr(34)
xmlParam = xmlParam + " subject=" + Chr(34) + CleanXML(reqSubject) + Chr(34)
xmlParam = xmlParam + " body=" + Chr(34) + CleanXML(reqBody) + Chr(34)
...
fileLanguage = "Language" + "\SendEmail[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\SendEmail[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "Email Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "Email Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "Email Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "Email Load file (oData) failed with error code " + CStr(oData.parseError)
