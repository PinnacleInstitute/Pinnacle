...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "04102rURL", reqReturnURL
   SetCache "04102rDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "04102r")
...
fileLanguage = "Language\04102r[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\04102r[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "04102r Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "04102r Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "04102r Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "04102r Load file (oData) failed with error code " + CStr(oData.parseError)
