...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0836URL", reqReturnURL
   SetCache "0836DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0836")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oHTMLFile
            .Filename = "PayoutError" + CSTR(tmpPayType) + ".htm"
   ...
   Case CLng(cActionEmail):
      ...
      LogMemberNote reqMemberID, "EMAILED: " + tmpSubject
      reqMode = 1
End Select
...
If oLanguage.parseError <> 0 Then
   Response.Write "0836 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0836 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0836 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0836 Load file (oData) failed with error code " + CStr(oData.parseError)
