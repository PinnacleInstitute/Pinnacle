...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1120URL", reqReturnURL
   SetCache "1120DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1120")
...
Sub Register()
   ...
   Response.Redirect "1121.asp" & "?CourseID=" & reqCourseID & "&MemberID=" & reqMemberID & "&OrgCourseID=" & reqOrgCourseID & "&ReturnURL=" & GetCache("1120URL")
End Sub
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("1120URL")
      reqReturnData = GetCache("1120DATA")
      SetCache "1120URL", ""
      SetCache "1120DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "1120 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1120 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1120 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1120 Load file (oData) failed with error code " + CStr(oData.parseError)
