               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                           ...
                           <xsl:if test="(/DATA/PARAM/@result = 2)">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Relogin']"/>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:element name="INPUT">
                                       ...
                                       <xsl:attribute name="value">
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Logout']"/>
                                       </xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@result = 0)">
                           <xsl:if test="(/DATA/TXN/PTSMEMBER/@level = 3)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                       ...
                                       <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:if test="/DATA/PARAM/@membership=15">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:attribute name="align">left</xsl:attribute>
                                                <xsl:attribute name="valign">center</xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_15']"/>
                                             </xsl:element>
                                          </xsl:element>
                           ...
                           <xsl:if test="(/DATA/TXN/PTSMEMBER/@level = 1)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    <xsl:attribute name="colspan">3</xsl:attribute>
                                    <xsl:attribute name="width">750</xsl:attribute>
                                          ...
                                          <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 1)">
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="align">left</xsl:attribute>
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                   <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_3']"/>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>
                                          ...
                                          <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 2)">
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_4']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_4i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>

                                          <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 2) or (/DATA/TXN/PTSMEMBER/@title = 3)">
                                             <xsl:element name="TR">
                                                <xsl:element name="TD">
                                                   <xsl:attribute name="colspan">3</xsl:attribute>
                                                   <xsl:attribute name="height">12</xsl:attribute>
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_5']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_5i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                          </xsl:if>

                                          <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 2) or (/DATA/TXN/PTSMEMBER/@title = 3) or (/DATA/TXN/PTSMEMBER/@title = 4)">
                                             <xsl:element name="TR">
                                                <xsl:element name="TD">
                                                   <xsl:attribute name="colspan">3</xsl:attribute>
                                                   <xsl:attribute name="height">12</xsl:attribute>
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_6']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_6i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_7']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_7i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_8']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_8i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_9']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_9i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                             ...
                                             <xsl:element name="TR">
                                                ...
                                                <xsl:element name="TD">
                                                   ...
                                                   <xsl:attribute name="valign">center</xsl:attribute>
                                                      <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_10']"/>
                                                      </xsl:if>
                                                      <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                         <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_10i']"/>
                                                      </xsl:if>
                                                </xsl:element>
                                             </xsl:element>
                                             ...
                                             <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 4)">
                                                ...
                                                <xsl:element name="TR">
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:if test="/DATA/PARAM/@membership=11">
                                                         <xsl:attribute name="CHECKED"/>
                                                      </xsl:if>
                                                      </xsl:element>
                                                   </xsl:element>
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         <xsl:if test="(/DATA/PARAM/@countryid = 224)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_11']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/PARAM/@countryid != 224)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Membership_11i']"/>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                             </xsl:if>
