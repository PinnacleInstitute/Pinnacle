...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "GCRFulfillURL", reqReturnURL
   SetCache "GCRFulfillDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "gcrfulfill")
...
fileLanguage = "Language" + "\GCRFulfill[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\GCRFulfill[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "GCRFulfill Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "GCRFulfill Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
xslPage = "GCRFulfill.xsl"
Set oStyle = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oStyle.load server.MapPath(xslPage)
If oStyle.parseError <> 0 Then
   Response.Write "GCRFulfill Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "GCRFulfill Load file (oData) failed with error code " + CStr(oData.parseError)
