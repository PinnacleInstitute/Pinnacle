...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "6201URL", reqReturnURL
   SetCache "6201DATA", reqReturnData
End If
...
pos = InStr(reqSysServerPath, "6201")
...
If oLanguage.parseError <> 0 Then
   Response.Write "6201 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "6201 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "6201 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "6201 Load file (oData) failed with error code " + CStr(oData.parseError)
