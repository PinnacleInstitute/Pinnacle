<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Member Performance'"/>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='PerformanceStatistics']"/>
                                 <xsl:element name="BR"/>
                                 <xsl:element name="IMG">
                                 ...
                                 <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                 <xsl:if test="(/DATA/TXN/PTSMEMBER/@qv != 0)">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:attribute name="style">border: 1px #5084A2 solid</xsl:attribute>
                                    ...
                                    <xsl:if test="(contains(/DATA/PARAM/@options, 'g')) or (contains(/DATA/PARAM/@options, 'G'))">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">50</xsl:attribute>
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSPERFORMANCE/@mentornotes"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">175</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MentorNotes']"/>
                                          </xsl:element>
                                       </xsl:element>
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                    ...
                                    <xsl:if test="(contains(/DATA/PARAM/@options, 'H'))">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSPERFORMANCE/@goals"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">175</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                                    ...
                                    <xsl:if test="(contains(/DATA/PARAM/@options, 'h'))">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSPERFORMANCE/@contacts"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">175</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                                    ...
                                    <xsl:if test="(contains(/DATA/PARAM/@options, 'E'))">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSPERFORMANCE/@prospects"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">175</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Prospects']"/>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSPERFORMANCE/@prospectsactive"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">175</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ProspectsActive']"/>
                                          </xsl:element>
                                       </xsl:element>
                                       ...
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSPERFORMANCE/@prospectnotes"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">175</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ProspectNotes']"/>
                                          </xsl:element>
                                       </xsl:element>
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                    ...
                                    <xsl:if test="(contains(/DATA/PARAM/@options, '6'))">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSPERFORMANCE/@customers"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">175</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                                       ...
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSPERFORMANCE/@customernotes"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">175</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CustomerNotes']"/>
                                          </xsl:element>
                                       </xsl:element>
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                    ...
                                    <xsl:if test="(contains(/DATA/PARAM/@options, 'K'))">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSPERFORMANCE/@courses"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">175</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                                    ...
                                    <xsl:if test="(contains(/DATA/PARAM/@options, 'L'))">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSPERFORMANCE/@assessments"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">175</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                                       ...
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/TXN/PTSPERFORMANCE/@certifications"/>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                             <xsl:attribute name="width">175</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Certifications']"/>
                                          </xsl:element>
                                       </xsl:element>
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
