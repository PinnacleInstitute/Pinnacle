...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_11711URL", reqReturnURL
   SetCache "m_11711DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_11711")
...
Sub ViewMetrics()
   ...
   Else
      With oMetrics
         ...
         .ListMember CLng(reqMemberID), CDate(reqFromDate), CDate(reqToDate)
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      Response.Redirect "m_11702.asp" & "?MemberID=" & reqMemberID & "&ReturnURL=" & reqPageURL

   Case CLng(cActionReturn):

      reqReturnURL = GetCache("m_11711URL")
      reqReturnData = GetCache("m_11711DATA")
      SetCache "m_11711URL", ""
      SetCache "m_11711DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_11711 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_11711 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_11711 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_11711 Load file (oData) failed with error code " + CStr(oData.parseError)
