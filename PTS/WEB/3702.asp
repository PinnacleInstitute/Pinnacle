...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "3702URL", reqReturnURL
   SetCache "3702DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "3702")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("3702URL")
         reqReturnData = GetCache("3702DATA")
         SetCache "3702URL", ""
         SetCache "3702DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "3702 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "3702 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "3702 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "3702 Load file (oData) failed with error code " + CStr(oData.parseError)
