...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "13704URL", reqReturnURL
   SetCache "13704DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "13704")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      Else
         With oProfile
            ...
            .ProfileDate = Request.Form.Item("ProfileDate")
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("13704URL")
         reqReturnData = GetCache("13704DATA")
         SetCache "13704URL", ""
         SetCache "13704DATA", ""
   ...
   Case CLng(cActionDelete):
      ...
      Else
         With oProfile
            .SysCurrentLanguage = reqSysLanguage
            .Delete CLng(reqProfileID), CLng(reqSysUserID)
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
         End With
      End If
      Set oProfile = Nothing
...
If oLanguage.parseError <> 0 Then
   Response.Write "13704 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "13704 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "13704 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "13704 Load file (oData) failed with error code " + CStr(oData.parseError)
