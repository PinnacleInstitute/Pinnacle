<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Redeem Reward'"/>
      ...
      <xsl:element name="BODY">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               <xsl:element name="SCRIPT">
                  <xsl:attribute name="language">JavaScript</xsl:attribute>
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function ValidPurchase(){ 
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">TotalCashBack</xsl:attribute>
                              <xsl:attribute name="id">TotalCashBack</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@totalcashback"/></xsl:attribute>
                           </xsl:element>
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">TotalAwards</xsl:attribute>
                              <xsl:attribute name="id">TotalAwards</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@totalawards"/></xsl:attribute>
                           </xsl:element>
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='RedeemReward']"/>
                           </xsl:element>
                        </xsl:element>
                        ...
                        <xsl:if test="(/DATA/PARAM/@consumername = '')">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">2</xsl:attribute>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="TABLE">
                                    ...
                                    <xsl:attribute name="cellspacing">0</xsl:attribute>
                                    <xsl:attribute name="width">100%</xsl:attribute>
                                    <xsl:attribute name="style">border:1px solid; border-radius:20px; border-color:#cccccc; padding:5px; BACKGROUND-COLOR: #d1fa99</xsl:attribute>
                           ...
                           <xsl:if test="(/DATA/PARAM/@consumername != '')">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="name">RewardType</xsl:attribute>
                                    <xsl:attribute name="id">RewardType</xsl:attribute>
                                    <xsl:attribute name="value">1</xsl:attribute>
                                    <xsl:if test="/DATA/PARAM/@rewardtype=1">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:element name="font">
                                       <xsl:attribute name="size">3</xsl:attribute>
                                       <xsl:element name="b">
                                       <xsl:value-of select="/DATA/PARAM/@totalcashback" disable-output-escaping="yes"/>
                                       </xsl:element>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TotalCashBack']"/>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
                              ...
                              <xsl:if test="(/DATA/PARAM/@isawards != 0)">
                                 <xsl:element name="TR">
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:if test="/DATA/PARAM/@rewardtype=2">
                                          <xsl:attribute name="CHECKED"/>
                                       </xsl:if>
                                       </xsl:element>
                                    </xsl:element>
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="font">
                                          <xsl:attribute name="size">3</xsl:attribute>
                                          <xsl:element name="b">
                                          <xsl:value-of select="/DATA/PARAM/@totalawards" disable-output-escaping="yes"/>
                                          </xsl:element>
                                          <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TotalAwards']"/>
                                       </xsl:element>
                                    </xsl:element>
                                 </xsl:element>
                                 <xsl:element name="TR">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="align">right</xsl:attribute>
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='RewardDate']"/>
                                    <xsl:text>:</xsl:text>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 </xsl:element>
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="class">bigtext</xsl:attribute>
                                    <xsl:attribute name="type">text</xsl:attribute>
                                    <xsl:attribute name="name">RewardDate</xsl:attribute>
                                    <xsl:attribute name="id">RewardDate</xsl:attribute>
                                    <xsl:attribute name="size">13</xsl:attribute>
                                    <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSREWARD/@rewarddate"/></xsl:attribute>
                                    </xsl:element>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    <xsl:element name="IMG">
                                       ...
                                       <xsl:attribute name="border">0</xsl:attribute>
                                       <xsl:attribute name="onclick">CalendarPopup(document.forms[0], document.getElementById('RewardDate'))</xsl:attribute>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
                              ...
                              <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="class">bigtext</xsl:attribute>
                                    <xsl:attribute name="type">text</xsl:attribute>
                                    <xsl:attribute name="name">Purchase</xsl:attribute>
                                    <xsl:attribute name="id">Purchase</xsl:attribute>
                                    <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@purchase"/></xsl:attribute>
                                    <xsl:attribute name="size">13</xsl:attribute>
                                    <xsl:attribute name="onblur"><xsl:text disable-output-escaping="yes"><![CDATA[ValidPurchase();]]></xsl:text></xsl:attribute>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
                              ...
                              <xsl:element name="TR">
                                 ...
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSREWARD/@reference"/></xsl:attribute>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:element name="TEXTAREA">
                                       ...
                                       <xsl:value-of select="/DATA/TXN/PTSREWARD/@note"/>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:element name="TR">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="font">
                                    ...
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Reward']"/>
                                    <xsl:text>:</xsl:text>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    <xsl:element name="b">
