<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Prospect Notes'"/>
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="IFRAME">
                                 <xsl:attribute name="src">9011.asp?OwnerType=81&amp;OwnerID=<xsl:value-of select="/DATA/PARAM/@prospectid"/>&amp;Title=<xsl:value-of select="/DATA/TXN/PTSPROSPECT/@prospectname"/></xsl:attribute>
                                 <xsl:attribute name="width">600</xsl:attribute>
                                 ...
                                 <xsl:element name="A">
                                    <xsl:attribute name="href">9011.asp?OwnerType=81&amp;OwnerID=<xsl:value-of select="/DATA/PARAM/@prospectid"/>&amp;Title=<xsl:value-of select="/DATA/TXN/PTSPROSPECT/@prospectname"/></xsl:attribute>
