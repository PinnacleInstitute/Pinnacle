...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "12201URL", reqReturnURL
   SetCache "12201DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "12201")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("12201URL")
      reqReturnData = GetCache("12201DATA")
      SetCache "12201URL", ""
      SetCache "12201DATA", ""
...
fileLanguage = "Language" + "\12201[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\12201[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "12201 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "12201 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "12201 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "12201 Load file (oData) failed with error code " + CStr(oData.parseError)
