...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "15903URL", reqReturnURL
   SetCache "15903DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "15903")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      Else
         With oGift
            ...
            .GiftDate = Request.Form.Item("GiftDate")
            .Amount = Request.Form.Item("Amount")
            .PaymentID = Request.Form.Item("PaymentID")
            .Member2ID = Request.Form.Item("Member2ID")
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("15903URL")
         reqReturnData = GetCache("15903DATA")
         SetCache "15903URL", ""
         SetCache "15903DATA", ""
   ...
   Case CLng(cActionDelete):
      ...
      Else
         With oGift
            .SysCurrentLanguage = reqSysLanguage
            .Delete CLng(reqGiftID), CLng(reqSysUserID)
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
         End With
      End If
      Set oGift = Nothing
...
If oLanguage.parseError <> 0 Then
   Response.Write "15903 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "15903 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "15903 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "15903 Load file (oData) failed with error code " + CStr(oData.parseError)
