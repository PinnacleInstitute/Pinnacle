<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Seminar Report'"/>
                                 ...
                                 <xsl:attribute name="width">675</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Visitors']"/>
                                          </xsl:element>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">200</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="font">
                                             <xsl:attribute name="size">5</xsl:attribute>
                                          <xsl:value-of select="/DATA/PARAM/@visitors" disable-output-escaping="yes"/>
                                          </xsl:element>
                                          </xsl:element>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="font">
                                             <xsl:attribute name="size">5</xsl:attribute>
                                          <xsl:value-of select="/DATA/PARAM/@registered" disable-output-escaping="yes"/>
                                          </xsl:element>
                                          </xsl:element>
                                       </xsl:element>
                                       <xsl:element name="TD">
