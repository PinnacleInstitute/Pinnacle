...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "2201URL", reqReturnURL
   SetCache "2201DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "2201")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("2201URL")
      reqReturnData = GetCache("2201DATA")
      SetCache "2201URL", ""
      SetCache "2201DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "2201 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "2201 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "2201 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "2201 Load file (oData) failed with error code " + CStr(oData.parseError)
