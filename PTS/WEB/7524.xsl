<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Whats New'"/>
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">VisitDate</xsl:attribute>
                              <xsl:attribute name="id">VisitDate</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@visitdate"/></xsl:attribute>
                           </xsl:element>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/PARAM/@projectid = 0)">
                                 <xsl:if test="(/DATA/PARAM/@memberid = 0)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='WhatsNewAll']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@memberid != 0)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='WhatsNewMember']"/>
                              ...
                              <xsl:if test="(/DATA/PARAM/@projectid != 0)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='WhatsNewProject']"/>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                     ...
                     document.getElementById('toDate').value = todate.getMonth()+1 + "/" + todate.getDate() + "/" + todate.getFullYear();
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@visitdate != '') and (/DATA/PARAM/@memberid != 0)">
                        ...
                        <xsl:if test="(/DATA/PARAM/@projectid = 0) and (/DATA/PARAM/@memberid != 0)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="width">750</xsl:attribute>
                                 <xsl:attribute name="align">center</xsl:attribute>
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:element name="b">
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ReportProjects']"/>
                                 <xsl:text>:</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 </xsl:element>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 <xsl:if test="(/DATA/PARAM/@securitylevel &gt;= 0)">
                                 <xsl:element name="INPUT">
                                    <xsl:attribute name="type">radio</xsl:attribute>
                                    <xsl:attribute name="name">Rpt</xsl:attribute>
                                    <xsl:attribute name="id">Rpt</xsl:attribute>
                                    <xsl:attribute name="value">3</xsl:attribute>
                                    <xsl:if test="/DATA/PARAM[@rpt=3]">
                                       <xsl:attribute name="CHECKED"/>
                                    </xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AccessProjects']"/>
                                 </xsl:element>
                                 </xsl:if>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 <xsl:if test="(/DATA/PARAM/@memberid != 0)">
                                 <xsl:element name="INPUT">
                                    ...
                                    <xsl:attribute name="id">Rpt</xsl:attribute>
                                    <xsl:attribute name="value">1</xsl:attribute>
                                    <xsl:if test="/DATA/PARAM[@rpt=1]">
                                       <xsl:attribute name="CHECKED"/>
                                    </xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='OwnProjects']"/>
                                 </xsl:element>
                                 </xsl:if>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 <xsl:if test="(/DATA/PARAM/@memberid != 0)">
                                 <xsl:element name="INPUT">
                                    ...
                                    <xsl:attribute name="id">Rpt</xsl:attribute>
                                    <xsl:attribute name="value">2</xsl:attribute>
                                    <xsl:if test="/DATA/PARAM[@rpt=2]">
                                       <xsl:attribute name="CHECKED"/>
                                    </xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='BelongProjects']"/>
                                 </xsl:element>
                                 </xsl:if>
                              </xsl:element>
                           </xsl:element>
                        ...
                        <xsl:if test="(/DATA/PARAM/@projectcount = 0)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:element name="b">
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoProjects']"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
                        ...
                        <xsl:if test="(/DATA/PARAM/@projectcount != 0)">
                                 ...
                                 <xsl:element name="TABLE">
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Projects']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">left</xsl:attribute>
                                          <xsl:attribute name="width">10%</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="class">ColumnTitle</xsl:attribute>
                                          <xsl:attribute name="valign">Bottom</xsl:attribute>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ActStartDate']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">left</xsl:attribute>
                                          <xsl:attribute name="width">10%</xsl:attribute>
                                          <xsl:attribute name="class">ColumnTitle</xsl:attribute>
                                          <xsl:attribute name="valign">Bottom</xsl:attribute>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ActEndDate']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="width">10%</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="class">ColumnTitle</xsl:attribute>
                                          <xsl:attribute name="valign">Bottom</xsl:attribute>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Documents']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="width">10%</xsl:attribute>
                                    ...
                                    <xsl:for-each select="/DATA/TXN/PTSPROJECTS/PTSPROJECT">
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">top</xsl:attribute>
                                                <xsl:element name="A">
                                                   <xsl:attribute name="onclick">w=window.open(this.href,"project","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                   <xsl:attribute name="href">7503.asp?ProjectID=<xsl:value-of select="@projectid"/></xsl:attribute>
                                                ...
                                                <xsl:if test="(@projectid != /DATA/PARAM/@projectid)">
                                                   <xsl:element name="A">
                                                      <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                                      <xsl:attribute name="onclick">w=window.open(this.href,"WhatsNew2","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                      <xsl:attribute name="href">7524.asp?ProjectID=<xsl:value-of select="@projectid"/></xsl:attribute>
                                                   [<xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='WhatsNew']"/>]
                                                   </xsl:element>
                                                </xsl:if>
                                          </xsl:element>
                                          <xsl:element name="TD">
                                          ...
                                          <xsl:element name="TD">
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">top</xsl:attribute>
                                                <xsl:if test="(@isforum != 0)">
                                                   <xsl:element name="A">
                                                      <xsl:attribute name="onclick">w=window.open(this.href,"_blank","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                      <xsl:attribute name="href">8411.asp?ForumID=<xsl:value-of select="@forumid"/>&amp;IsChat=<xsl:value-of select="@ischat"/></xsl:attribute>
                                    ...
                                    <xsl:choose>
                                       <xsl:when test="(count(/DATA/TXN/PTSPROJECTS/PTSPROJECT) = 0)">
                                          <xsl:element name="TR">
                                             <xsl:element name="TD">
                                                <xsl:attribute name="colspan">7</xsl:attribute>
                                                <xsl:attribute name="align">left</xsl:attribute>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="align">left</xsl:attribute>
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TotalProjects']"/>
                                    <xsl:text>:</xsl:text>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                    <xsl:value-of select="/DATA/PARAM/@projectcount" disable-output-escaping="yes"/>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                        ...
                        <xsl:if test="(/DATA/PARAM/@taskcount = 0)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:element name="b">
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoTasks']"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                           <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="valign">top</xsl:attribute>
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">7403.asp?TaskID=<xsl:value-of select="@taskid"/></xsl:attribute>
