<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Add Leads'"/>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewLead']"/>
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">prompt</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewLeadText']"/>
                           </xsl:element>
                        </xsl:element>
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:attribute name="width">590</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">245</xsl:attribute>
                                          <xsl:attribute name="align">left</xsl:attribute>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Priority1</xsl:attribute>
                                          <xsl:attribute name="id">Priority1</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Note1</xsl:attribute>
                                          <xsl:attribute name="id">Note1</xsl:attribute>
                                          <xsl:attribute name="maxlength">80</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Priority2</xsl:attribute>
                                          <xsl:attribute name="id">Priority2</xsl:attribute>
                                          <xsl:attribute name="maxlength">4</xsl:attribute>
                                          <xsl:attribute name="size">3</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Note2</xsl:attribute>
                                          <xsl:attribute name="id">Note2</xsl:attribute>
                                          <xsl:attribute name="maxlength">80</xsl:attribute>
                                          <xsl:attribute name="size">80</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Priority3</xsl:attribute>
                                          <xsl:attribute name="id">Priority3</xsl:attribute>
                                          <xsl:attribute name="maxlength">4</xsl:attribute>
                                          <xsl:attribute name="size">3</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Note3</xsl:attribute>
                                          <xsl:attribute name="id">Note3</xsl:attribute>
                                          <xsl:attribute name="maxlength">80</xsl:attribute>
                                          <xsl:attribute name="size">80</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Priority4</xsl:attribute>
                                          <xsl:attribute name="id">Priority4</xsl:attribute>
                                          <xsl:attribute name="maxlength">4</xsl:attribute>
                                          <xsl:attribute name="size">3</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Note4</xsl:attribute>
                                          <xsl:attribute name="id">Note4</xsl:attribute>
                                          <xsl:attribute name="maxlength">80</xsl:attribute>
                                          <xsl:attribute name="size">80</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Priority5</xsl:attribute>
                                          <xsl:attribute name="id">Priority5</xsl:attribute>
                                          <xsl:attribute name="maxlength">4</xsl:attribute>
                                          <xsl:attribute name="size">3</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Note5</xsl:attribute>
                                          <xsl:attribute name="id">Note5</xsl:attribute>
                                          <xsl:attribute name="maxlength">80</xsl:attribute>
                                          <xsl:attribute name="size">80</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Priority6</xsl:attribute>
                                          <xsl:attribute name="id">Priority6</xsl:attribute>
                                          <xsl:attribute name="maxlength">4</xsl:attribute>
                                          <xsl:attribute name="size">3</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Note6</xsl:attribute>
                                          <xsl:attribute name="id">Note6</xsl:attribute>
                                          <xsl:attribute name="maxlength">80</xsl:attribute>
                                          <xsl:attribute name="size">80</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Priority7</xsl:attribute>
                                          <xsl:attribute name="id">Priority7</xsl:attribute>
                                          <xsl:attribute name="maxlength">4</xsl:attribute>
                                          <xsl:attribute name="size">3</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Note7</xsl:attribute>
                                          <xsl:attribute name="id">Note7</xsl:attribute>
                                          <xsl:attribute name="maxlength">80</xsl:attribute>
                                          <xsl:attribute name="size">80</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Priority8</xsl:attribute>
                                          <xsl:attribute name="id">Priority8</xsl:attribute>
                                          <xsl:attribute name="maxlength">4</xsl:attribute>
                                          <xsl:attribute name="size">3</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Note8</xsl:attribute>
                                          <xsl:attribute name="id">Note8</xsl:attribute>
                                          <xsl:attribute name="maxlength">80</xsl:attribute>
                                          <xsl:attribute name="size">80</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Priority9</xsl:attribute>
                                          <xsl:attribute name="id">Priority9</xsl:attribute>
                                          <xsl:attribute name="maxlength">4</xsl:attribute>
                                          <xsl:attribute name="size">3</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Note9</xsl:attribute>
                                          <xsl:attribute name="id">Note9</xsl:attribute>
                                          <xsl:attribute name="maxlength">80</xsl:attribute>
                                          <xsl:attribute name="size">80</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Priority10</xsl:attribute>
                                          <xsl:attribute name="id">Priority10</xsl:attribute>
                                          <xsl:attribute name="maxlength">4</xsl:attribute>
                                          <xsl:attribute name="size">3</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="INPUT">
                                          <xsl:attribute name="type">text</xsl:attribute>
                                          <xsl:attribute name="name">Note10</xsl:attribute>
                                          <xsl:attribute name="id">Note10</xsl:attribute>
                                          <xsl:attribute name="maxlength">80</xsl:attribute>
                                          <xsl:attribute name="size">80</xsl:attribute>
                                          </xsl:element>
                                       </xsl:element>
