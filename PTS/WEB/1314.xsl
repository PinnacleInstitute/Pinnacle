<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="/DATA/LANGUAGE/LABEL[@name='Classes']"/>
                              ...
                              <xsl:if test="(contains(/DATA/SYSTEM/@useroptions, 'M')) or (/DATA/SYSTEM/@usergroup &lt;= 23)">
                                 <xsl:element name="INPUT">
                                    ...
                                    <xsl:attribute name="value">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ViewCourseCatalog']"/>
                                    </xsl:attribute>
                     ...
                     window.open( URL);
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ViewStatus']"/>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:element name="TR">
                                    ...
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:attribute name="class">ColumnTitle</xsl:attribute>
                                       <xsl:attribute name="valign">Bottom</xsl:attribute>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='RegisteredClassesCaption']"/>
                                    </xsl:element>
                                    <xsl:element name="TD">
                                       <xsl:attribute name="align">left</xsl:attribute>
                                       <xsl:attribute name="width">10%</xsl:attribute>
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSSESSIONS/PTSSESSION">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="b">
                                             <xsl:element name="A">
                                                <xsl:attribute name="onclick">w=window.open(this.href,"Lessons","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                <xsl:attribute name="href">1315.asp?SessionID=<xsl:value-of select="@sessionid"/>&amp;MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/></xsl:attribute>
                                       ...
                                       <xsl:if test="(@passinggrade = 0)">
                                          <xsl:element name="TD">
                                             <xsl:attribute name="align">center</xsl:attribute>
                                             <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NA']"/>
                                          </xsl:element>
                                       </xsl:if>
                                       <xsl:if test="(@passinggrade &gt; 0)">
                                          <xsl:element name="TD">
