                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="b">
                                 ...
                                 <xsl:if test="(/DATA/PARAM/@existfavoriteid &gt; 0)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Exisits']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@existfavoriteid = 0) and (/DATA/PARAM/@favoriteid &gt; 0)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Success']"/>
                                 </xsl:if>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
