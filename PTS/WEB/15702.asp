...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "15702URL", reqReturnURL
   SetCache "15702DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "15702")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("15702URL")
         reqReturnData = GetCache("15702DATA")
         SetCache "15702URL", ""
         SetCache "15702DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "15702 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "15702 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "15702 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "15702 Load file (oData) failed with error code " + CStr(oData.parseError)
