   ...
   <xsl:template match="/">
      ...
      <xsl:element name="BODY">
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:attribute name="onload">document.getElementById('FolderName').focus()</xsl:attribute>
            </xsl:otherwise>
         </xsl:choose>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewFolder']"/>
                           </xsl:element>
                        </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FolderName']"/>
                              <xsl:text>:</xsl:text>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="name">FolderName</xsl:attribute>
                              <xsl:attribute name="id">FolderName</xsl:attribute>
                              <xsl:attribute name="size">40</xsl:attribute>
                              <xsl:attribute name="maxlength">60</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSFOLDER/@foldername"/></xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSFOLDER/@seq"/></xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:if test="(/DATA/SYSTEM/@usergroup != 41) or (/DATA/PARAM/@groupid = /DATA/TXN/PTSFOLDER/@memberid)">
                              <xsl:element name="INPUT">
                                 <xsl:attribute name="type">checkbox</xsl:attribute>
                                 <xsl:attribute name="name">IsShare</xsl:attribute>
                                 <xsl:attribute name="id">IsShare</xsl:attribute>
                                 <xsl:attribute name="value">1</xsl:attribute>
                                 <xsl:if test="(/DATA/TXN/PTSFOLDER/@isshare = 1)"><xsl:attribute name="CHECKED"/></xsl:if>
                        ...
                        <xsl:if test="(count(/DATA/TXN/PTSDRIPCAMPAIGNS/ENUM) &gt; 1)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="align">right</xsl:attribute>
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='DripCampaignID']"/>
                                 <xsl:text>:</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              </xsl:element>
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="SELECT">
                                    <xsl:attribute name="name">DripCampaignID</xsl:attribute>
                                    <xsl:attribute name="id">DripCampaignID</xsl:attribute>
