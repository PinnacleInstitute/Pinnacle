<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="/DATA/LANGUAGE/LABEL[@name='AssessmentQuestion']"/>
            ...
            <xsl:when test="(/DATA/ERROR)">
               ...
               <xsl:choose>
                  <xsl:when test="string-length($errmsg)&gt;0">
                     ...
                     <xsl:attribute name="onLoad"><xsl:text disable-output-escaping="yes"><![CDATA[UpdateTimer();parent.scrollTo(0,0);]]></xsl:text>;doErrorMsg('<xsl:value-of select="concat($errmsg, $errmsgfld)"/>')</xsl:attribute>
                  </xsl:when>
                  <xsl:otherwise>
                     <xsl:attribute name="onLoad"><xsl:text disable-output-escaping="yes"><![CDATA[UpdateTimer();parent.scrollTo(0,0);]]></xsl:text>;doErrorMsg('<xsl:value-of select="/DATA/ERROR"/>')</xsl:attribute>
                  </xsl:otherwise>
               </xsl:choose>
            </xsl:when>
            <xsl:otherwise>
               <xsl:attribute name="onLoad"><xsl:text disable-output-escaping="yes"><![CDATA[UpdateTimer();parent.scrollTo(0,0);]]></xsl:text></xsl:attribute>
            </xsl:otherwise>
         </xsl:choose>
                                    ...
                                    <xsl:attribute name="width">600</xsl:attribute>
                                       ...
                                       <xsl:element name="TR">
                                          ...
                                          <xsl:element name="TD">
                                             ...
                                             <xsl:attribute name="style">BORDER:none; COLOR:black; BACKGROUND:transparent; TEXT-ALIGN:right;</xsl:attribute>
                                 ...
                                 <xsl:element name="TR">
                                    ...
                                    <xsl:element name="TD">
                                       ...
                                       <xsl:element name="A">
                                          ...
                                          <xsl:attribute name="href">3460.asp?AssessmentID=<xsl:value-of select="/DATA/PARAM/@assessmentid"/>&amp;MemberAssessID=<xsl:value-of select="/DATA/PARAM/@memberassessid"/></xsl:attribute>
                                       <xsl:element name="b">
