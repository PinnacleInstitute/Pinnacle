...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "14904URL", reqReturnURL
   SetCache "14904DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "14904")
...
Select Case CLng(reqActionCode)
         ...
         Else
            With oMember
               ...
               If (reqMembership = 4) Then
                  ...
                  .Price = 69.77
               End If
               If (InStr(.Options2, tmpCode) = 0) Then
               ...
               If (tmpUpdate <> 0) Then
                  ...
                  If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
                  If (xmlError = "") Then
                     LogMemberNote reqMemberID, "CUSTOMER CHANGE: (" + oldOptions2 + ") to (" + .Options2 + ")"
                  End If
               End If
            End With
         End If
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("14904URL")
      reqReturnData = GetCache("14904DATA")
      SetCache "14904URL", ""
      SetCache "14904DATA", ""
...
fileLanguage = "Language" + "\14904[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\14904[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "14904 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "14904 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "14904 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "14904 Load file (oData) failed with error code " + CStr(oData.parseError)
