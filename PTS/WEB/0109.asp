...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0109URL", reqReturnURL
   SetCache "0109DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0109")
...
reqDAY1 =  Numeric(GetInput("DAY1", reqPageData))
reqDAY2 =  Numeric(GetInput("DAY2", reqPageData))
reqDAY3 =  Numeric(GetInput("DAY3", reqPageData))
reqDAY4 =  Numeric(GetInput("DAY4", reqPageData))
reqDAY5 =  Numeric(GetInput("DAY5", reqPageData))
reqDAY6 =  Numeric(GetInput("DAY6", reqPageData))
reqDAY7 =  Numeric(GetInput("DAY7", reqPageData))
reqTIME1 =  Numeric(GetInput("TIME1", reqPageData))
reqTIME2 =  Numeric(GetInput("TIME2", reqPageData))
reqTZ =  Numeric(GetInput("TZ", reqPageData))
reqAccess =  GetInput("Access", reqPageData)
   ...
   Case CLng(cActionNew):
      ...
      If (reqStaffID <> 0) Then
         ...
         Else
            With oStaff
               .SysCurrentLanguage = reqSysLanguage
               .Load reqStaffID, CLng(reqSysUserID)
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
               reqName = .StaffName
               reqAccess = .Access
            End With
...
xmlParam = xmlParam + " day1=" + Chr(34) + CStr(reqDAY1) + Chr(34)
xmlParam = xmlParam + " day2=" + Chr(34) + CStr(reqDAY2) + Chr(34)
xmlParam = xmlParam + " day3=" + Chr(34) + CStr(reqDAY3) + Chr(34)
xmlParam = xmlParam + " day4=" + Chr(34) + CStr(reqDAY4) + Chr(34)
xmlParam = xmlParam + " day5=" + Chr(34) + CStr(reqDAY5) + Chr(34)
xmlParam = xmlParam + " day6=" + Chr(34) + CStr(reqDAY6) + Chr(34)
xmlParam = xmlParam + " day7=" + Chr(34) + CStr(reqDAY7) + Chr(34)
xmlParam = xmlParam + " time1=" + Chr(34) + CStr(reqTIME1) + Chr(34)
xmlParam = xmlParam + " time2=" + Chr(34) + CStr(reqTIME2) + Chr(34)
xmlParam = xmlParam + " tz=" + Chr(34) + CStr(reqTZ) + Chr(34)
xmlParam = xmlParam + " access=" + Chr(34) + CleanXML(reqAccess) + Chr(34)
xmlParam = xmlParam + " />"
...
fileLanguage = "Language" + "\0109[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\0109[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "0109 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0109 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0109 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0109 Load file (oData) failed with error code " + CStr(oData.parseError)
