   ...
   <xsl:template match="/">
      ...
      <xsl:element name="BODY">
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:attribute name="onload">document.getElementById('ReportToDate').focus()</xsl:attribute>
            </xsl:otherwise>
         </xsl:choose>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="INPUT">
                                 ...
                                 <xsl:attribute name="value">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='LinkReferrals']"/>
                                 </xsl:attribute>
                                 <xsl:attribute name="onclick">doSubmit(2,'<xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ConfirmLink']"/>')</xsl:attribute>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="INPUT">
                                 ...
                                 <xsl:attribute name="onclick">doSubmit(4,'<xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ConfirmCreatePayments']"/>')</xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              ...
                              <xsl:attribute name="name">ReportToDate</xsl:attribute>
                              <xsl:attribute name="id">ReportToDate</xsl:attribute>
                              <xsl:attribute name="size">10</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSPAYMENT/@reporttodate"/></xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                              <xsl:element name="IMG">
                                 ...
                                 <xsl:attribute name="border">0</xsl:attribute>
                                 <xsl:attribute name="onclick">CalendarPopup(document.forms[0], document.getElementById('ReportToDate'))</xsl:attribute>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="INPUT">
                                 <xsl:attribute name="type">button</xsl:attribute>
                                 <xsl:attribute name="value">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CalcTrainerScores']"/>
                                 </xsl:attribute>
                                 <xsl:attribute name="onclick">doSubmit(8,'<xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ConfirmCalcTrainerScores']"/>')</xsl:attribute>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
