                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Congradulations']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="width">600</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating2 &lt; 1)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating2 &lt; 2)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating2 &lt; 3)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating2 &lt; 4)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating2 &lt; 5)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating3 &lt; 1)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating3 &lt; 2)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating3 &lt; 3)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating3 &lt; 4)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating3 &lt; 5)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating4 &lt; 1)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating4 &lt; 2)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating4 &lt; 3)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating4 &lt; 4)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:if test="(/DATA/TXN/PTSSESSION/@rating4 &lt; 5)">
                                             <xsl:element name="IMG">
                                                <xsl:attribute name="src">Images/star_empty.gif</xsl:attribute>
                                                <xsl:attribute name="width">20</xsl:attribute>
