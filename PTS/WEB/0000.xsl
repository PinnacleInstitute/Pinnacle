<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:include href="PageHeaderPublic.xsl"/>
   <xsl:include href="PageFooterPublic.xsl"/>
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Pinnacle Performance Institute'"/>
      ...
      <xsl:element name="BODY">
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:attribute name="onload">document.getElementById('Lgn').focus()</xsl:attribute>
            </xsl:otherwise>
         </xsl:choose>

         <xsl:element name="DIV">
            <xsl:attribute name="style">z-index: 2; position: absolute; left: 14px; top: 460px;</xsl:attribute>
            <xsl:element name="A">
               <xsl:attribute name="onclick">w=window.open(this.href,"catalog","");if (window.focus) {w.focus();};return false;</xsl:attribute>
               <xsl:attribute name="href">1212.asp</xsl:attribute>
               <xsl:element name="IMG">
                  <xsl:attribute name="src">Images/@Bar1.gif</xsl:attribute>
                  <xsl:attribute name="border">0</xsl:attribute>
               </xsl:element>
            </xsl:element>
         </xsl:element>
         <xsl:element name="DIV">
            <xsl:attribute name="style">z-index: 2; position: absolute; left: 14px; top: 505px;</xsl:attribute>
            <xsl:element name="A">
               <xsl:attribute name="onclick">w=window.open(this.href,"video","");if (window.focus) {w.focus();};return false;</xsl:attribute>
               <xsl:attribute name="href">mms://media1.pinnaclep.com/Video/Pinnacle/buffet.wmv</xsl:attribute>
               <xsl:element name="IMG">
                  <xsl:attribute name="src">Images/@Bar2.gif</xsl:attribute>
                  <xsl:attribute name="border">0</xsl:attribute>
               </xsl:element>
            </xsl:element>
         </xsl:element>
         <xsl:element name="DIV">
            <xsl:attribute name="style">z-index: 2; position: absolute; left: 14px; top: 550px;</xsl:attribute>
            <xsl:element name="A">
               <xsl:attribute name="onclick">w=window.open(this.href,"catalog","");if (window.focus) {w.focus();};return false;</xsl:attribute>
               <xsl:attribute name="href">0025.asp</xsl:attribute>
               <xsl:element name="IMG">
                  <xsl:attribute name="src">Images/@Bar3.gif</xsl:attribute>
                  <xsl:attribute name="border">0</xsl:attribute>
               </xsl:element>
            </xsl:element>
         </xsl:element>
            ...
            <xsl:element name="FORM">
               ...
               <xsl:element name="TR">
                  <xsl:element name="TD">
                     ...
                     <xsl:call-template name="PageHeaderPublic"/>
                  </xsl:element>
               </xsl:element>
               ...
               <xsl:element name="TR">
                  <xsl:element name="TD">
                     <xsl:attribute name="colspan">2</xsl:attribute>
                     <xsl:call-template name="PageFooterPublic"/>
                  </xsl:element>
               </xsl:element>
