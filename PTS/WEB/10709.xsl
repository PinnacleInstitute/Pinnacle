         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="TR">
               <xsl:element name="TD">
                  ...
                  <xsl:element name="A">
                     <xsl:attribute name="href">http://www.cloudzow.com/customerupgrade.asp?MemberID=<xsl:value-of select="/DATA/TXN/PTSMEMBER/@memberid"/></xsl:attribute>
                  <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CustomerUpgradeLabel']"/>
                  </xsl:element>
               </xsl:element>
            </xsl:element>
