...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8107URL", reqReturnURL
   SetCache "8107DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8107")
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oProspect
            ...
            If (tmpNewsLetterID <> 0) Then
               ...
               .Save CLng(reqSysUserID)
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
               .NewStatus CLng(reqProspectID), -3
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            End If
         End With
      End If
      ...
      If (tmpNewsLetterID <> 0) Then
         ...
         Else
            With oNote
               ...
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
               .Notes = "UNSUBSCRIBED from Newsletter #" & tmpNewsLetterID
               .AuthUserID = 1
               .NoteDate = Now
               .OwnerType = 81
      ...
      If (tmpNewsLetterID <> 0) Then
         ...
         Else
            With oNewsLetter
               .SysCurrentLanguage = reqSysLanguage
               .UpdateProspectCnt tmpNewsLetterID, -1
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            End With
         End If
...
If oLanguage.parseError <> 0 Then
   Response.Write "8107 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8107 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8107 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8107 Load file (oData) failed with error code " + CStr(oData.parseError)
