...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "13254URL", reqReturnURL
   SetCache "13254DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "13254")
   ...
   Else
      With oNewss
         .SysCurrentLanguage = reqSysLanguage
               ...
               reqBookmark = .Search( reqBookmark, tmpSearchText, reqDirection, reqCompanyID, reqFromDate, tmpToDate )
...
If oLanguage.parseError <> 0 Then
   Response.Write "13254 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "13254 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "13254 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "13254 Load file (oData) failed with error code " + CStr(oData.parseError)
