...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_8163URL", reqReturnURL
   SetCache "m_8163DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_8163")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("m_8163URL")
         reqReturnData = GetCache("m_8163DATA")
         SetCache "m_8163URL", ""
         SetCache "m_8163DATA", ""
   ...
   Case CLng(cActionPresent):
      ...
      Response.Redirect "m_8112.asp" & "?ProspectID=" & reqProspectID & "&CompanyID=" & tmpCompanyID & "&MemberID=" & tmpMemberID & "&Entity=" & 22 & "&ReturnURL=" & reqPageURL
   ...
   Case CLng(cActionLead):
      ...
      Response.Redirect "m_8111.asp" & "?ProspectID=" & reqProspectID & "&CompanyID=" & tmpCompanyID & "&MemberID=" & tmpMemberID & "&Entity=" & 22 & "&ReturnURL=" & reqPageURL
End Select
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_8163 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_8163 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_8163 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_8163 Load file (oData) failed with error code " + CStr(oData.parseError)
