         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               <xsl:element name="SCRIPT">
                  ...
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function Export(){ 
               var url, win;
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(count(/DATA/TXN/PTSCONTESTS/ENUM) &gt; 1) or (/DATA/PARAM/@ownercontestid != 0)">
                                 ...
                                 <xsl:if test="(contains(/DATA/SYSTEM/@useroptions, '|')) or (/DATA/PARAM/@ownercontestid != 0)">
                                       <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                       <xsl:element name="A">
                                          <xsl:attribute name="href">#_</xsl:attribute>
                                          <xsl:attribute name="onclick">Export()</xsl:attribute>
                                          <xsl:element name="IMG">
