<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Ticket Manager'"/>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="class">PageHeading</xsl:attribute>
                                             <xsl:if test="(/DATA/PARAM/@companyid = 0)">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FindIssue']"/>
                                             </xsl:if>
                                             <xsl:if test="(/DATA/PARAM/@companyid != 0)">
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SupportTicketManager']"/>
                                             </xsl:if>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">600</xsl:attribute>
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 21) or (/DATA/SYSTEM/@usergroup = 51)">
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="href">9411.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Categories']"/>
                                             </xsl:element>
                                          ...
                                          <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 21) or (/DATA/SYSTEM/@usergroup = 51)">
                                             <xsl:element name="A">
                                                <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                                <xsl:attribute name="href">9510.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
