<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'New Course Certificate'"/>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="SELECT">
                                    ...
                                    <xsl:variable name="tmp"><xsl:value-of select="/DATA/PARAM/@pv"/></xsl:variable>
                                    <xsl:element name="OPTION">
                                       <xsl:attribute name="value">2</xsl:attribute>
                                       <xsl:if test="$tmp='2'"><xsl:attribute name="SELECTED"/></xsl:if>
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Cert5']"/>
                                    </xsl:element>
                                    <xsl:element name="OPTION">
                                    ...
                                    <xsl:element name="OPTION">
                                       ...
                                       <xsl:if test="$tmp='50'"><xsl:attribute name="SELECTED"/></xsl:if>
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="class">Prompt</xsl:attribute>
                                    ...
                                    <xsl:element name="font">
                                       <xsl:attribute name="size">3</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Processing100']"/>
                                    </xsl:element>
                                    </xsl:element>
                                    <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                    <xsl:element name="A">
