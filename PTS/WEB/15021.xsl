      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               <xsl:attribute name="action">15021Upload.asp</xsl:attribute>
                                          ...
                                          <xsl:element name="TR">
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="onclick">document.PreviewImage.src='images/store/<xsl:value-of select="concat(/DATA/PARAM/@merchantid,'/',@name)"/>'</xsl:attribute>
                                             ...
                                             <xsl:element name="TD">
                                                ...
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">15021.asp?DeleteFile=<xsl:value-of select="@name"/>&amp;MerchantID=<xsl:value-of select="/DATA/PARAM/@merchantid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
