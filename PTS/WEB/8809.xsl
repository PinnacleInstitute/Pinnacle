   ...
   <xsl:template match="/">
      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
            ...
            <xsl:if test="(/DATA/PARAM/@newsletterid != 0)">
               <xsl:element name="TR">
                  <xsl:element name="TD">
                     <xsl:attribute name="width">750</xsl:attribute>
                     ...
                     <xsl:element name="b">
                        ...
                        <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewsLetterArchive']"/>
                          ...
                          |  
                        <xsl:element name="A">
                           <xsl:attribute name="href"><xsl:value-of select="concat('http://', /DATA/SYSTEM/@servername, /DATA/SYSTEM/@serverpath)"/>8107.asp?ProspectID={id}</xsl:attribute>
