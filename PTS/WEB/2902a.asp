...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "2902aURL", reqReturnURL
   SetCache "2902aDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "2902a")
...
If oLanguage.parseError <> 0 Then
   Response.Write "2902a Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "2902a Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "2902a Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "2902a Load file (oData) failed with error code " + CStr(oData.parseError)
