...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "17110URL", reqReturnURL
   SetCache "17110DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "17110")
   ...
   If (reqBarterCategoryID <> 0) Then
      ...
      Else
         With oBarterCategory
            ...
            End If
            If (reqBarterCategoryID <> 0) Then
               reqTitle = .BarterCategoryName
               SetCache "BARTERCATEGORY", reqBarterCategoryID
            End If
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionBarterCategory):
...
If oLanguage.parseError <> 0 Then
   Response.Write "17110 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "17110 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "17110 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "17110 Load file (oData) failed with error code " + CStr(oData.parseError)
