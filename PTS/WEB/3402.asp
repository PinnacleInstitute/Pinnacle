...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "3402URL", reqReturnURL
   SetCache "3402DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "3402")
   ...
   Case CLng(cActionAdd):
      ...
      Else
         With oMemberAssess
            ...
            .StartDate = Now
            .CommStatus = 1
            MemberAssessID = CLng(.Add(CLng(reqSysUserID)))
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            If (xmlError <> "") Then
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("3402URL")
         reqReturnData = GetCache("3402DATA")
         SetCache "3402URL", ""
         SetCache "3402DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "3402 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "3402 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "3402 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "3402 Load file (oData) failed with error code " + CStr(oData.parseError)
