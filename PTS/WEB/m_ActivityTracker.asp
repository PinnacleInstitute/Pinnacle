...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_ActivityTrackerURL", reqReturnURL
   SetCache "m_ActivityTrackerDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_activitytracker")
...
m_CheckSecurity reqSysUserID, reqSysUserGroup, 0, 0, "m_ActivityTracker.asp"
...
fileLanguage = "Language" + "\m_ActivityTracker[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\m_ActivityTracker[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "m_ActivityTracker Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_ActivityTracker Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
s=s+      "<ITEM label=""mActivities"" width=""150"" height=""40"" menuwidth=""150"" menuheight=""40"">"
s=s+         "<IMAGE name=""Activity.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabActivity',1))""/>"
s=s+      "</ITEM>"
         End If
         If (InStr(reqSysUserOptions,"l") <> 0) Then
s=s+      "<ITEM label=""mLeaderBoard"" width=""150"" height=""40"" menuwidth=""150"" menuheight=""40"">"
s=s+         "<IMAGE name=""leaderboard.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabActivity',2))""/>"
s=s+      "</ITEM>"
         End If
         If (InStr(reqSysUserOptions,"*") <> 0) Then
s=s+      "<ITEM label=""mActivityStatistics"" width=""150"" height=""40"" menuwidth=""150"" menuheight=""40"">"
s=s+         "<IMAGE name=""Contest.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabActivity',3))""/>"
s=s+      "</ITEM>"
         End If
         If (InStr(reqSysUserOptions,"*") <> 0) Then
s=s+      "<ITEM label=""mContests"" width=""150"" height=""40"" menuwidth=""150"" menuheight=""40"">"
s=s+         "<IMAGE name=""Contest.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabActivity',4))""/>"
s=s+      "</ITEM>"
         End If
         If (InStr(reqSysUserOptions,"l") <> 0) Then
s=s+      "<ITEM label=""mActivityGoals"" width=""150"" height=""40"" menuwidth=""150"" menuheight=""40"">"
s=s+         "<IMAGE name=""Goal.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabActivity',5))""/>"
s=s+      "</ITEM>"
         End If
         If (InStr(reqSysUserOptions,"#") <> 0) Then
s=s+      "<ITEM label=""mActivityReports"" width=""150"" height=""40"" menuwidth=""150"" menuheight=""40"">"
s=s+         "<IMAGE name=""Chart.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""JAVA(ShowTab('TabActivity',6))""/>"
s=s+      "</ITEM>"
         End If
s=s+      "<ITEM label=""mSignout"" width=""150"" height=""40"" menuwidth=""150"" menuheight=""40"">"
s=s+         "<IMAGE name=""close.gif"" width=""18"" height=""18""/>"
s=s+         "<LINK name=""m_15005"" nodata=""true""/>"
s=s+      "</ITEM>"
s=s+   "</ITEM>"
s=s+   "<ITEM value=""" & MemberName & """ width=""220"" align=""center""/>"
s=s+   "<ITEM width=""40"">"
...
xslPage = "m_ActivityTracker.xsl"
Set oStyle = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oStyle.load server.MapPath(xslPage)
If oStyle.parseError <> 0 Then
   Response.Write "m_ActivityTracker Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_ActivityTracker Load file (oData) failed with error code " + CStr(oData.parseError)
