...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "6211URL", reqReturnURL
   SetCache "6211DATA", reqReturnData
End If
...
pos = InStr(reqSysServerPath, "6211")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      Set oBonuss = server.CreateObject("ptsBonusUser.CBonuss")
      If oBonuss Is Nothing Then
         DoError Err.Number, Err.Source, "Unable to Create Object - ptsBonusUser.CBonuss"
      Else
         With oBonuss
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("6211URL")
      reqReturnData = GetCache("6211DATA")
      SetCache "6211URL", ""
      SetCache "6211DATA", ""
...
xmlTransaction = "<TXN>"
xmlTransaction = xmlTransaction +  xmlBonuss
...
If oLanguage.parseError <> 0 Then
   Response.Write "6211 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "6211 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "6211 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "6211 Load file (oData) failed with error code " + CStr(oData.parseError)
