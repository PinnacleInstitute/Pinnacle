...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_15103URL", reqReturnURL
   SetCache "m_15103DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_15103")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") And (reqPopup = 0) Then
         reqReturnURL = GetCache("m_15103URL")
         reqReturnData = GetCache("m_15103DATA")
         SetCache "m_15103URL", ""
         SetCache "m_15103DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_15103 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_15103 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_15103 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_15103 Load file (oData) failed with error code " + CStr(oData.parseError)
