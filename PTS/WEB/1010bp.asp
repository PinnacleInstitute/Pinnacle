...
<!--#include file="Include\bitpay.asp"-->
...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1010bpURL", reqReturnURL
   SetCache "1010bpDATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1010bp")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("1010bpURL")
      reqReturnData = GetCache("1010bpDATA")
      SetCache "1010bpURL", ""
      SetCache "1010bpDATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "1010bp Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1010bp Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1010bp Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1010bp Load file (oData) failed with error code " + CStr(oData.parseError)
