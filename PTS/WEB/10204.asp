...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "10204URL", reqReturnURL
   SetCache "10204DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "10204")
...
Sub LoadDebts()
   ...
   Else
      With oDebt
         ...
         .FetchConsolidate CLng(reqMemberID), CLng(reqSysUserID)
      ...
      Else
         With oDebt
            ...
            If (reqDebtID = 0) Then
               ...
               .DebtType = 8
               .DebtName = "Consolidation"
               .IntRate = IntRate
               .IsActive = 1
               .IsConsolidate = 1
               reqDebtID = CLng(.Add(CLng(reqSysUserID)))
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            End If
         End With
      End If
...
If oLanguage.parseError <> 0 Then
   Response.Write "10204 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "10204 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "10204 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "10204 Load file (oData) failed with error code " + CStr(oData.parseError)
