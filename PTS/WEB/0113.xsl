                     ...
                     <xsl:element name="TABLE">
                                 ...
                                 <xsl:attribute name="width">600</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AuthUser']"/>
                                          <xsl:text>:</xsl:text>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="A">
                                             ...
                                             <xsl:attribute name="href">0107.asp?AuthUserID=<xsl:value-of select="/DATA/PARAM/@authuserid"/>&amp;Popup=1</xsl:attribute>
                                          <xsl:element name="b">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="INPUT">
                              <xsl:attribute name="type">text</xsl:attribute>
                              <xsl:attribute name="name">AuthyID</xsl:attribute>
                              <xsl:attribute name="id">AuthyID</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@authyid"/></xsl:attribute>
