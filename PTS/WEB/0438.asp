...
pos = InStr(LCASE(reqSysServerPath), "0438")
...
If oStyle.parseError <> 0 Then
   Response.Write "0438 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oMember
            ...
            tmpFrom = .Email
            tmpTo = .Email
            tmpSubject = "MEMBER NOTICE: " + .NameFirst + " " + .NameLast + " - "
...
fileLanguage = "Language" + "\0438[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\0438[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "0438 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0438 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0438 Load file (oData) failed with error code " + CStr(oData.parseError)
