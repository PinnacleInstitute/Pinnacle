<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Team Members'"/>
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TeamMembers']"/>
                           </xsl:element>
                        </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:if test="(/DATA/PARAM/@companyid = 7)">
                                 <xsl:element name="A">
                                    <xsl:attribute name="onclick">w=window.open(this.href,"GroupStats","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                    <xsl:attribute name="href">12203.asp?GroupID=<xsl:value-of select="/DATA/PARAM/@groupid"/></xsl:attribute>
                                    <xsl:element name="IMG">
                                       <xsl:attribute name="src">Images/performance32.gif</xsl:attribute>
                                       <xsl:attribute name="align">absmiddle</xsl:attribute>
                                       <xsl:attribute name="border">0</xsl:attribute>
                                       <xsl:attribute name="alt"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TeamStats']"/></xsl:attribute>
                                       <xsl:attribute name="title"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TeamStats']"/></xsl:attribute>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:if>
                           </xsl:element>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:if test="(@status &lt; 2)">
                                                <xsl:element name="IMG">
                                                   ...
                                                   <xsl:attribute name="align">absmiddle</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                   <xsl:attribute name="alt"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='PaidMembership']"/></xsl:attribute>
                                                   <xsl:attribute name="title"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='PaidMembership']"/></xsl:attribute>
                                                </xsl:element>
                                          </xsl:if>
                                          <xsl:if test="(@status = 2)">
                                                <xsl:element name="IMG">
                                                   ...
                                                   <xsl:attribute name="align">absmiddle</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                   <xsl:attribute name="alt"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TrialMembership']"/></xsl:attribute>
                                                   <xsl:attribute name="title"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='TrialMembership']"/></xsl:attribute>
                                                </xsl:element>
                                          </xsl:if>
                                          <xsl:if test="(@status = 3)">
                                                <xsl:element name="IMG">
                                                   ...
                                                   <xsl:attribute name="align">absmiddle</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                   <xsl:attribute name="alt"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FreeMembership']"/></xsl:attribute>
                                                   <xsl:attribute name="title"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FreeMembership']"/></xsl:attribute>
                                                </xsl:element>
                                          </xsl:if>
                                          <xsl:if test="(@status &gt; 3)">
                                                <xsl:element name="IMG">
                                                   ...
                                                   <xsl:attribute name="align">absmiddle</xsl:attribute>
                                                   <xsl:attribute name="border">0</xsl:attribute>
                                                   <xsl:attribute name="alt"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SuspendedMembership']"/></xsl:attribute>
                                                   <xsl:attribute name="title"><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='SuspendedMembership']"/></xsl:attribute>
                                                </xsl:element>
                                          </xsl:if>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
