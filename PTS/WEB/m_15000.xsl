      ...
      <xsl:element name="BODY">
         ...
         <xsl:variable name="background">
            <xsl:choose>
               ...
               <xsl:otherwise>bg.jpg</xsl:otherwise>
            </xsl:choose>
         </xsl:variable>
...
<xsl:element name="SCRIPT">
   ...
   var UserMenu = new CMenu(UserMenuDef, 'UserMenu'); UserMenu.create();
                        ...
                        <xsl:element name="TR">
                           <xsl:attribute name="id">TabRewards</xsl:attribute>
                           <xsl:element name="TD">
                              <xsl:attribute name="width">100%</xsl:attribute>
                              <xsl:attribute name="align">left</xsl:attribute>
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:element name="IFRAME">
                                 ...
                                 <xsl:attribute name="height">700</xsl:attribute>
                                 <xsl:attribute name="frmheight">700</xsl:attribute>
                                 <xsl:attribute name="id">RewardsFrame</xsl:attribute>
                                 <xsl:attribute name="name">RewardsFrame</xsl:attribute>
                                 <xsl:attribute name="class">FrameNoScroll</xsl:attribute>
                                 <xsl:attribute name="frameborder">0</xsl:attribute>
                                 <xsl:attribute name="onload">ShowFrame('TabRewards')</xsl:attribute>
                                 <xsl:element name="A">
                                    <xsl:attribute name="href"></xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoFrameSupport']"/>
                                 </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:attribute name="id">TabConsumers</xsl:attribute>
                           <xsl:element name="TD">
                              <xsl:attribute name="width">100%</xsl:attribute>
                              <xsl:attribute name="align">left</xsl:attribute>
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:element name="IFRAME">
                                 ...
                                 <xsl:attribute name="height">700</xsl:attribute>
                                 <xsl:attribute name="frmheight">700</xsl:attribute>
                                 <xsl:attribute name="id">ConsumersFrame</xsl:attribute>
                                 <xsl:attribute name="name">ConsumersFrame</xsl:attribute>
                                 <xsl:attribute name="class">FrameNoScroll</xsl:attribute>
                                 <xsl:attribute name="frameborder">0</xsl:attribute>
                                 <xsl:attribute name="onload">ShowFrame('TabConsumers')</xsl:attribute>
                                 <xsl:element name="A">
                                    <xsl:attribute name="href"></xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoFrameSupport']"/>
                                 </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:attribute name="id">TabPromotions</xsl:attribute>
                           <xsl:element name="TD">
                              <xsl:attribute name="width">100%</xsl:attribute>
                              <xsl:attribute name="align">left</xsl:attribute>
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:element name="IFRAME">
                                 ...
                                 <xsl:attribute name="height">700</xsl:attribute>
                                 <xsl:attribute name="frmheight">700</xsl:attribute>
                                 <xsl:attribute name="id">PromotionsFrame</xsl:attribute>
                                 <xsl:attribute name="name">PromotionsFrame</xsl:attribute>
                                 <xsl:attribute name="class">FrameNoScroll</xsl:attribute>
                                 <xsl:attribute name="frameborder">0</xsl:attribute>
                                 <xsl:attribute name="onload">ShowFrame('TabPromotions')</xsl:attribute>
                                 <xsl:element name="A">
                                    <xsl:attribute name="href"></xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoFrameSupport']"/>
                                 </xsl:element>
