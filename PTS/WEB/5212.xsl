                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/TXN/PTSPROMOTION/@promotionname"/>
                           </xsl:element>
                        </xsl:element>
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:if test="(/DATA/SYSTEM/@usergroup != 99)">
                                                <xsl:element name="A">
                                                   ...
                                                   <xsl:attribute name="href">5203.asp?SalesOrderID=<xsl:value-of select="@salesorderid"/>&amp;Popup=1&amp;ContentPage=3</xsl:attribute>
                                                <xsl:value-of select="@orderdate"/>
                                                </xsl:element>
                                             </xsl:if>
                                       </xsl:element>
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:attribute name="width">650</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">97</xsl:attribute>
                                          <xsl:attribute name="align">left</xsl:attribute>
                                       </xsl:element>
                                       <xsl:element name="TD">
