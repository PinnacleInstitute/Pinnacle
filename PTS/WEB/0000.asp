...
<!--#include file="Include\Redirect.asp"-->
...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0000URL", reqReturnURL
   SetCache "0000DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0000")
...
Function RedirectHomePage(tmpPage)
   On Error Resume Next
...
If (reqCompanyID = 0) And (reqC > 0) Then
   reqCompanyID = reqC
End If
If (reqSysCompanyID = 0) And (reqCompanyID > 0) Then
   reqSysCompanyID = reqCompanyID
End If
If (reqSysCompanyID = reqCompanyID) Then
   reqSysCompanyID = reqCompanyID
End If
If (reqG = 0) Then
   reqG = GetCache("GROUPID")
End If
   ...
   Case CLng(cActionNew):
      ...
      If (reqCompanyID > 0) Then
         ...
         If (tmpPage = "HOME") Then
            ...
            Response.Redirect "Home.asp" & "?CompanyID=" & reqCompanyID & "&G=" & reqG
         End If
         If (tmpPage <> "") Then
            RedirectHomePage(tmpPage)
         End If
      ...
      If (reqCompany <> "") Then
         ...
         Else
            With oCompany
               ...
               reqCompanyID = CLng(.GetSubnet(reqCompany))
...
fileLanguage = "Language" + "\0000[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\0000[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "0000 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0000 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0000 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0000 Load file (oData) failed with error code " + CStr(oData.parseError)
