                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CampaignFor']"/>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                 <xsl:if test="(/DATA/TXN/PTSDRIPCAMPAIGN/@target = 1)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Lead#']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/TXN/PTSDRIPCAMPAIGN/@target = 2)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Prospect#']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/TXN/PTSDRIPCAMPAIGN/@target = 3)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Customer#']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/TXN/PTSDRIPCAMPAIGN/@target = 4)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Member#']"/>
                                 </xsl:if>
                                 <xsl:value-of select="/DATA/TXN/PTSDRIPTARGET/@targetid"/>
                           </xsl:element>
                        </xsl:element>
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/TXN/PTSDRIPTARGET/@startdate"/></xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSDRIPTARGET/PTSSTATUSS/ENUM">
