...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8824URL", reqReturnURL
   SetCache "8824DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8824")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      Else
         With oEmailees
            .SysCurrentLanguage = reqSysLanguage
            .ListTeam tmpMemberID, tmpParam1, tmpParam2, tmpParam3, tmpParam4, tmpParam5
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
            xmlEmailees = .XML()
            If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
...
If oLanguage.parseError <> 0 Then
   Response.Write "8824 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8824 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8824 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8824 Load file (oData) failed with error code " + CStr(oData.parseError)
