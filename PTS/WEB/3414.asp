...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "3414URL", reqReturnURL
   SetCache "3414DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "3414")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionReturn):
      ...
      Response.Redirect "3411.asp" & "?MemberID=" & reqMemberID & "&ReturnURL=" & reqPageURL & "&ReturnData=" & reqPageData
End Select
...
If oLanguage.parseError <> 0 Then
   Response.Write "3414 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "3414 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "3414 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "3414 Load file (oData) failed with error code " + CStr(oData.parseError)
