                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 ...
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewsContent']"/>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:element name="A">
                                    <xsl:attribute name="onclick">w=window.open(this.href,"UploadNews","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                    <xsl:attribute name="href">9821.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/></xsl:attribute>
                                    <xsl:element name="IMG">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SCRIPT">
                                 ...
                                 <![CDATA[   CKEDITOR.replace('Data', { height:800, customConfig:'CKEditor/wtConfig.js'} );  ]]>
                              </xsl:element>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
