...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8014URL", reqReturnURL
   SetCache "8014DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8014")
...
reqMoveParent =  Numeric(GetInput("MoveParent", reqPageData))
reqMoveID =  Numeric(GetInput("MoveID", reqPageData))
...
Sub LoadDocuments()
   ...
   Else
      With oAttachments
         ...
         .ListAttachments reqProspectID, CLng(reqParentType), CLng(reqSysUserID)
...
If (reqMoveParent <> 0) And (reqMoveID <> 0) Then
   ...
   Else
      With oAttachment
         .SysCurrentLanguage = reqSysLanguage
         .Load reqMoveID, CLng(reqSysUserID)
         If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
         .ParentType = reqMoveParent
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("8014URL")
      reqReturnData = GetCache("8014DATA")
      SetCache "8014URL", ""
      SetCache "8014DATA", ""
   ...
   Case CLng(cActionAttachment):
      ...
      Response.Redirect "8002.asp" & "?ParentType=" & reqParentType & "&ParentID=" & reqProspectID & "&ContentPage=" & 1 & "&Mini=" & 1 & "&ReturnURL=" & reqPageURL
End Select
...
xmlParam = xmlParam + " moveparent=" + Chr(34) + CStr(reqMoveParent) + Chr(34)
xmlParam = xmlParam + " moveid=" + Chr(34) + CStr(reqMoveID) + Chr(34)
...
If oLanguage.parseError <> 0 Then
   Response.Write "8014 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8014 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8014 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8014 Load file (oData) failed with error code " + CStr(oData.parseError)
