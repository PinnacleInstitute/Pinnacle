                                 ...
                                 <xsl:attribute name="width">800</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FindCompany']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">500</xsl:attribute>
                                          <xsl:attribute name="align">right</xsl:attribute>
                                          ...
                                          <xsl:if test="(contains(/DATA/SYSTEM/@useroptions, 'V'))">
                                             <xsl:element name="A">
                                                <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                                <xsl:attribute name="href">3802.asp?ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/></xsl:attribute>
                                          ...
                                          <xsl:element name="A">
                                             ...
                                             <xsl:attribute name="href">9022.asp</xsl:attribute>
                                          ...
                                          <xsl:element name="A">
                                             <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                             <xsl:attribute name="onclick">w=window.open(this.href,"Report","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                             <xsl:attribute name="href">0062.asp?Report=2&amp;OwnerType=0&amp;AuthUserID=<xsl:value-of select="/DATA/SYSTEM/@userid"/>&amp;User=<xsl:value-of select="/DATA/SYSTEM/@username"/></xsl:attribute>
                                          ...
                                          <xsl:element name="A">
                                             <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                             <xsl:attribute name="onclick">w=window.open(this.href,"Report","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                             <xsl:attribute name="href">0062.asp?Report=1&amp;OwnerType=0&amp;AuthUserID=<xsl:value-of select="/DATA/SYSTEM/@userid"/>&amp;User=<xsl:value-of select="/DATA/SYSTEM/@username"/></xsl:attribute>
                                          ...
                                          <xsl:if test="(contains(/DATA/SYSTEM/@useroptions, 'U'))">
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="href">0099.asp</xsl:attribute>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSCOMPANYS/PTSFINDTYPEIDS/ENUM">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSCOMPANYS/PTSCOMPANY">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">top</xsl:attribute>
                                             ...
                                             <xsl:element name="A">
                                                ...
                                                <xsl:attribute name="href">AdminHome.asp?CompanyID=<xsl:value-of select="@companyid"/></xsl:attribute>
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="b">
                                             <xsl:element name="A">
                                                <xsl:attribute name="onclick">w=window.open(this.href,"_blank","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                <xsl:attribute name="href">3816.asp?CompanyID=<xsl:value-of select="@companyid"/></xsl:attribute>
                                                <xsl:element name="IMG">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:element name="font">
                                             ...
                                             <xsl:if test="(@status = 4)">
                                              ...
                                              - 
                                             <xsl:variable name="tmp6"><xsl:value-of select="../PTSCOMPANYTYPES/ENUM[@id=current()/@companytype]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp6]"/>
                                              - 
                                 ...
                                 <xsl:choose>
                                    <xsl:when test="(count(/DATA/TXN/PTSCOMPANYS/PTSCOMPANY) = 0)">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             <xsl:attribute name="colspan">4</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
