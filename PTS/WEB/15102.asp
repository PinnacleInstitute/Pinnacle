...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "15102URL", reqReturnURL
   SetCache "15102DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "15102")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("15102URL")
      reqReturnData = GetCache("15102DATA")
      SetCache "15102URL", ""
      SetCache "15102DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "15102 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "15102 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "15102 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "15102 Load file (oData) failed with error code " + CStr(oData.parseError)
