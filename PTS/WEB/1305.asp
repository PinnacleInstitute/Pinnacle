...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "1305URL", reqReturnURL
   SetCache "1305DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "1305")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("1305URL")
         reqReturnData = GetCache("1305DATA")
         SetCache "1305URL", ""
         SetCache "1305DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "1305 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "1305 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "1305 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "1305 Load file (oData) failed with error code " + CStr(oData.parseError)
