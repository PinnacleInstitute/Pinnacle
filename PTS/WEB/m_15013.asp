...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_15013URL", reqReturnURL
   SetCache "m_15013DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_15013")
...
m_CheckSecurity reqSysUserID, reqSysUserGroup, 0, 0, "m_15013.asp"
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      reqBookmark = ""
      reqDirection = 1
      reqSearchText = GetCache("MERCHANTSEARCH")
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_15013 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_15013 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_15013 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_15013 Load file (oData) failed with error code " + CStr(oData.parseError)
