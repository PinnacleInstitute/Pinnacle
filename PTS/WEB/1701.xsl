<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Guide Manager'"/>
      ...
      <xsl:element name="DIV">
         ...
         <xsl:element name="TABLE">
          ...
          var url, win;
          url = "1721.asp?companyid=" + document.getElementById('CompanyID').value
          ...
          win.focus();
               ...
               <xsl:element name="SCRIPT">
                  <xsl:attribute name="language">JavaScript</xsl:attribute>
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function TheGuide(){ 
          var url, win;
          url = "1713.asp?popup=1&companyid=" + document.getElementById('CompanyID').value
          win = window.open(url,"Guide");
          win.focus();
         }]]></xsl:text>
               </xsl:element>
                                 ...
                                 <xsl:attribute name="width">1000</xsl:attribute>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FindQuestion']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">600</xsl:attribute>
                                          <xsl:attribute name="align">right</xsl:attribute>
                                          ...
                                          <xsl:element name="A">
                                             ...
                                             <xsl:attribute name="href">1702.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;ContentPage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewQuestion']"/>
                                          </xsl:element>
                                          <xsl:text disable-output-escaping="yes">&amp;#160;|&amp;#160;</xsl:text>
                                          <xsl:element name="A">
                                             <xsl:attribute name="class">PageHeadingLink</xsl:attribute>
                                             <xsl:attribute name="href">2711.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;ContentPage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;Popup=<xsl:value-of select="/DATA/PARAM/@popup"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='QuestionTypes']"/>
                                          </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSQUESTIONS/PTSFINDTYPEIDS/ENUM">
                              ...
                              <xsl:element name="INPUT">
                                 <xsl:attribute name="type">button</xsl:attribute>
                                 <xsl:attribute name="value">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Images']"/>
                                 </xsl:attribute>
                              ...
                              <xsl:element name="INPUT">
                                 ...
                                 <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[TheGuide()]]></xsl:text></xsl:attribute>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                    ...
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:value-of select="@questiontypename"/>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;&amp;#160;</xsl:text>
                                             ...
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">1703.asp?QuestionID=<xsl:value-of select="@questionid"/>&amp;ContentPage=<xsl:value-of select="/DATA/PARAM/@contentpage"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                <xsl:element name="IMG">
                                             ...
                                             <xsl:if test="(@status = 2)">
                                                <xsl:variable name="tmp9"><xsl:value-of select="../PTSSTATUSS/ENUM[@id=current()/@status]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp9]"/>
                                             </xsl:if>
                                             <xsl:if test="(@status = 3)">
                                                <xsl:element name="font">
                                                   <xsl:attribute name="color">red</xsl:attribute>
                                                <xsl:variable name="tmp10"><xsl:value-of select="../PTSSTATUSS/ENUM[@id=current()/@status]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp10]"/>
                                                </xsl:element>
                                             </xsl:if>
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="font">
