...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0104URL", reqReturnURL
   SetCache "0104DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0104")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      Else
         ...
         oHTTP.open "GET", tmpServer + "0105.asp" & "?AuthUserID=" & reqAuthUserID
         oHTTP.send
      End If
      Set oHTTP = Nothing
      If (reqPopup <> 0) Then
      ...
      If (reqPopup = 0) Then
         reqReturnURL = GetCache("0104URL")
         reqReturnData = GetCache("0104DATA")
         SetCache "0104URL", ""
         SetCache "0104DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "0104 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0104 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0104 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0104 Load file (oData) failed with error code " + CStr(oData.parseError)
