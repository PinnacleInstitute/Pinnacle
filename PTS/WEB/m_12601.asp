...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_12601URL", reqReturnURL
   SetCache "m_12601DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_12601")
...
reqCompanyID =  GetInput("CompanyID", reqPageData)
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      If (reqMemberID = 0) Then
         reqMemberID = tmpGroupID
      End If
      If (reqMemberID <> tmpGroupID) Then
         reqPrivate = 1
      End If
      reqBookmark = ""
      reqDirection = 1
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("m_12601URL")
      reqReturnData = GetCache("m_12601DATA")
      SetCache "m_12601URL", ""
      SetCache "m_12601DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_12601 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_12601 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_12601 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_12601 Load file (oData) failed with error code " + CStr(oData.parseError)
