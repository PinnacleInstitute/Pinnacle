<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Member Bonuses'"/>
                        ...
                        <xsl:if test="(/DATA/SYSTEM/@usergroup &lt;= 23) or (/DATA/SYSTEM/@usergroup = 51) or (/DATA/SYSTEM/@usergroup = 52)">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:element name="A">
                                    <xsl:attribute name="href">0902.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;OwnerType=<xsl:value-of select="/DATA/PARAM/@ownertype"/>&amp;OwnerID=<xsl:value-of select="/DATA/PARAM/@ownerid"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                 <xsl:element name="b">
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NewCommission']"/>
                                 </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">907</xsl:attribute>
                                    <xsl:if test="$tmp='907'"><xsl:attribute name="SELECTED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CommTypeName']"/>
                                 </xsl:element>
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">901</xsl:attribute>
                                    <xsl:if test="$tmp='901'"><xsl:attribute name="SELECTED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CommissionID']"/>
                                 </xsl:element>
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">913</xsl:attribute>
                                    <xsl:if test="$tmp='913'"><xsl:attribute name="SELECTED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Amount']"/>
                                 </xsl:element>
                                 <xsl:element name="OPTION">
                                    <xsl:attribute name="value">916</xsl:attribute>
                                    <xsl:if test="$tmp='916'"><xsl:attribute name="SELECTED"/></xsl:if>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='AffiliateNumber']"/>
                                 </xsl:element>
                              </xsl:element>
                              <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
