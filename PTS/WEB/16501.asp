...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "16501URL", reqReturnURL
   SetCache "16501DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "16501")
      ...
      If (reqMerchantID <> 0) Then
         ...
         Else
            With oMerchant
               ...
               If (Err.Number <> 0) Then DoError Err.Number, Err.Source, Err.Description End If
               reqTitle = CleanXML(.MerchantName)
            End With
         End If
...
If oLanguage.parseError <> 0 Then
   Response.Write "16501 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "16501 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "16501 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "16501 Load file (oData) failed with error code " + CStr(oData.parseError)
