<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Sales Processing'"/>
               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                           ...
                           <xsl:if test="(/DATA/PARAM/@mode = 3)">
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ClickHereFile']"/>
                                    </xsl:element>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:if>
                           ...
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:if test="(/DATA/PARAM/@mode = 1)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CalcCommission']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@mode = 2)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='CalcBonus']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@mode = 3)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='PrintReport']"/>
                                 </xsl:if>
                                 <xsl:if test="(/DATA/PARAM/@mode = 4)">
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MarkPending']"/>
                                 </xsl:if>
                        ...
                        <xsl:if test="(/DATA/PARAM/@mode = 1) or (/DATA/PARAM/@mode = 2) or (/DATA/PARAM/@mode = 3) or (/DATA/PARAM/@mode = 4) or (/DATA/PARAM/@mode = 5) or (/DATA/PARAM/@mode = 6)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">1</xsl:attribute>
                                 <xsl:attribute name="height">12</xsl:attribute>
