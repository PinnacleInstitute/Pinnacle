...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "12601URL", reqReturnURL
   SetCache "12601DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "12601")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("12601URL")
      reqReturnData = GetCache("12601DATA")
      SetCache "12601URL", ""
      SetCache "12601DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "12601 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "12601 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "12601 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "12601 Load file (oData) failed with error code " + CStr(oData.parseError)
