<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Activate Member'"/>
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="class">PageHeading</xsl:attribute>
                                    <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Congratulations']"/>
                                    ...
                                    <xsl:if test="(/DATA/PARAM/@status = 5)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='InactiveConfirm']"/>
                                    </xsl:if>
                                 <xsl:if test="(/DATA/TXN/PTSMEMBER/@status = 2) or (/DATA/TXN/PTSMEMBER/@status = 1)">
                                       <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='UpgradedConfirm']"/>
                                       <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                        ...
                        <xsl:if test="(/DATA/PARAM/@txn = 0)">
                           ...
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:attribute name="class">PageHeading</xsl:attribute>
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FailConfirm']"/>
                              </xsl:element>
                           </xsl:element>
                        </xsl:if>
