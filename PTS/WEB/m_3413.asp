...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "m_3413URL", reqReturnURL
   SetCache "m_3413DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "m_3413")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      If (tmpAssessmentType = 1) Then
         ...
         Response.Redirect "m_3105.asp" & "?AssessmentID=" & reqAssessmentID & "&MemberAssessID=" & reqMemberAssessID & "&MemberID=" & reqMemberID & "&ReturnURL=" & reqPageURL & "&ReturnData=" & reqPageData
      End If
      ...
      If (tmpAssessmentType = 2) And (tmpExternalID = "") Then
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("m_3413URL")
      reqReturnData = GetCache("m_3413DATA")
      SetCache "m_3413URL", ""
      SetCache "m_3413DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "m_3413 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "m_3413 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "m_3413 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "m_3413 Load file (oData) failed with error code " + CStr(oData.parseError)
