...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8812URL", reqReturnURL
   SetCache "8812DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8812")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      If (xmlError = "") Then
         ...
         Response.Redirect "8813.asp" & "?EmailID=" & EmailID & "&ReturnURL=" & GetCache("8812URL")
      End If

   Case CLng(cActionCancel):

      reqReturnURL = GetCache("8812URL")
      reqReturnData = GetCache("8812DATA")
      SetCache "8812URL", ""
      SetCache "8812DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "8812 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8812 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8812 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8812 Load file (oData) failed with error code " + CStr(oData.parseError)
