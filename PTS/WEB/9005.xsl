                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="IFRAME">
                                 <xsl:attribute name="src">9011.asp?OwnerType=<xsl:value-of select="/DATA/PARAM/@ownertype"/>&amp;OwnerID=<xsl:value-of select="/DATA/PARAM/@ownerid"/>&amp;Title=<xsl:value-of select="/DATA/PARAM/@title"/></xsl:attribute>
                                 <xsl:attribute name="width">600</xsl:attribute>
                                 ...
                                 <xsl:element name="A">
                                    <xsl:attribute name="href">9011.asp?OwnerType=<xsl:value-of select="/DATA/PARAM/@ownertype"/>&amp;OwnerID=<xsl:value-of select="/DATA/PARAM/@ownerid"/>&amp;Title=<xsl:value-of select="/DATA/PARAM/@title"/></xsl:attribute>
