...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "13501URL", reqReturnURL
   SetCache "13501DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "13501")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionUpdate):
      ...
      If (xmlError = "") Then
         ...
         Else
            With oMember
               ...
               tmpUpdate = 0
               tmpUpdatePaidDate = 0
               If (reqMembership = 0) Or (reqMembership >= 4) Then
               ...
               If (reqMembership = 0) Then
                  ...
                  .Options2 = Replace(.Options2, "112", "")
                  .Options2 = Replace(.Options2, "113", "")
                  .Options2 = Replace(.Options2, "114", "")
                  .Options2 = Replace(.Options2, "115", "")
                  .Options2 = Replace(.Options2, "116", "")
                  .Options2 = Replace(.Options2, "117", "")
                  .Options2 = Replace(.Options2, "118", "")
                  .Options2 = Replace(.Options2, "119", "")
                  .Options2 = Replace(.Options2, "120", "")
                  .Options2 = Replace(.Options2, "121", "")
                  .Options2 = Replace(.Options2, ",,", ",")
                  .Options2 = .Options2 + "," + tmpCode 
                  tmpUpdate = 1
               End If
               If (reqMembership = 15) Then
                  .Status = 1
                  .Level = 1
                  .Options2 = tmpCode
                  .InitPrice = 0
               ...
               If (reqMembership = 12) Then
                  ...
                  End If
               End If
               If (reqMembership = 11) Then
                  .Title = 5
                  .Options2 = "131," + tmpCode
                  .InitPrice = 211.95
                  If (reqCountryID <> 224) Then
                     .InitPrice = 224.95
                  End If
               ...
               If (reqMembership = 13) Then
                  ...
                  End If
               End If
               If (reqMembership = 14) Then
                  .Title = 5
                  .Options2 = "100," + tmpCode
                  .InitPrice = 414.95
                  If (reqCountryID <> 224) Then
                     .InitPrice = 429.95
                  End If
      ...
      End If
      If (xmlError = "") Then
         If (newTitle <> oldTitle) Or (reqMembership = 10) Then
               ...
               Else
                  With oMember
                     ...
                     tmpTo = .Email
                        ...
                        tmpSender = "support@legacymax.com"
                        tmpFrom = "support@legacymax.com"
                        If reqMembership = 10 Then
                           tmpSubject = tmpName + " has activated their membership."
                        Else
                           ...
                           Case 5
                              tmpSubject = tmpName + " has upgraded to the Diamond Pack"
                           End Select
                        End If
                        tmpBody = tmpSubject
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("13501URL")
      reqReturnData = GetCache("13501DATA")
      SetCache "13501URL", ""
      SetCache "13501DATA", ""
...
fileLanguage = "Language" + "\13501[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\13501[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "13501 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "13501 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "13501 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "13501 Load file (oData) failed with error code " + CStr(oData.parseError)
