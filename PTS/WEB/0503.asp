...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "0503URL", reqReturnURL
   SetCache "0503DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "0503")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("0503URL")
      reqReturnData = GetCache("0503DATA")
      SetCache "0503URL", ""
      SetCache "0503DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "0503 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0503 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "0503 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0503 Load file (oData) failed with error code " + CStr(oData.parseError)
