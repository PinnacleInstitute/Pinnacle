...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "2302URL", reqReturnURL
   SetCache "2302DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "2302")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionAdd):
      ...
      If (xmlError = "") Then
         reqReturnURL = GetCache("2302URL")
         reqReturnData = GetCache("2302DATA")
         SetCache "2302URL", ""
         SetCache "2302DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "2302 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "2302 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "2302 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "2302 Load file (oData) failed with error code " + CStr(oData.parseError)
