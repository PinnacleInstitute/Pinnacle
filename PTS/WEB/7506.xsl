<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="HTMLHeading">
         <xsl:with-param name="pagename" select="'Change Owner'"/>
               ...
               <xsl:element name="TR">
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:if test="(count(/DATA/TXN/PTSPROJECTMEMBERS/ENUM) &gt; 1)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="width">140</xsl:attribute>
                        ...
                        <xsl:if test="(count(/DATA/TXN/PTSPROJECTMEMBERS/ENUM) = 1)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 ...
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='NoNewOwner']"/>
                                 </xsl:element>
                              </xsl:element>
                           </xsl:element>
                        </xsl:if>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:attribute name="align">center</xsl:attribute>
                              <xsl:attribute name="valign">center</xsl:attribute>
                              <xsl:if test="(/DATA/SYSTEM/@userstatus = 1) and (count(/DATA/TXN/PTSPROJECTMEMBERS/ENUM) &gt; 1)">
                                 <xsl:element name="INPUT">
