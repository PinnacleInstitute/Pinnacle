...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "8011URL", reqReturnURL
   SetCache "8011DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "8011")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("8011URL")
      reqReturnData = GetCache("8011DATA")
      SetCache "8011URL", ""
      SetCache "8011DATA", ""
...
If oLanguage.parseError <> 0 Then
   Response.Write "8011 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "8011 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "8011 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "8011 Load file (oData) failed with error code " + CStr(oData.parseError)
