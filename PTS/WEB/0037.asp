...
pos = InStr(LCASE(reqSysServerPath), "0037")
...
If oStyle.parseError <> 0 Then
   Response.Write "0037 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
      ...
      Else
         With oMember
            ...
            If (reqBilling <> 0) Then
               tmpSubject = "Member Billing Updated: " + .NameFirst + " " + .NameLast + " (#" + .MemberID + ")" 
            End If
            If (reqBilling = 0) Then
               tmpSubject = "Member Payout Updated: " + .NameFirst + " " + .NameLast + " (#" + .MemberID + ")" 
            End If
         End With
      End If
      Set oMember = Nothing
...
fileLanguage = "Language" + "\0037[" + reqSysLanguage + "].xml"
If reqSysLanguage <> "en" Then
   If Not FileExists( reqSysWebDirectory + fileLanguage ) Then fileLanguage = "Language\0037[en].xml"
End If
Set oLanguage = server.CreateObject("MSXML2.FreeThreadedDOMDocument")
oLanguage.load server.MapPath(fileLanguage)
If oLanguage.parseError <> 0 Then
   Response.Write "0037 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "0037 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "0037 Load file (oData) failed with error code " + CStr(oData.parseError)
