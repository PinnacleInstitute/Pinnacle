                        ...
                        <xsl:if test="(/DATA/TXN/PTSMEMBER/@level != 3)">
                              ...
                              <xsl:element name="TR">
                                 <xsl:element name="TD">
                                    ...
                                    <xsl:attribute name="valign">center</xsl:attribute>
                                       <xsl:element name="b">
                                          ...
                                          <xsl:if test="(/DATA/PARAM/@nexttitle = 4)">
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Executive']"/>
                                          </xsl:if>
                                          <xsl:element name="BR"/>
                                       </xsl:element>
                                    ...
                                    <xsl:if test="(/DATA/PARAM/@nexttitle1 &gt; 0)">
                                          ...
                                          <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MoreMembers']"/>
                                          <xsl:element name="BR"/>
                                    </xsl:if>
                                    ...
                                    <xsl:if test="(/DATA/PARAM/@nexttitle4 &gt; 0)">
                                          ...
                                          <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                          <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='MoreExecutives']"/>
                                          <xsl:element name="BR"/>
                                    </xsl:if>
                                 </xsl:element>
                              </xsl:element>
                           ...
                           <xsl:element name="TR">
                              ...
                              <xsl:element name="TD">
                                 ...
                                 <xsl:attribute name="valign">center</xsl:attribute>
                                 <xsl:element name="b">
                                 <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Executives']"/>
                                 <xsl:text>:</xsl:text>
                                 <xsl:text disable-output-escaping="yes">&amp;#160;&amp;#160;</xsl:text>
                                 </xsl:element>
                              </xsl:element>
