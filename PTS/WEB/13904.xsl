                                                ...
                                                <xsl:element name="TR">
                                                   ...
                                                   <xsl:element name="TD">
                                                      ...
                                                      <xsl:attribute name="valign">center</xsl:attribute>
                                                         ...
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 2)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Team1']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title = 3)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Team2']"/>
                                                         </xsl:if>
                                                         <xsl:if test="(/DATA/TXN/PTSMEMBER/@title &gt;= 4)">
                                                            <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='Team3']"/>
                                                         </xsl:if>
                                                   </xsl:element>
                                                </xsl:element>
                                                <xsl:element name="TR">
