         ...
         <xsl:element name="TABLE">
            ...
            <xsl:element name="FORM">
               ...
               <xsl:element name="SCRIPT">
                  ...
                  <xsl:text disable-output-escaping="yes"><![CDATA[ function NewContest(){ 
                  ...
                  <xsl:element name="TD">
                     ...
                     <xsl:element name="TABLE">
                        ...
                        <xsl:element name="TR">
                           ...
                           <xsl:element name="INPUT">
                              <xsl:attribute name="type">hidden</xsl:attribute>
                              <xsl:attribute name="name">Private</xsl:attribute>
                              <xsl:attribute name="id">Private</xsl:attribute>
                              <xsl:attribute name="value"><xsl:value-of select="/DATA/PARAM/@private"/></xsl:attribute>
                           </xsl:element>
                                    ...
                                    <xsl:element name="TR">
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="class">PageHeading</xsl:attribute>
                                             ...
                                             <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='FindContest']"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="width">375</xsl:attribute>
                                          <xsl:attribute name="align">right</xsl:attribute>
                                          ...
                                          <xsl:attribute name="class">PageHeader</xsl:attribute>
                                             <xsl:element name="INPUT">
                                                ...
                                                <xsl:attribute name="onclick"><xsl:text disable-output-escaping="yes"><![CDATA[NewContest()]]></xsl:text></xsl:attribute>
                                             </xsl:element>
                                       </xsl:element>
                                    </xsl:element>
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='ContestCreaterText']"/>
                           </xsl:element>
                        </xsl:element>
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="SELECT">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSCONTESTS/PTSFINDTYPEIDS/ENUM">
                        ...
                        <xsl:element name="TR">
                           <xsl:element name="TD">
                              ...
                              <xsl:element name="TABLE">
                                 ...
                                 <xsl:for-each select="/DATA/TXN/PTSCONTESTS/PTSCONTEST">
                                    <xsl:element name="TR">
                                       ...
                                       <xsl:element name="TD">
                                          ...
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             ...
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="A">
                                                <xsl:attribute name="href">12603.asp?ContestID=<xsl:value-of select="@contestid"/>&amp;Private=<xsl:value-of select="/DATA/PARAM/@private"/>&amp;ReturnURL=<xsl:value-of select="/DATA/SYSTEM/@pageURL"/>&amp;ReturnData=<xsl:value-of select="/DATA/SYSTEM/@pageData"/></xsl:attribute>
                                                <xsl:element name="IMG">
                                             ...
                                             <xsl:text disable-output-escaping="yes">&amp;#160;</xsl:text>
                                             <xsl:element name="A">
                                                <xsl:attribute name="onclick">w=window.open(this.href,"OwnerLeaderboard","");if (window.focus) {w.focus();};return false;</xsl:attribute>
                                                <xsl:attribute name="href">11710.asp?CompanyID=<xsl:value-of select="/DATA/PARAM/@companyid"/>&amp;MemberID=<xsl:value-of select="/DATA/PARAM/@memberid"/>&amp;OwnerContestID=<xsl:value-of select="@contestid"/></xsl:attribute>
                                                <xsl:element name="IMG">
                                       ...
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                          <xsl:variable name="tmp4"><xsl:value-of select="../PTSMETRICS/ENUM[@id=current()/@metric]/@name"/></xsl:variable><xsl:value-of select="/DATA/LANGUAGE/LABEL[@name=$tmp4]"/>
                                       </xsl:element>
                                       <xsl:element name="TD">
                                          <xsl:attribute name="align">center</xsl:attribute>
                                          <xsl:attribute name="valign">center</xsl:attribute>
                                             <xsl:if test="(@isprivate = 0)">
                                                <xsl:choose>
                                                   <xsl:when test="(@isprivate='0')">
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IsPrivateFalse']"/>
                                                   </xsl:when>
                                                   <xsl:otherwise>
                                                      <xsl:value-of select="/DATA/LANGUAGE/LABEL[@name='IsPrivateTrue']"/>
                                                   </xsl:otherwise>
                                                </xsl:choose>
                                             </xsl:if>
                                             <xsl:if test="(@isprivate != 0)">
                                 ...
                                 <xsl:choose>
                                    <xsl:when test="(count(/DATA/TXN/PTSCONTESTS/PTSCONTEST) = 0)">
                                       <xsl:element name="TR">
                                          <xsl:element name="TD">
                                             <xsl:attribute name="colspan">5</xsl:attribute>
                                             <xsl:attribute name="align">left</xsl:attribute>
                        ...
                        <xsl:if test="(/DATA/PARAM/@return != 0)">
                           <xsl:element name="TR">
                              <xsl:element name="TD">
                                 <xsl:attribute name="colspan">1</xsl:attribute>
