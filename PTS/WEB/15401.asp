...
If (Len(Request.Item("ReturnURL")) > 0) Then
   ...
   SetCache "15401URL", reqReturnURL
   SetCache "15401DATA", reqReturnData
End If
...
pos = InStr(LCASE(reqSysServerPath), "15401")
...
Select Case CLng(reqActionCode)
   ...
   Case CLng(cActionNew):
      ...
      Set oPromos = server.CreateObject("ptsPromoUser.CPromos")
      If oPromos Is Nothing Then
         DoError Err.Number, Err.Source, "Unable to Create Object - ptsPromoUser.CPromos"
      Else
         With oPromos
   ...
   Case CLng(cActionCancel):
      ...
      reqReturnURL = GetCache("15401URL")
      reqReturnData = GetCache("15401DATA")
      SetCache "15401URL", ""
      SetCache "15401DATA", ""
...
xmlTransaction = "<TXN>"
xmlTransaction = xmlTransaction +  xmlPromos
...
If oLanguage.parseError <> 0 Then
   Response.Write "15401 Load file (oLanguage) failed with error code " + CStr(oLanguage.parseError)
   Response.End
End If
...
If oCommon.parseError <> 0 Then
   Response.Write "15401 Load file (oCommon) failed with error code " + CStr(oCommon.parseError)
   Response.End
End If
...
If oStyle.parseError <> 0 Then
   Response.Write "15401 Load file (oStyle) failed with error code " + CStr(oStyle.parseError)
   Response.End
End If
...
If oData.parseError <> 0 Then
   Response.Write "15401 Load file (oData) failed with error code " + CStr(oData.parseError)
